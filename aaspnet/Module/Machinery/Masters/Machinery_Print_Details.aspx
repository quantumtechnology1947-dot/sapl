<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Machinery_Masters_Machinery_Print_Details, newerp_deploy" title="ERP" theme="Default" %>
        ...
        <tr>
            <td align="center" class="style3">
                ...
                <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                  <Report FileName="~/Module/Machinery/Masters/Reports/Machinery.rpt">
                    </Report>
