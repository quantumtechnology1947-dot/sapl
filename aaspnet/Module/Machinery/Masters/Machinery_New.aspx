<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Machinery_Masters_Machinery_New, newerp_deploy" title="ERP" theme="Default" %>
...
<table align="left" cellpadding="0" 
            ...
            &nbsp;<asp:DropDownList 
                ...
                CssClass="box3" 
                OnSelectedIndexChanged="DrpSearchCode_SelectedIndexChanged1">
            ...
            <asp:GridView ID="GridView2" runat="server" AllowPaging="True" 
                ...
                <ItemStyle VerticalAlign="Top" Width="55%" /></asp:BoundField>
