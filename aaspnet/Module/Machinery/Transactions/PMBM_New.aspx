<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Machinery_Transactions_PMBM_New, newerp_deploy" title="ERP" theme="Default" %>
            ...
            <asp:GridView ID="GridView2" runat="server" AllowPaging="True" 
                ...
                <asp:BoundField DataField="Qty" HeaderText="Stock Qty">
                    ...
                    <ItemStyle VerticalAlign="Top" Width="15%" />
                       ...
                       <asp:TemplateField HeaderText="PM In Days" Visible="true">
                        <ItemTemplate>
                        <asp:Label ID="lblPMDays" runat="server" Text='<%# Bind("PMDays") %>'></asp:Label>
                        </ItemTemplate>                                                                       
                         <ItemStyle VerticalAlign="Top" HorizontalAlign="Center" />
                      </asp:TemplateField>
                      ...
                      <asp:TemplateField HeaderText="Remain Days" Visible="true">
                        <ItemTemplate>
                        <asp:Label ID="lblRemainDays" runat="server" Text='<%# Bind("RemainDays") %>'></asp:Label>
                        </ItemTemplate>                                                                       
                         <ItemStyle VerticalAlign="Top" HorizontalAlign="Center" />
                      </asp:TemplateField>
