<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Machinery_Transactions_Schedule_New_Details, newerp_deploy" title="ERP" theme="Default" %>
...
<td align="left" valign="middle"  height="21" ><b>&nbsp;WONo :&nbsp;&nbsp;<asp:Label ID="lblWoNo" runat="server" Text=""></asp:Label> </b></td>
    ...
    <table align="left" cellpadding="0" cellspacing="0" class="style2"><tr><td align="center">
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                    CssClass="yui-datatable-theme"  AllowPaging="True" 
                    Width="100%" onrowcommand="GridView2_RowCommand" 
            onpageindexchanging="GridView2_PageIndexChanging" ><FooterStyle Wrap="True"></FooterStyle><Columns><asp:TemplateField HeaderText="SN"><ItemTemplate><%#Container.DataItemIndex+1  %>
            ...
            <asp:TemplateField  HeaderText="Type">  
                                  <ItemTemplate>
                                  <asp:DropDownList ID="DrpType" Width="99%" runat="server" >
                     <asp:ListItem Value="0">Finished</asp:ListItem>
                     <asp:ListItem Value="1">By Split</asp:ListItem>
