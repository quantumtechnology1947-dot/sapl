<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Machinery_Transactions_PMBM_Print_Details, newerp_deploy" title="ERP" theme="Default" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
 ...
 <table align="left" cellpadding="0" cellspacing="0" width="100%">
        ...
        &nbsp;<b>Preventive /Breckdown Maintenance- Print</b>
            </td>
        </tr>
        <tr>
            <td align="center" class="style3">
                ...
                <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                  <Report FileName="~/Module/Machinery/Transactions/Reports/PMBM.rpt">
                    </Report>
