<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Manufacturing_Vendor_Report_Info_Print.aspx.cs" Inherits="ChallanInfo" Title="ERP" %>
...
<asp:Content ID="Content8" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
 <table align="center" cellpadding="0" cellspacing="0" width="100%" >
    <tr height="21">
        <td style="background:url(../../../images/hdbg.JPG)" class="fontcsswhite" >&nbsp;<b>Vendor Report </b></td>
    </tr></table>
    <br />
  ...
  <asp:Label runat="server" ID="lbl14" Text='<%# Eval("VendorPlan") %>'></asp:Label>
   ...
   <asp:GridView ID="GridView2" runat="server" DataKeyNames="Id" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
 <asp:LinkButton ID="View" runat="server" CommandName="View" CommandArgument='<%# Bind("VendorPlan") %>'>View</asp:LinkButton>                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
