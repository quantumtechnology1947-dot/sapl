    ...
    <RowStyle HorizontalAlign="Center" />
       ...
       <asp:BoundField DataField="ItemCode" HeaderText="Item code" SortExpression="ItemCode" />
          ...
          <asp:BoundField DataField="UOM" HeaderText="UOM" SortExpression="UOM" />   
             ...
             <asp:BoundField DataField="Manf"  Visible="false" HeaderText="Manf" SortExpression="Manf" />
             <asp:BoundField DataField="BOP" Visible="false" HeaderText="Date" SortExpression="BOP"  />
             
              <asp:BoundField DataField="Assemly"  Visible="false" HeaderText="Assemly" SortExpression="Assemly" />
        <asp:BoundField DataField="Hrs" Visible="false" HeaderText="Hrs" SortExpression="Hrs" />
