<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Manufacturing_Assemly_Report_Print_Detail.aspx.cs" Inherits="Challanreport" %>
...
&nbsp;<small>Email -&quot;sales@synergytechs.com&quot;</small><br />
    ...
    <center> 
            <hr />
        <asp:Label runat="server" ID="dclabel" Text="Assemly Report" 
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                  ...
                  <asp:TemplateField HeaderText="Design" >
                   ...
                   <asp:TemplateField HeaderText="Vendor Plan Date" >
                    <ItemTemplate>
                        <asp:Label runat="server" ID="txtven1" Visible="True" Text='<%#Eval("VendorPlanDate") %>'>'></asp:Label>
                    </ItemTemplate>
                  
                  </asp:TemplateField>
                  
                   <asp:TemplateField HeaderText="Vendor Actual Date" >
                    <ItemTemplate>
                        <asp:Label runat="server" ID="txtven2" Visible="True" Text='<%#Eval("VendorAct") %>'>'></asp:Label>
                    </ItemTemplate>
                  ...
                  <asp:TemplateField HeaderText="Assemly" >
                    <ItemTemplate>
                        <asp:Label runat="server" ID="txtassem" Visible="True" Text='<%#Eval("AssemlyDate") %>'>'></asp:Label>
                    </ItemTemplate>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT [Id],[ItemCode],[Description],[UOM],[BOMQ],[WONo] ,[Design],[VendorPlanDate],[VendorAct],[AssemlyDate] FROM [tblPM_Project_Hardware_Assemly_Detail] WHERE ([PRJCTNO] = @PRJCTNO)">
    <SelectParameters>
