<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Manufacturing_Assemly_Report_Info_Print.aspx.cs" Inherits="ChallanInfo" Title="ERP" %>
...
<asp:GridView ID="GridView1" runat="server" DataKeyNames="PRJCTNO" AllowPaging="True" PageSize="10000" 
 ...
 <ItemTemplate>
      <%# Container.DataItemIndex + 1%>
         ...
         <asp:BoundField DataField="AssemlyNo" HeaderText="Report NO" SortExpression="DCNo" 
...
<HeaderStyle BackColor="#BDBDBD"></HeaderStyle>
  ...
  <EditItemTemplate>
  <asp:Label runat="server" ID="lbl14" Text='<%# Eval("AssemlyNo") %>'></asp:Label>
  </EditItemTemplate>
   <ItemTemplate>
   ...
   <asp:BoundField DataField="SysDate" HeaderText="Gen Date" SortExpression="SysDate" HeaderStyle-BackColor = "#BDBDBD"/>
        ...
        SelectCommand="SELECT distinct AssemlyNo,SysDate,SessionId,WONo FROM tblPM_Project_Hardware_Assemly_Master order by AssemlyNo asc" >
         </asp:SqlDataSource>
   ...
   <asp:GridView ID="GridView2" runat="server" DataKeyNames="Id" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
 <asp:LinkButton ID="View" runat="server" CommandName="View" CommandArgument='<%# Bind("AssemlyNo") %>'>View</asp:LinkButton>                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Report No.">
                        <ItemTemplate>
                            <asp:Label ID="lblPRNo" runat="server" Text='<%# Bind("AssemlyNo") %>'></asp:Label>
                        </ItemTemplate>                       
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
