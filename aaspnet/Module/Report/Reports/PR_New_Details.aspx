<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PR_New_Details.aspx.cs" Inherits="Module_MaterialManagement_Transactions_PR_New_Detail" Title="ERP" Theme ="Default"  %>
             ...
             <table width="100%" align="center" cellpadding="0" cellspacing="0">
                    <tr >                   
                       ...
                       <asp:Label runat="server" ID="lblreportdate"></asp:Label>
                        ...
                        &nbsp;<strong>Design Report - New</strong>&nbsp;&nbsp;&nbsp;<strong>WONo:</strong><asp:Label ID="lblWono" runat="server" Text=""></asp:Label>
...
<CommandItemSettings   ExportToPdfText="Export to Pdf"></CommandItemSettings>
   ...
   <ItemStyle HorizontalAlign="Center" VerticalAlign="Top" Width="20px" ></ItemStyle>       
    ...
    <telerik:GridTemplateColumn HeaderText="BOM Date" Visible="False">
        <ItemTemplate>
        <asp:Label ID="lblItemDate" runat="server" Text='<%#Eval("SysDate") %>'></asp:Label>
        </ItemTemplate>
       ...
       <HeaderStyle HorizontalAlign="center" Width="60px"  />
        ...
        <telerik:GridTemplateColumn HeaderText="BOM Qty" Visible="True">
        <ItemTemplate>
        ...
        <%--<telerik:GridTemplateColumn HeaderText="BOM Qty" Visible="false">
        <ItemTemplate>
        <asp:Label ID="lblbomqty1" runat="server" Text='<%#Eval("BOMQty") %>'></asp:Label>
        </ItemTemplate>
           <ItemStyle HorizontalAlign="Left"  VerticalAlign="Top" Width="10px"   />
            <HeaderStyle HorizontalAlign="center" Width="15px"   />
        </telerik:GridTemplateColumn>--%>
         ...
         <telerik:GridTemplateColumn HeaderText="Release Qty" Visible="false">
        <ItemTemplate>
        <asp:TextBox ID="lblbomqty1" runat="server" Enabled="false" ></asp:TextBox>
        </ItemTemplate>
        ...
        <ItemTemplate>
        <asp:RadioButton ID="rdoEmail" runat="server" Text="1" Visible="false" AutoPostBack="true"  />
        
        <asp:TextBox ID="txtdesign" runat="server" Enabled="false" ></asp:TextBox>
       <cc1:CalendarExtender ID="CalendarExtenderFin"  Format="dd-MM-yyyy"
          PopupPosition="BottomRight" CssClass="cal_Theme1"
           Animated="True"  TargetControlID="txtdesign" runat="server"></cc1:CalendarExtender> 
          ...
          <telerik:GridTemplateColumn HeaderText="Vendor" Visible="false">
        <ItemTemplate>
        <asp:TextBox ID="txtven11" runat="server" ></asp:TextBox>
        <asp:TextBox runat="server" ID="txtven21"></asp:TextBox>
        </ItemTemplate>
        ...
        <telerik:GridTemplateColumn HeaderText="Vendor1" Visible="False">
        <ItemTemplate>
        <asp:TextBox ID="txtven1" runat="server" ></asp:TextBox>
        </ItemTemplate>
           <ItemStyle HorizontalAlign="Right"  VerticalAlign="Top" Width="40px"   />
            <HeaderStyle HorizontalAlign="center" Width="40px"   />
        </telerik:GridTemplateColumn>
        
         <telerik:GridTemplateColumn HeaderText="Vendor2" Visible="False">
        <ItemTemplate>
        <asp:TextBox ID="txtven2" runat="server" ></asp:TextBox>
        </ItemTemplate>
           <ItemStyle HorizontalAlign="Right"  VerticalAlign="Top" Width="40px"   />
            <HeaderStyle HorizontalAlign="center" Width="40px"   />
        </telerik:GridTemplateColumn>
