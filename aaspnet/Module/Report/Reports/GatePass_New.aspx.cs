...
public partial class Module_Scheduler_GatePass_New : System.Web.UI.Page
{
    ...
    public void loaddata()
    {
        try
        {
            ...
            dt.Columns.Add(new System.Data.DataColumn("Adharcard", typeof(string)));
            dt.Columns.Add(new System.Data.DataColumn("PAN", typeof(string)));
            if (DSInv.Tables[0].Rows.Count > 0)
            {
                DataRow dr;
                ...
                for (int i = 0; i < DSInv.Tables[0].Rows.Count; i++)
                {
                    ...
                    dr[11] = (DSInv.Tables[0].Rows[i]["Adharcard"].ToString());
    ...
    protected void GridView3_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        try
        {
            ...
            if (e.CommandName == "add1")
            {
                ...
                string Adhar = ((TextBox)grv.FindControl("txtadhar2")).Text;
                string PAN = ((TextBox)grv.FindControl("txtPAN2")).Text;
                ...
                if (((TextBox)grv.FindControl("TxtDate2")).Text!="" && fun.DateValidation(((TextBox)grv.FindControl("TxtDate2")).Text)==true)
                {
                    if (T == 1)
                    {
                        ...
                        {
                            SqlCommand exeme2 = new SqlCommand(fun.insert("tblCV_Temp", "SessionId,CompId,FromDate,FromTime,ToTime,Place,ContactPerson,ContactNo,Reason,Type,TypeOf,TypeFor,Adharcard,PAN", "'" + sId + "','" + CompId + "','" + Date + "','" + FromTime + "','" + ToTime + "','" + Place + "','" + Person + "','" + ContactNo + "','" + Reason + "','" + typ + "','" + T + "','" + typefor + "','"+Adhar+"','"+PAN+"'"), con);
            ...
            if (e.CommandName == "add")
            {
                ...
                string Adhar = ((TextBox)grv.FindControl("txtadhar1")).Text;
                string PAN = ((TextBox)grv.FindControl("txtPAN1")).Text;
                ...
                if (((TextBox)grv.FindControl("TxtDate1")).Text != "" && fun.DateValidation(((TextBox)grv.FindControl("TxtDate1")).Text) == true)
                {
                    if (T == 1)
                    {
                        if (typefor != "" && fun.CheckValidWONo(((TextBox)grv.FindControl("TxtDetails1")).Text, CompId, FinYearId) == true)
                        {
                            ...
                            SqlCommand exeme1 = new SqlCommand(fun.insert("tblCV_Temp", "SessionId,CompId,FromDate,FromTime,ToTime,Place,ContactPerson,ContactNo,Reason,Type,TypeOf,TypeFor,Adharcard,PAN", "'" + sId + "','" + CompId + "','" + Date + "','" + FromTime + "','" + ToTime + "','" + Place + "','" + Person + "','" + ContactNo + "','" + Reason + "','" + typ + "','" + T + "','" + typefor + "','"+Adhar+"','"+PAN+"'"), con);
