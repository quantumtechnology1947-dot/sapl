...
public partial class Module_MaterialManagement_Transactions_PR_New_Detail : System.Web.UI.Page
{
    ...
    public void MP_Tree1()
    {
        ...
        try
        {
            ...
            DataRow dr;
            string sql = "select ItemCode,Description,UOM,BOMQ,Design From tblPM_Project_Site_Master_Detail Where PRJCTNO='" + lblreport.Text + "'";
    ...
    public void Display()
    {
        ...
        using (SqlConnection cnz = new SqlConnection(conStr))
        {
            ...
            SqlCommand cmdzs = new SqlCommand("SELECT MAX((VendorPlan) + 1) as VendorPlan FROM tblPM_Project_Manufacturing_VendorD ", cnz);
    ...
    protected void RadButton2_Click_Cancel(object sender, EventArgs e)
    {
        ...
        foreach (GridDataItem grv2 in RadGrid1.Items)
        {
            ...
            TextBox txtven1 = grv2.Cells[7].FindControl("txtven1") as TextBox;
            TextBox txtven2 = grv2.Cells[8].FindControl("txtven2") as TextBox;

            if (CK.Checked == true)
            {
                grv2.BackColor = System.Drawing.Color.Pink;
                cmd1 = new SqlCommand("INSERT INTO tblPM_Project_Manufacturing_Plan_Detail(PRJCTNO,WONo,ItemCode,Description,UOM,BOMQ,Design,VendorPlanDate,VendorAct,VendorPlan) values(@PRJCTNO,@WONo,@ItemCode,@Description,@UOM,@BOMQ,@Design,@VendorPlanDate,@VendorAct,@VendorPlan)", con);
    ...
    {
        Response.Redirect("~/Module/Report/Reports/Manufacturing_Design_Report_Info_Edit.aspx?", true);
    }
    protected void RadButton1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string sqlStatment = "INSERT INTO tblPM_Project_Manufacturing_VendorD(SysDate,SysTime,CompId,SessionId,FinYearId,PRJCTNO,WONo,GenDate,VendorPlan,VendorDate) VALUES(@SysDate,@SysTime,@CompId,@SessionId,@FinYearId,@PRJCTNO,@WONo,@GenDate,@VendorPlan,@VendorDate)";
