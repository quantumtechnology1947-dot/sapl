                ...
                <cc1:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" 
                    ...
                    <cc1:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel1">
                        ...
                        <ContentTemplate><table class="style2"><tr><td align="center"><asp:GridView 
                                ...
                                <asp:TemplateField HeaderText="Contact No"><ItemTemplate><asp:Label 
                                ...
                                <asp:TemplateField HeaderText="Reason"><ItemTemplate><asp:Label 
                                ...
                                <FooterTemplate>
                                 ...
                                 <asp:TemplateField HeaderText="Reason"><ItemTemplate><asp:Label 
                                        ID="lbladhar1" runat="server" Text='<%#Eval("Adharcard") %>'></asp:Label>
                                </ItemTemplate>
                                <FooterTemplate>
                                    <asp:TextBox ID="txtadhar1" runat="server" CssClass="box3" ValidationGroup="A" 
                                        Width="80px"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator56" runat="server" 
                                        ControlToValidate="txtadhar1" ErrorMessage="*" ValidationGroup="A"></asp:RequiredFieldValidator>
                                </FooterTemplate>
                                </asp:TemplateField>
                                
                                
                                
                                 <asp:TemplateField HeaderText="Adhar Card"><ItemTemplate><asp:Label 
                                        ID="lblPAN1" runat="server" Text='<%#Eval("PAN") %>'></asp:Label>
                                </ItemTemplate>
                                <FooterTemplate>
                                    <asp:TextBox ID="txtPAN1" runat="server" CssClass="box3" ValidationGroup="A" 
                                        Width="80px"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator57" runat="server" 
                                        ControlToValidate="txtPAN1" ErrorMessage="*" ValidationGroup="A"></asp:RequiredFieldValidator>
                                </FooterTemplate>
                                </asp:TemplateField>
                                
                                
                                
                                <asp:TemplateField><FooterTemplate><asp:Button ID="BtnAdd" 
                                    ...
                                    <tr height="24" valign="middle">
                                        <td align="center">
                                            ...
                                            align="center"><b>Contact Person</b> </td><td align="center"><b>Contact No</b> <td 
                                                align="center"><b>Reason</b></td>
                                                
                                                 <td 
                                            align="center"><b>Adhard Card</b> </td>
                                            <td 
                                            align="center"><b>PAN Card</b> </td>
                                        ...
                                        align="center"><asp:TextBox ID="TxtContNo2" runat="server" CssClass="box3" 
                                            ...
                                            align="center"><asp:TextBox ID="TxtReason2" runat="server" CssClass="box3" 
                                                ...
                                                ErrorMessage="*" ValidationGroup="A1"> </asp:RequiredFieldValidator></td>
                                                  ...
                                                  <td 
                                            align="center"><asp:TextBox ID="txtadhar2" runat="server" CssClass="box3" 
                                                ValidationGroup="A1" Width="100px"> </asp:TextBox><asp:RequiredFieldValidator 
                                                ID="RequiredFieldValidator21" runat="server" ControlToValidate="txtadhar2" 
                                                ErrorMessage="*" ValidationGroup="A1"> </asp:RequiredFieldValidator></td>
                                                
                                                
                                                  <td 
                                            align="center"><asp:TextBox ID="txtPAN2" runat="server" CssClass="box3" 
                                                ValidationGroup="A1" Width="100px"> </asp:TextBox><asp:RequiredFieldValidator 
                                                ID="RequiredFieldValidator22" runat="server" ControlToValidate="txtPAN2" 
                                                ErrorMessage="*" ValidationGroup="A1"> </asp:RequiredFieldValidator></td>
                                              <td>
                    ...
                    <cc1:TabPanel ID="TabPanel3" runat="server" HeaderText="TabPanel3">
                        ...
                        <asp:GridView ID="GridView2" runat="server" 
                                ...
                                </ItemTemplate><ItemStyle HorizontalAlign="Left" Width="13%" /></asp:TemplateField>
                                <asp:TemplateField HeaderText="Purpose Type"><ItemTemplate><asp:Label ID="lblType" runat="server" Text='<%#Eval("Type") %>'></asp:Label></ItemTemplate><ItemStyle HorizontalAlign="Left" Width="10%" /></asp:TemplateField><asp:TemplateField HeaderText="For Purpose Type For"><ItemTemplate><asp:Label ID="lblWONo" runat="server" Text='<%#Eval("TypeFor") %>'></asp:Label></ItemTemplate><ItemStyle HorizontalAlign="Center" Width="7%" /></asp:TemplateField>
