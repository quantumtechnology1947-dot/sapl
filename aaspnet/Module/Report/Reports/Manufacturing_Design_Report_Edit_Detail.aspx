<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Manufacturing_Design_Report_Edit_Detail.aspx.cs" Inherits="Challanreport" %>
...
<hr />
 ...
 <asp:TemplateField Visible="True"  >
                    ...
                    <ItemTemplate>
                        <asp:CheckBox ID="chkitems1"  runat="server"
        AutoPostBack="False" OnCheckedChanged="Selected_chk_Changed" Visible="True" />
                    </ItemTemplate>
                  </asp:TemplateField>
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                ...
                <ItemTemplate>
                <asp:TextBox ID="lblbomqty" runat="server" Text='<%#Eval("BOMQ") %>'></asp:TextBox>
                </ItemTemplate>
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                  ...
                  <asp:TemplateField HeaderText="Design" >
                    <ItemTemplate>
                      ...
                      <asp:TemplateField HeaderText="Vendor Plan ">
                        <ItemTemplate>
                         <asp:TextBox ID="txtven1" runat="server"   Visible="True" ></asp:TextBox>
                        </ItemTemplate>
                      </asp:TemplateField>            
                      
                    <asp:TemplateField HeaderText="Vendor Actual" Visible="True"  >
                <ItemTemplate>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT [ItemCode],[Description],[UOM],[BOMQ],[WONo] ,[Design] FROM [tblPM_Project_Site_Master_Detail] WHERE ([PRJCTNO] = @PRJCTNO)">
    <SelectParameters>
...
&nbsp;&nbsp;&nbsp; Checked By &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
   ...
   <br />
    ...
    <asp:Button ID="Button1" Visible="True" runat="server" BackColor="Red" ForeColor="White" Text="Update" OnClick="Button1_Click" />
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
