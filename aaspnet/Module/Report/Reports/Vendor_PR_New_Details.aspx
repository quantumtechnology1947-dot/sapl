<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Vendor_PR_New_Details.aspx.cs" Inherits="Module_MaterialManagement_Transactions_PR_New_Detail" Title="ERP" Theme ="Default"  %>
...
<CommandItemSettings   ExportToPdfText="Export to Pdf"></CommandItemSettings>
   ...
   <ItemStyle HorizontalAlign="Center" VerticalAlign="Top" Width="20px" ></ItemStyle>       
       ...
       <HeaderStyle HorizontalAlign="center" Width="60px"  />
        ...
        <telerik:GridTemplateColumn HeaderText="Design" Visible="True">
        <ItemTemplate>
        ...
        <telerik:GridTemplateColumn HeaderText="Vendor1" Visible="True">
        <ItemTemplate>
        <asp:TextBox ID="txtven1" runat="server" Enabled="True" ></asp:TextBox>
        </ItemTemplate>
           <ItemStyle HorizontalAlign="Right"  VerticalAlign="Top" Width="40px"   />
            <HeaderStyle HorizontalAlign="center" Width="40px"   />
        </telerik:GridTemplateColumn>
        
         <telerik:GridTemplateColumn HeaderText="Vendor2" Visible="True">
        <ItemTemplate>
        <asp:TextBox ID="txtven2" runat="server"  Enabled="True" ></asp:TextBox>
        </ItemTemplate>
           <ItemStyle HorizontalAlign="Right"  VerticalAlign="Top" Width="40px"   />
            <HeaderStyle HorizontalAlign="center" Width="40px"   />
        </telerik:GridTemplateColumn>
        
         <telerik:GridTemplateColumn HeaderText="Remark" Visible="True">
        <ItemTemplate>
    ...
    <td align="center" style="height:25px" valign="middle">
                    ...
                    onclick="RadButton2_Click_Add" Skin="Default"/>
    ...
    <tr>
            <td align="center" style="height:25px" valign="middle" >
                ...
                <asp:Button ID="RadButton1" Text="Generate Vendor Report"  runat="server" 
