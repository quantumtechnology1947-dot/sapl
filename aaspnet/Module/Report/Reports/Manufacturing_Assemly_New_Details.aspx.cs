...
public partial class Module_MaterialManagement_Transactions_PR_New_Detail : System.Web.UI.Page
{
    ...
    protected void display1()
    {
        ...
        String strQuery = "select distinct VendorPlan, WONO, GenDate,PRJCTNO from tblPM_Project_Manufacturing_VendorD where" + " VendorPlan = @VendorPlan";
    ...
    public void MP_Tree1()
    {
        ...
        try
        {
            ...
            DataRow dr;
            string sql = "select ItemCode,Description,UOM,BOMQ,Design,VendorPlanDate,VendorAct From tblPM_Project_Manufacturing_Plan_Detail Where VendorPlan='" + lblreport1.Text + "'";
    ...
    public void Display()
    {
        ...
        using (SqlConnection cnz = new SqlConnection(conStr))
        {
            ...
            SqlCommand cmdzs = new SqlCommand("SELECT MAX((AssemlyNo) + 1) as AssemlyNo FROM tblPM_Project_Manufacturing_Assemly_Master ", cnz);
    ...
    protected void RadButton2_Click_Cancel(object sender, EventArgs e)
    {
        ...
        foreach (GridDataItem grv2 in RadGrid1.Items)
        {
            ...
            {
                grv2.BackColor = System.Drawing.Color.Pink;
                cmd1 = new SqlCommand("INSERT INTO tblPM_Project_Manufacturing_Assemly_Detail(PRJCTNO,WONo,ItemCode,Description,UOM,BOMQ,Design,VendorPlanDate,VendorAct,VendorPlan,AssemlyDate,AssemlyNo) values(@PRJCTNO,@WONo,@ItemCode,@Description,@UOM,@BOMQ,@Design,@VendorPlanDate,@VendorAct,@VendorPlan,@AssemlyDate,@AssemlyNo)", con);
    ...
    {
        Response.Redirect("~/Module/Report/Reports/Manufacturing_Assemly_New_Report_Info.aspx?", true);
    }
    protected void RadButton1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string sqlStatment = "INSERT INTO tblPM_Project_Manufacturing_Assemly_Master(SysDate,SysTime,CompId,SessionId,FinYearId,PRJCTNO,WONo,GenDate,VendorPlan,VendorDate,AssemlyNo,AssemlyDate) VALUES(@SysDate,@SysTime,@CompId,@SessionId,@FinYearId,@PRJCTNO,@WONo,@GenDate,@VendorPlan,@VendorDate,@AssemlyNo,@AssemlyDate)";
