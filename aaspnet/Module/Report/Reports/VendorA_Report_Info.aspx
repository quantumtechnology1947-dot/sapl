<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="VendorA_Report_Info.aspx.cs" Inherits="ChallanInfo" Title="ERP" %>
...
<asp:Content ID="Content8" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
 <table align="center" cellpadding="0" cellspacing="0" width="100%" >
    <tr height="21">
        <td style="background:url(../../../images/hdbg.JPG)" class="fontcsswhite" >&nbsp;<b>Assemly Report </b></td>
    </tr></table>
    <br />
                                
<asp:GridView ID="GridView1" runat="server" DataKeyNames="PRJCTNO" AllowPaging="False"  
...
<HeaderStyle BackColor="#BDBDBD"></HeaderStyle>
  ...
  <EditItemTemplate>
  <asp:Label runat="server" ID="lbl14" Text='<%# Eval("VendorPlan") %>'></asp:Label>
  </EditItemTemplate>
   <ItemTemplate>
   ...
   <asp:BoundField DataField="SysDate" HeaderText="Gen Date" SortExpression="SysDate" HeaderStyle-BackColor = "#BDBDBD"/>
         <asp:BoundField DataField="SessionId" HeaderText="Gen By" SortExpression="SessionId" HeaderStyle-BackColor = "#BDBDBD"/>
          ...
          <asp:BoundField DataField="VendorPlan" HeaderText="Report No. " Visible="false" SortExpression="VendorPlan" HeaderStyle-BackColor = "#BDBDBD" />
        ...
        SelectCommand="SELECT distinct VendorPlan,VendorDate,SessionId,WONo FROM tblPM_Project_Hardware_VendorD order by VendorPlan asc" >
         </asp:SqlDataSource>
   ...
   <asp:GridView ID="GridView2" runat="server" DataKeyNames="Id" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
 <asp:LinkButton ID="View" runat="server" CommandName="Select" CommandArgument='<%# Bind("VendorPlan") %>'>View</asp:LinkButton>                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Report No.">
                        <ItemTemplate>
                            <asp:Label ID="lblPRNo" runat="server" Text='<%# Bind("VendorPlan") %>'></asp:Label>
                        </ItemTemplate>                       
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
