...
public partial class Challanreport : System.Web.UI.Page
{
    ...
    protected void display()
    {
        ...
        String strQuery = "select distinct VendorPlan, WONO, GenDate from tblPM_Project_Manufacturing_VendorD where" + " VendorPlan = @VendorPlan";
    ...
    public void DisplayRecord()
    {
        ...
        string sql1 = string.Format("select Id,VendorPlan,ItemCode,Description,UOM,BOMQ,Design,VendorPlanDate,VendorAct from tblPM_Project_Manufacturing_Plan_Detail where VendorPlan = '" + Labeldc.Text + "'");
    ...
    {
        Response.Redirect("~/Module/Report/Reports/Boughtout_Report_Info_Edit.aspx?ModId=18&SubModId=159", true);
