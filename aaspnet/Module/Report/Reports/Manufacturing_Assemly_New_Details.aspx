<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Manufacturing_Assemly_New_Details.aspx.cs" Inherits="Module_MaterialManagement_Transactions_PR_New_Detail" Title="ERP" Theme ="Default"  %>
...
<div style="width:99.9%; height:auto; position:relative; margin:0px 0px 0px 0px; top: 0px; left: 0px;" >
             ...
             <table width="100%" align="center" cellpadding="0" cellspacing="0">
                    <tr >                   
                       ...
                       <strong>Assemly No: </strong>
                       <asp:Label runat="server" ID="lblreport2"></asp:Label>
                       &nbsp;&nbsp;&nbsp;&nbsp;<strong></strong>
                       <asp:Label runat="server" ID="lblreportdate"></asp:Label>
                        ...
                        <asp:Label runat="server" ID="lblreportdate1"></asp:Label>
                         <strong>Assemly Date</strong>
                        <asp:Label runat="server" ID="lblreportdate2"></asp:Label>
                        &nbsp;&nbsp;&nbsp;<strong>WONo:</strong>
...
<CommandItemSettings   ExportToPdfText="Export to Pdf"></CommandItemSettings>
   ...
   <ItemStyle HorizontalAlign="Center" VerticalAlign="Top" Width="20px" ></ItemStyle>       
       ...
       <HeaderStyle HorizontalAlign="center" Width="60px"  />
        ...
        <ItemTemplate>
        <asp:Label ID="txtven1" runat="server" Text='<%#Eval("VendorPlanDate") %>' ></asp:Label>
        ...
        <ItemTemplate>
        <asp:Label ID="txtven2" runat="server"  Text='<%#Eval("VendorAct") %>'  ></asp:Label>
         ...
         <telerik:GridTemplateColumn HeaderText="Assemly" >
        <ItemTemplate>
        <asp:TextBox ID="txtassm" runat="server" Enabled="false" ></asp:TextBox>
        <cc1:CalendarExtender ID="CalendarExtenderFin"  Format="dd-MM-yyyy"
          PopupPosition="BottomRight" CssClass="cal_Theme1"
           Animated="True"  TargetControlID="txtassm" runat="server"></cc1:CalendarExtender> 
    ...
    <tr>
            <td align="center" style="height:25px" valign="middle" >
                ...
                <asp:Button ID="RadButton1" Text="Generate Assemly"  runat="server" 
