<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Manufacturing_Vendor_Report_Print_Detail.aspx.cs" Inherits="Challanreport" %>
...
&nbsp;<small>Email -&quot;sales@synergytechs.com&quot;</small><br />
    ...
    <center> 
            <hr />
        <asp:Label runat="server" ID="dclabel" Text="Vendor Report" 
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT [Id],[ItemCode],[Description],[UOM],[BOMQ],[WONo] ,[Design],[VendorPlanDate],[VendorAct] FROM [tblPM_Project_Vendor_Plan_Detail] WHERE ([PRJCTNO] = @PRJCTNO)">
    <SelectParameters>
