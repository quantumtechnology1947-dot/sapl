<%@ Page Language="C#" AutoEventWireup="true" masterpagefile="~/MasterPage.master" CodeFile="Appraisal.aspx.cs" Inherits="Appraisal" %>
 ...
 collapse;width:730pt; border-color:#2196f3;" width="100%" frame="box" >
  ...
  height:34px">
            ...
            <tr height="36" style="mso-height-source:userset;height:27.0pt">
                ...
                <td colspan="5" class="style34"><asp:CheckBoxList ID="CheckBox1" runat="server" >
                <asp:ListItem Text="Bus" Value="1"></asp:ListItem>
                 <asp:ListItem Text="Travel Allowance" Value="2"></asp:ListItem>
                  <asp:ListItem Text="Canteen" Value="3"></asp:ListItem>
                   <asp:ListItem Text="Punch Card" Value="4"></asp:ListItem>
       ...
       <asp:Button ID="Button1" runat="server" Text="SUBMIT" Width="40%" 
            BackColor="Red" ForeColor="White" OnClick="Submit_Click" />
