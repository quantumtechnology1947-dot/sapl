<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Vehical_Master.aspx.cs" Inherits="Module_MaterialPlanning_Masters_ItemProcess" Title="ERP" Theme ="Default"  %>
    ...
    <table cellpadding="0" cellspacing="0" align="center" style="width: 40%">
        ...
        <tr>
            ...
            <Columns> 
                    ...
                    <asp:TemplateField HeaderText="Name of Vehicle">
                    <ItemTemplate>
                    <asp:Label ID="lblProcessName" runat="server" Text='<%# Eval("VehicalName") %>'></asp:Label>                    
                  </ItemTemplate>
                  <EditItemTemplate>
                  <asp:TextBox ID ="txtPName" runat ="server" Width="95%"   CssClass="box3" Text='<%# Eval("VehicalName") %>'
                     ValidationGroup="A" >
                    </asp:TextBox>
                   ...
                   <FooterTemplate>
                    ...
                    <ItemTemplate>
                    <asp:Label ID="lblSymbol" runat="server" Text='<%# Eval("VehicalNo") %>'></asp:Label>
                    
                     </ItemTemplate>
                     <EditItemTemplate>
                     <asp:TextBox ID ="txtSymbol" CssClass="box3" Width="95%" runat ="server"  Text='<%# Eval("VehicalNo") %>'
                     ValidationGroup="A">
                    </asp:TextBox>
            ...
            <table  width="100%" border="1" style="border-color:Gray">
                    ...
                    <td></td>
                    <td align="center">
                        <asp:Label ID="Label1" Font-Bold="true" Font-Size="Medium" Font-Names="Times New Roman" runat="server" Text="Name of Vehical"></asp:Label></td>
                        
                        <td align="center">
                         <asp:Label ID="Label2" runat="server" Font-Size="Medium" Font-Names="Times New Roman"  Font-Bold="true" Text="Number"></asp:Label></td>
                         <td align="center">
                          <asp:Label ID="Label3" Visible="false" runat="server" Font-Size="Medium"  Font-Names="Times New Roman" Font-Bold="true" Text="UOM Basic"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <asp:DropDownList ID="DDLBasic" runat="server" Width="95%" CssClass="box3" 
                    DataSourceID="SqlDataSource2" DataTextField="Symbol" Visible="false" DataValueField="Id">
                    </asp:DropDownList></td>                    
                    </table>
            </EmptyDataTemplate>
