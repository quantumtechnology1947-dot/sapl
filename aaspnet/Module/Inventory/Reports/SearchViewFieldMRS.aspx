<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Inventory_Reports_SearchViewFieldMRS, newerp_deploy" title="ERP" theme="Default" %>
         ...
         <tr>
             <td valign="top">
                 ...
                 <table width="100%"><tr><td align="center">
                     <asp:Label ID="lblMRS" runat="server" style="font-weight: 700" ></asp:Label></td></tr></table>
             ...
             <td valign="top">             
                ...
                <table width="100%"><tr><td align="center">
                     <asp:Label ID="lblMIN" runat="server" style="font-weight: 700" ></asp:Label></td></tr></table>
...
<br />
 ...
 <asp:Panel ID="Panel1" ScrollBars="Auto" Height="382px" Width="99%"  
        runat="server">   
