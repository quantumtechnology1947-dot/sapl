<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Stock_StatementDUP.aspx.cs" Inherits="Module_Inventory_Reports_Stock_Statement" %>
    ...
    <table cellpadding="0" cellspacing="0" align="center"  class="box3">
        ...
        <tr>
            ...
            <td align="left" height="28" colspan="2">
                ...
                <asp:Label ID="lblFromDate" Visible="false" runat="server" style="font-weight: 700"></asp:Label>
                &nbsp;<b></b>
                <asp:Label ID="lblToDate" Visible="false" runat="server" style="font-weight: 700"></asp:Label>
            </td>
        </tr>
        <tr>
            <td height="21" align="left">
