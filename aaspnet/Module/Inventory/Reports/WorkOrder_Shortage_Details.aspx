<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="WorkOrder_Shortage_Details.aspx.cs" Inherits="Module_Inventory_Reports_WorkOrder_Shortage_Details" Title="Untitled Page" %>
...
<table align="center" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        ...
        &nbsp;<b>WorkOrder Shortage Print Details</b></td>            
    </tr>
    ...
    <tr>
        ...
        <asp:Panel ID="Panel1" runat="server" Height="450px" ScrollBars="Auto">
            ...
            <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                <Report FileName="~/Module/Inventory/Reports/WorkOrder_Shortage.rpt">
                </Report>
