<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Inventory_Transactions_Moving_NonMoving_Items_Details, newerp_deploy" title="ERP" theme="Default" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <table align="left" cellpadding="0" cellspacing="0" width="100%">
        ...
        &nbsp;<b> Moving Non-Moving Items</b></td>
        </tr>
        <tr>
            <td align="center">
        ...
        EnableParameterPrompt="False" ReportSourceID="CrystalReportSource1" Height="50px" 
                    ...
                    <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                        <Report FileName="Moving_NonMoving_Items.rpt"></Report>  
