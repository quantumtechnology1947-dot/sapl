...
public partial class Module_Inventory_Reports_ABCAnalysis_Details : System.Web.UI.Page
{
           ...
           try
            {
                ...
                DataRow dr;                
                    ...
                    if (ClosingQty > 0)
                    {
                        ...
                        dr[10] = ClosingQty;
                        double Amount = 0;
                        Amount = Convert.ToDouble(decimal.Parse((WisIssuQty * Rate).ToString()).ToString("N2"));
                ...
                xsdds.AcceptChanges();
                string reportPath = Server.MapPath("~/Module/Inventory/Reports/ABCAnalysis.rpt");
    ...
    {
        Response.Redirect("Abcanalysis.aspx?ModId=9");
    }
