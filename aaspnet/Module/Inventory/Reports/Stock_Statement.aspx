<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Inventory_Reports_ABCAnalysis, newerp_deploy" theme="Default" title="ERP" %>
    ...
    <table class="box3" cellpadding="0" cellspacing="0" align="center" width="50%">
        <tr>
            <td align="left" valign="middle" style="background:url(../../../images/hdbg.JPG)" 
                height="21" class="fontcsswhite" colspan="2"><b>&nbsp;Stock Statement</b>
                &nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="style11" valign="bottom" align="left">
                &nbsp; &nbsp;
            <asp:TextBox ID="TxtboxA" runat="server" Width="51px" Text="100" Visible="false"></asp:TextBox>
        
                &nbsp;
               
           <asp:TextBox ID="TxtboxB" runat="server" Width="51px" Text="0" Visible="false"></asp:TextBox>
        
        &nbsp;
              <asp:TextBox ID="TxtboxC" runat="server" Width="51px" Text="0" Visible="false"></asp:TextBox>
         &nbsp;
