<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Inventory_Transactions_MaterialReturnNote_MRN_Edit, newerp_deploy" title="ERP" theme="Default" %>
    ...
    <table  width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td   align="left" valign="middle" 
                ...
                class="fontcsswhite"><b>&nbsp;Material Return Note [MRN] - Edit</b></td>
        ...
        <tr>
                    ...
                    &nbsp;<asp:TextBox ID="TxtMrn" runat="server" Visible="False"  CssClass="box3"></asp:TextBox>
        ...
        <tr>
            <td align="left">
                ...
                <asp:Label ID="Id" runat="server" Text='<%# Eval("Id") %>' ></asp:Label>
                 ...
                 <asp:TemplateField HeaderText="FinYear Id"  Visible="false" ><ItemTemplate>
