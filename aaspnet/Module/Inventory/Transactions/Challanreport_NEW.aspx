<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Challanreport_NEW.aspx.cs" Inherits="Challanreport" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT  [ItemCode],[Description],[HSN],[Quantity] ,[Rate],[Amount],[UOM] FROM [Challan_Details] WHERE ([DCNo] = @DCNo)">
    <SelectParameters>
