<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ChallanInfo_NEW.aspx.cs" Inherits="ChallanInfo" Title="ERP" %>
...
<asp:GridView ID="GridView1" runat="server" DataKeyNames="DCNo" AllowPaging="True" PageSize="10000" 
  ...
  <asp:Label runat="server" ID="lbl14" Text='<%# Eval("DCNo") %>'></asp:Label>
   ...
   <asp:BoundField DataField="CustomerName" HeaderText="Customer Name" SortExpression="CustomerName" HeaderStyle-BackColor = "#BDBDBD"/>
         ...
         <asp:BoundField DataField="DCDate" HeaderText="Id" SortExpression="Id" HeaderStyle-BackColor = "#BDBDBD" Visible="false"/>
           </Columns>
             </asp:GridView>
             <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:LocalSqlServer%>"
        SelectCommand="SELECT  CustomerName,Address,DCNo,DCDate FROM Challan_Master ORDER BY ID DESC " >
         </asp:SqlDataSource>
