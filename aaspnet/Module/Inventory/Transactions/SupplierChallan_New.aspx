<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Inventory_Transactions_SupplierChallan_New, newerp_deploy" title="ERP" theme="Default" %>
...
<ItemStyle  Width="5%" HorizontalAlign="Right"></ItemStyle>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="SupplierId" 
                            DataNavigateUrlFormatString="~/Module/Inventory/Transactions/SupplierChallan_New_Details.aspx?SupplierId={0}&ModId=9&SubModId=118" 
