<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Inventory_Transactions_CustomerChallan_Print, newerp_deploy" title="ERP" theme="Default" %>
                ...
                <table width="100%" align="center" cellpadding="0" cellspacing="0">
                    <tr >
                        <td style="background:url(../../../images/hdbg.JPG)" class="fontcsswhite" 
                            colspan="2">&nbsp;<strong> 
                            Customer Challan - Print</strong></td>
                    </tr>
...
<ItemStyle  Width="5%" HorizontalAlign="Right"></ItemStyle>
                     ...
                     <asp:TemplateField HeaderText="CCNo">
                    <ItemTemplate>
                    <asp:LinkButton ID ="lnkButton"  Text='<%# Eval("CCNo") %>' runat ="server" CommandName="sel">
                    </asp:LinkButton>
                    </ItemTemplate>
