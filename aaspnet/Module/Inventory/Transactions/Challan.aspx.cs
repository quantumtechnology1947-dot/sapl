...
public partial class Challan : System.Web.UI.Page
{
   ...
   //// For Name Extender  /////
    ...
    {
        string sqlTrunc = "Delete  From Challantemp";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand("INSERT INTO Challantemp (DCNo,ItemCode,Description,UOM ,HSN ,Quantity,Rate,Amount) values(@DCNo,@ItemCode,@Description ,@UOM,@HSN ,@Quantity,@Rate,@Amount)", con);
        cmd.Parameters.AddWithValue("@ItemCode", TxtItemCode.Text);
    ...
    protected void Save(string Item, string Desc, string hsn, string Qty, string r, string amt  )
    {
        try
        {
            ...
            string sqlStatment = "INSERT INTO Challan(SysDate,SysTime,SessionId,CompId,FinYearId,CustomerName,Address,GST, DCNo,DCDate,Attention,Contact,Responsible_By,Type,ItemCode,Description,UOM,HSN,Quantity,Rate,Amount,TQty,TAmt,Gst_per,GTotal,Remark,Transport,vehicleNo,LRNo,Acknowledgement,GSTWORDS) VALUES(@SysDate,@SysTime,@SessionId,@CompId,@FinYearId,@CustomerName,@Address,@GST,@DCNo,@DCDate,@Attention,@Contact,@Responsible_By,@Type,@ItemCode,@Description,@UOM,@HSN,@Quantity,@Rate,@Amount,@TQty,@TAmt,@Gst_per,@GTotal,@Remark,@Transport,@vehicleNo,@LRNo,@Acknowledgement,@GSTWORDS)";
            {
