<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Inventory_Transactions_MaterialReturnNote_MRN_Print, newerp_deploy" title="ERP" theme="Default" %>
    ...
    <table  width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td   align="left" valign="middle" 
                ...
                class="fontcsswhite"><b>&nbsp;Material Return Note [MRN] - Print&nbsp;&nbsp;&nbsp; </b></td>
        </tr>
        <tr>
        <td width="600px" class="style2">
        ...
        <tr>
            <td align="Left">
                ...
                <asp:TemplateField HeaderText="Id"  Visible="false" ><ItemTemplate><asp:Label ID="Id" runat="server" Text='<%# Eval("Id") %>' ></asp:Label></ItemTemplate></asp:TemplateField>
                 ...
                 <asp:TemplateField HeaderText="FinYear Id"  Visible="false" ><ItemTemplate><asp:Label ID="lblFyId" runat="server" Text='<%# Eval("FinYearId") %>' ></asp:Label></ItemTemplate>
                     <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
