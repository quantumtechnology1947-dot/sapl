<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Inventory_Transactions_GoodsReceivedReceipt_GRR_Delete_Details, newerp_deploy" title="ERP" theme="Default" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <table align="center" cellpadding="0" cellspacing="0" class="style2">
        <tr>
            <td align="left" valign="middle" style="background:url(../../../images/hdbg.JPG)" height="21" class="fontcsswhite"><b>&nbsp;Goods Received Receipt [GRR] - Delete</b></td>
        </tr>
        <tr>
                ...
                <table align="center" cellpadding="0" cellspacing="0" class="style2" 
                    ><tr><td class="style8" 
                        ...
                        <asp:GridView runat="server" AllowPaging="True" 
                            ...
                            Width="100%" ID="GridView2" OnPageIndexChanging="GridView2_PageIndexChanging" 
                            OnRowCommand="GridView2_RowCommand" PageSize="15">
...
<ItemStyle HorizontalAlign="Right" VerticalAlign="Top" Width="3%"></ItemStyle>
 ...
 <asp:LinkButton runat="server" ID="LinkButton1" OnClientClick="return confirmationDelete()"  CommandName="del"  Text="Delete"  />  
...
<EmptyDataTemplate>
        ...
        <tr>
            <td align="center" height="21" valign="bottom">
