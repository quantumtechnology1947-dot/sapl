<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Inventory_Transactions_GoodsReceivedReceipt_GRR_Delete, newerp_deploy" title="ERP" theme="Default" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <table align="left" cellpadding="0" cellspacing="0" class="style2">
        ...
        <tr>
            <td class="style3">
                &nbsp;Supplier:
                <asp:TextBox ID="txtSupplier" runat="server" Width="332px" CssClass="box3"></asp:TextBox>
