<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Inventory_Transactions_SupplierChallan_Delete, newerp_deploy" title="ERP" theme="Default" %>
                ...
                <table width="100%" align="center" cellpadding="0" cellspacing="0">
                    <tr height="21">
                        <td style="background:url(../../../images/hdbg.JPG)" class="fontcsswhite" 
                            colspan="2">&nbsp;<strong> 
                            Supplier Challan - Delete</strong></td>
                    </tr>
...
<ItemStyle  Width="5%" HorizontalAlign="Right"></ItemStyle>
                        ...
                        <asp:BoundField DataField="FinYear" HeaderText="Fin Yrs"  >
                           ...
                           <asp:HyperLinkField DataNavigateUrlFields="Id" 
                            DataNavigateUrlFormatString="~/Module/Inventory/Transactions/SupplierChallan_Delete_Details.aspx?Id={0}&ModId=9&SubModId=118" 
                            DataTextField="SCNo" HeaderText="SCNo">
