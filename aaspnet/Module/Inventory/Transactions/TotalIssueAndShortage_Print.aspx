<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TotalIssueAndShortage_Print.aspx.cs" Inherits="Module_Inventory_Transactions_TotalIssueAndShortage_Print" Title="Untitled Page" %>
    ...
    <tr>
        ...
        <asp:Panel ID="Panel1" runat="server" Height="450px" ScrollBars="Auto">
            ...
            <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                <Report FileName="~\Module\Inventotry\Transactions\Reports\TotalIssueAndShortage.rpt">
                </Report>
