<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="WIS_ActualRun_Material.aspx.cs" Inherits="Module_Inventory_Transactions_WIS_ActualRun_Material" Title="ERP" Theme="Default" %>
...
<ContentTemplate>
    ...
    <tr>
<td align="left" height="25">&nbsp;<b>WIS Dry Run for Material of Work Order No.:</b>
    <asp:Label ID="Label2" runat="server"></asp:Label>
    &nbsp;&nbsp; <asp:CheckBox  runat="server" ID="CheckBox1"
AutoPostBack="True"  Visible="true" oncheckedchanged="CheckBox1_CheckedChanged" /><b>
    Expand Tree
    &nbsp;<asp:Button ID="Button2" runat="server" CssClass="redbox" 
        onclick="Button2_Click" Text="Actual Run of Material" />
