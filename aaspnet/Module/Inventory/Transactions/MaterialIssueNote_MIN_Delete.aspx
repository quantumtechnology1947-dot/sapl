<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Inventory_Transactions_MaterialIssueNote_MIN_Delete, newerp_deploy" title="ERP" theme="Default" %>
...
<table  width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td align="left" valign="middle" 
                ...
                class="fontcsswhite" ><b>&nbsp;Material Issue Note [MIN] - Delete</b></td>
        </tr>
            <tr>
        <td width="600px" align="left" class="style2">
        ...
        <tr>
            <td align="left">
                ...
                <asp:TemplateField HeaderText="Id"  Visible="false" ><ItemTemplate><asp:Label ID="Id" runat="server" Text='<%# Eval("Id") %>' ></asp:Label></ItemTemplate></asp:TemplateField>
                 ...
                 <asp:TemplateField HeaderText="MIN No" ><ItemTemplate><asp:Label ID="lblMINNo" runat="server" Text='<%# Eval("MINNo") %>' ></asp:Label></ItemTemplate>
