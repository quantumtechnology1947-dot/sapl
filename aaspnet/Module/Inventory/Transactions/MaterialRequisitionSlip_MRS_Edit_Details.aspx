<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Inventory_Transactions_MaterialRequisitionSlip_MRS_Edit_Details, newerp_deploy" title="ERP" theme="Default" %>
        ...
        <tr>
            <td align="left" >
                <asp:GridView ID="GridView1" runat="server" CssClass="yui-datatable-theme" 
                    AllowPaging="True" AutoGenerateColumns="False" Width="100%" onpageindexchanging="GridView1_PageIndexChanging" 
                    ...
                    <asp:TemplateField ShowHeader="False">
                        <ItemTemplate>
                            <asp:LinkButton ID="LinkButton1" OnClientClick="return confirmationUpdate()" runat="server" CausesValidation="False" 
                                ...
                                <asp:Label ID="lblmin" runat="server" Text="MIN" Visible="false"></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                ...
                <ItemStyle HorizontalAlign="Right" />
                 ...
                 </ItemTemplate><ItemStyle HorizontalAlign="Center" Width="7%" />
                 </asp:TemplateField>
                 
                 <asp:TemplateField HeaderText="Item Code">
                 <ItemTemplate><asp:Label ID="lblItemCode" runat="server" Text='<%# Eval("ItemCode") %>' ></asp:Label>
                 </ItemTemplate>
                 <ItemStyle HorizontalAlign="Center" Width="12%"/>
                  ...
                  <ItemStyle HorizontalAlign="Left" Width="30%" />
                   ...
                   <asp:ListItem Text="Select" Value="0"></asp:ListItem>
                    ...
                    <ItemStyle Font-Bold="True" HorizontalAlign="Center" Width="8%" />
                ...
                <asp:DropDownList ID="drpdept" DataSourceID="SqlDataSource1" SelectedValue='<%# Eval("DeptId") %>' DataTextField="Dept" DataValueField="Id"
                  runat="server" CssClass="box3" Visible="false">
                  </asp:DropDownList>
                <asp:TextBox ID="txtwono" runat="server" Text='<%# Eval("WO") %>'  Width="75%" CssClass="box3" Visible="false">
                </asp:TextBox>
                ...
                <ItemStyle HorizontalAlign="Center" Width="8%" />
                  ...
                  <asp:TemplateField HeaderText="StockQty" Visible="True">
                <ItemTemplate>
                ...
                <EditItemTemplate>
                 <asp:TextBox ID="txtqty"  Text='<%# Eval("ReqQty") %>' runat="server" Width="75%" CssClass="box3"  ></asp:TextBox>
