...
public partial class Challanreport : System.Web.UI.Page
{
    ...
    protected void display()
    {
        ...
        String strQuery = "select distinct CustomerName,Address,GST,DCNo,DCDate,Attention,Contact,Responsible_By,Type,TQty,TAmt,Gst_per,(((Gst_per)*(TAmt))/100) AS GTotal ,((((Gst_per)*(TAmt))/100) + TAmt) As GrandTotal,Remark,Transport,vehicleNo,LRNo,Acknowledgement,GSTWORDS from Challan where" + " DCNo = @DCNo";
