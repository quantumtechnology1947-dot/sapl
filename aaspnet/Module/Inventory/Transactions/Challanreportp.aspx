<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Challanreportp.aspx.cs" Inherits="Challanreport" %>
           ...
           <table >
            <tr align="right">
                <td align="right">
                    ...
                    <asp:Label runat="server" ID="IDl" Text="CHALLAN:- " Font-Bold="True"></asp:Label>
               &nbsp;&nbsp; ORIGINAL
               <br />
                &nbsp; &nbsp;
               DUPLICATE
...
&nbsp;:- &nbsp;<asp:Label ID="TQ" runat="server" ></asp:Label>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;GST Total&nbsp; :&nbsp;<asp:Label ID="LabelGT" runat="server"></asp:Label>
