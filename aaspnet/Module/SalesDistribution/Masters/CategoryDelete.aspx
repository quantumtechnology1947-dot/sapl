<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_SalesDistribution_Masters_CategoryDelete, newerp_deploy" title="ERP" theme="Default" %>
    ...
    <table cellpadding="0" cellspacing="0" width="100%" align="center">
        ...
        <tr>
            <td align="left" valign="top">
               ...
               CssClass="yui-datatable-theme" Width="50%" DataKeyNames="CId" 
                    onrowdeleted="GridView1_RowDeleted" 
                    onrowdatabound="GridView1_RowDataBound" PageSize="17" onrowdeleting="GridView1_RowDeleting" 
                   >
...
<FooterStyle Wrap="True"></FooterStyle>
            ...
            <table width="100%" class="fontcss">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [tblSD_WO_Category] WHERE [CId] = @CId" 
                    
                    SelectCommand="SELECT * FROM [tblSD_WO_Category]WHERE (([CompId] = @CompId) AND ([FinYearId] &lt;= @FinYearId)) order by [CId] desc">
                    <DeleteParameters>
