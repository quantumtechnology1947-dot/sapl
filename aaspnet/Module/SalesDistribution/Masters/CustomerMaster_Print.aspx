<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_SalesDistribution_Masters_CustomerMaster_Print, newerp_deploy" title="ERP" theme="Default" %>
 ...
 <table width="100%" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td>
                <table width="100%" align="center" cellpadding="0" cellspacing="0">
                    <tr height="21">
                        <td style="background:url(../../../images/hdbg.JPG)" class="fontcsswhite">&nbsp;<strong> Customer Master - 
                            Print</strong></td>
                    </tr>
                    ...
                    runat="server" CompletionInterval="100" CompletionSetCount="1" 
                            ...
                            <asp:Button ID="Search" runat="server" onclick="Search_Click" Text="Search" 
                                CssClass="redbox" />
                        &nbsp;<asp:Button ID="btnPrintAll" runat="server" CssClass="redbox" 
            ...
            <td>
                ...
                <asp:GridView ID="SearchGridView1" runat="server" AllowPaging="True" 
                    ...
                    CssClass="yui-datatable-theme" PageSize="16">
...
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="CustomerId,Key" 
                            DataNavigateUrlFormatString="~/Module/SalesDistribution/Masters/CustomerMaster_Print_Details.aspx?CustomerId={0}&amp;Key={1}&amp;ModId=2&amp;SubModId=7" 
                      ...
                      <asp:TemplateField HeaderText="Key" ItemStyle-HorizontalAlign="Right" Visible="false">                     
                       <ItemTemplate>
