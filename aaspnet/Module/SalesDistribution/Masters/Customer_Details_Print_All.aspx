<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_SalesDistribution_Masters_Customer_Details_Print_All, newerp_deploy" title="ERP" theme="Default" %>
...
<CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" HasCrystalLogo="False"
        ...
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server" >
            <Report FileName="Module\SalesDistribution\Masters\Reports\CustomerPrintReportAll.rpt">
            </Report>
