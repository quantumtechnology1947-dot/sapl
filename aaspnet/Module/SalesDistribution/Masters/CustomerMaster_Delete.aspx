<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_SalesDistribution_Masters_CustomerMaster_Delete, newerp_deploy" title="ERP" theme="Default" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server"><p><br /></p><p></p>
</asp:Content>
   ...
   <table width="100%" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td>
                <table width="100%" align="center" cellpadding="0" cellspacing="0">
                    <tr height="21">
                        <td style="background:url(../../../images/hdbg.JPG)" class="fontcsswhite">&nbsp;<strong> Customer Master - Delete</strong></td>
                    </tr>
...
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="CustomerId" 
                            DataNavigateUrlFormatString="~/Module/SalesDistribution/Masters/CustomerMaster_Delete_Details.aspx?CustomerId={0}&amp;ModId=2&amp;SubModId=7" 
                        ...
                        <asp:BoundField DataField="SysDate" HeaderText="Gen. Date" />                  <asp:BoundField DataField="EmployeeName" HeaderText="Gen. By" >
