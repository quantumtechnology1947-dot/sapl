<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_SalesDistribution_Transactions_WorkOrder_close, newerp_deploy" title="ERP" theme="Default" %>
...
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                ...
                <asp:Label ID="LblId" runat="server" Text='<%# Eval("Id") %>'></asp:Label>
                  ...
                  <asp:BoundField DataField="Id" HeaderText="Id" Visible="false"/>  
                    ...
                    <ItemTemplate>
                        <asp:TextBox ID="txtremarks" Width="95%"  CssClass="box3" runat="server"></asp:TextBox>
                    </ItemTemplate>
                    ...
                    <ItemTemplate>
                        <asp:LinkButton ID="btnOpen" runat="server" CommandName="Open" >Open</asp:LinkButton>
                        <asp:LinkButton ID="BtnClosed" runat="server" CommandName="Close"  >Close</asp:LinkButton>
                    </ItemTemplate>
                          <ItemStyle HorizontalAlign="Center" Width="6%" />
                    </asp:TemplateField>  
