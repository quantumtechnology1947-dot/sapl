<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_SalesDistribution_Transactions_CustEnquiry_Delete, newerp_deploy" title="ERP" theme="Default" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <table width="100%" align="center" cellpadding="0" cellspacing="0" Class="fontcss">
        <tr>
            <td>
                <table width="100%" align="center" cellpadding="0" cellspacing="0">
                    <tr height="21">
                        <td style="background:url(../../../images/hdbg.JPG)" class="fontcsswhite" >&nbsp;<strong> Customer Enquiry - Delete</strong></td>
                    </tr>
        ...
        <asp:GridView ID="SearchGridView1" runat="server" AllowPaging="True" 
                    ...
                    DataKeyNames="EnqId" RowStyle-HorizontalAlign ="Center"
...
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                ...
                <asp:HyperLinkField DataTextField="CustomerName" HeaderText="Customer" 
                    ...
                    DataNavigateUrlFormatString="~/Module/SalesDistribution/Transactions/CustEnquiry_Delete_Details.aspx?CustomerId={1}&amp;EnqId={2}&amp;ModId=2&amp;SubModId=10" >
