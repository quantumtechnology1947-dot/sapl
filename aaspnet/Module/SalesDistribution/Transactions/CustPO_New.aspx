<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_SalesDistribution_Transactions_CustPO_New, newerp_deploy" title="ERP" theme="Default" %>
...
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="CustomerId,EnqId" 
                        DataNavigateUrlFormatString="~/Module/SalesDistribution/Transactions/CustPO_New_Details.aspx?CustomerId={0}&amp;EnqId={1}&amp;ModId=2&amp;SubModId=11" 
                        DataTextField="EnqId" HeaderText="Enquiry No" 
                        >           
