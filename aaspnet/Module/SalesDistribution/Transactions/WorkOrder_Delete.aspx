<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_SalesDistribution_Transactions_SalesOrder_Delete, newerp_deploy" title="ERP" theme="Default" %>
...
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                ...
                <asp:TemplateField >
                <ItemTemplate>
                    <asp:LinkButton ID="BtnDelete"  runat="server" CommandName="Del"  OnClientClick="return confirmationDelete()" >Delete</asp:LinkButton>
                </ItemTemplate>
