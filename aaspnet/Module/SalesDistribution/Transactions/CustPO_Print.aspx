<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_SalesDistribution_Transactions_CustPO_Print, newerp_deploy" title="ERP" theme="Default" %>
...
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                    ...
                    <ItemTemplate>
                    <asp:LinkButton ID ="lnkButton"  Text='<%# Eval("PONo") %>' runat ="server" CommandName="sel">
                    </asp:LinkButton>
                    </ItemTemplate>
                    ...
                    <ItemStyle HorizontalAlign="Center" Width="3%" />
                           ...
                           <asp:TemplateField HeaderText="POId" SortExpression="Id" Visible="False">
                                <ItemTemplate>
