<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_SalesDistribution_Transactions_CustPO_Edit, newerp_deploy" title="ERP" theme="Default" %>
        ...
        <asp:Button ID="btnSearch" runat="server" 
            ...
            <td>
                ...
                <asp:GridView ID="SearchGridView1" runat="server" AllowPaging="True"  CssClass="yui-datatable-theme"
                    ...
                    DataKeyNames="PONo" RowStyle-HorizontalAlign ="Center" PageSize="20"
...
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                                    ...
                                    <asp:HyperLinkField DataNavigateUrlFields="CustomerId,PONo,EnqId,POId" 
                                        DataNavigateUrlFormatString="~/Module/SalesDistribution/Transactions/CustPO_Edit_Details.aspx?CustomerId={0}&amp;PONo={1}&amp;EnqId={2}&amp;POId={3}&amp;ModId=2&amp;SubModId=11" 
