<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_SalesDistribution_Transactions_Quotation_Print, newerp_deploy" title="ERP" theme="Default" %>
        ...
        <tr>
            <td>
                <table width="100%" align="center" cellpadding="0" cellspacing="0">
                    <tr height="21">
                         <td style="background:url(../../../images/hdbg.JPG)" class="fontcsswhite">&nbsp;<b>Customer Quotation -Print</b></td>
                    </tr>
...
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                    ...
                    <ItemTemplate>
                    <asp:LinkButton ID ="lnkButton"  Text='<%# Eval("QuotationNo") %>' runat ="server" CommandName="sel">
                    </asp:LinkButton>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
