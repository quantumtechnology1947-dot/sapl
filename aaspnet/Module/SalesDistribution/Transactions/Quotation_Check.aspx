<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_SalesDistribution_Transactions_Quotation_Check, newerp_deploy" title="ERP" theme="Default" %>
    ...
    <table align="left" cellpadding="0" cellspacing="0" class="style2">
        <tr>
            <td valign="top">
                ...
                style="background:url(../../../images/hdbg.JPG)">&nbsp;<b>Quotation Check</b></td>
                    </tr>
                    <tr>
                        <td height="25">
...
<ItemStyle HorizontalAlign="Center" Width="7%"></ItemStyle>
                                    ...
                                    <ItemStyle HorizontalAlign="center"></ItemStyle>
                                    <FooterTemplate>
                                    <asp:Button ID="Check" Text="Checked" CssClass="redbox" runat="server" 
                                    OnClientClick=" return confirmation()" CommandName="check"/>
                                    </FooterTemplate>
                                    </asp:TemplateField>
