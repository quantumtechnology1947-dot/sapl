<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_SalesDistribution_Transactions_Quotation_Edit, newerp_deploy" title="ERP" theme="Default" %>
...
<ItemStyle HorizontalAlign="Right" Width="3%"></ItemStyle>
                                    ...
                                    <asp:HyperLinkField DataNavigateUrlFields="CustomerId,QuotationNo,EnqId,Id" 
                                        DataNavigateUrlFormatString="~/Module/SalesDistribution/Transactions/Quotation_Edit_Details.aspx?CustomerId={0}&amp;QuotationNo={1}&amp;EnqId={2}&amp;Id={3}&amp;ModId=2&amp;SubModId=63" 
