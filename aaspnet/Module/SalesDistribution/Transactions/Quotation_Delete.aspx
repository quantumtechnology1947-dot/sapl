<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_SalesDistribution_Transactions_Quotation_Delete, newerp_deploy" title="ERP" theme="Default" %>
            ...
            <td class="fontcsswhite" height="25" >
               ...
               <asp:DropDownList ID="DropDownList1" runat="server" Width="200px" 
                    ...
                    <asp:ListItem Value="1">Enquiry No</asp:ListItem>
                     <asp:ListItem Value="2">Quotation No</asp:ListItem>
                </asp:DropDownList>
...
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                                    ...
                                    <asp:HyperLinkField DataNavigateUrlFields="CustomerId,QuotationNo,EnqId,Id" 
                                        DataNavigateUrlFormatString="~/Module/SalesDistribution/Transactions/Quotation_Delete_Details.aspx?CustomerId={0}&amp;QuotationNo={1}&amp;EnqId={2}&amp;Id={3}&amp;ModId=2&amp;SubModId=63" 
                                        DataTextField="QuotationNo" HeaderText="Quotation No">
