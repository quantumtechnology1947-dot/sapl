<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_SalesDistribution_Transactions_WorkOrder_Release, newerp_deploy" title="ERP" theme="Default" %>
...
<table width="100%" align="center" cellpadding="0" cellspacing="0" Class="fontcss">
        <tr>
            <td>
                <table width="100%" align="center" cellpadding="0" cellspacing="0">
                    <tr >                   
                        <td height="21px" style="background:url(../../../images/hdbg.JPG)"  class="fontcsswhite" >&nbsp;<strong>Work Order -Release </strong>
        ...
        <asp:Button ID="btnSearch" runat="server" 
         ...
         <td>
                  ...
                  <asp:GridView ID="GridView1" runat="server" AllowPaging="True"  CssClass="yui-datatable-theme"
                    AllowSorting="True" AutoGenerateColumns="False" 
                    DataKeyNames="Id" RowStyle-HorizontalAlign ="Center"
                    
                    onpageindexchanging="GridView1_PageIndexChanging" Width="100%" PageSize="20" 
...
<ItemStyle HorizontalAlign="Right"></ItemStyle>
 ...
 <asp:BoundField DataField="FinYear" HeaderText="Fin Yrs">
                    ...
                    HeaderText="CustomerName" >
                                  ...
                                  <asp:HyperLinkField DataNavigateUrlFields="CustomerId,EnqId,Id,PONo,WONo" 
                    HeaderText="WO No" 
                    DataNavigateUrlFormatString="~/Module/SalesDistribution/Transactions/WorkOrder_ReleaseRPT.aspx?CustomerId={0}&amp;EnqId={1}&amp;Id={2}&amp;PONo={3}&amp;WONo={4}&amp;ModId=2&amp;SubModId=15" 
                    DataTextField="WONo" 
                    
                    NavigateUrl="~/Module/SalesDistribution/Transactions/WorkOrder_ReleaseRPT.aspx" >
                    <ItemStyle HorizontalAlign="Center" />
                </asp:HyperLinkField>
                ...
                <asp:BoundField DataField="Id" HeaderText=" WO Id" Visible ="false">  </asp:BoundField>
