<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_SalesDistribution_Transactions_Dispatch_Gunrail_WO_Grid, newerp_deploy" title="ERP" theme="Default" %>
        ...
        <tr>
            <td>
                <table width="100%" align="center" cellpadding="0" cellspacing="0">
                    <tr height="21">
                        <td style="background:url(../../../images/hdbg.JPG)" class="fontcsswhite" ><strong>&nbsp;Dispatch GunRail - New
                          </strong>
                        </td>
                    </tr>
        ...
        <asp:Button ID="btnSearch" runat="server" 
            ...
            <td>
                ...
                <asp:GridView ID="SearchGridView1" runat="server" AllowPaging="True" 
                    ...
                    DataKeyNames="WONo" RowStyle-HorizontalAlign ="Center"  PageSize="20"                 
...
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                    ...
                    HeaderText="WO No" 
                    DataNavigateUrlFormatString="~/Module/SalesDistribution/Transactions/Dispatch_Gunrail_Details.aspx?WONo={0}&ModId=2&SubModId=132" 
                    DataTextField="WONo" />
