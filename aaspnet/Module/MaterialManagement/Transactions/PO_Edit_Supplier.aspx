<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_MaterialManagement_Transactions_PO_Edit_Supplier, newerp_deploy" title="ERP" theme="Default" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <table align="center" cellpadding="0" cellspacing="0" border="0" 
        ...
        &nbsp;<b>PO - Edit&nbsp;</b></td></tr><tr><td align="left" height="30"><b>&nbsp; Supplier&nbsp;&nbsp; 
         ...
         <asp:Button runat="server" Text="Search" CssClass="redbox" ID="btnSearch" OnClick="btnSearch_Click">
                                ...
                                <asp:GridView ID="GridView5" runat="server" AllowPaging="True" 
                                    ...
                                    <Columns>
                                      ...
                                      <%--  <asp:ButtonField  CommandName="sel" Text="Select">
                                       ...
                                       <asp:TemplateField>
                                            <ItemTemplate>
                                           <asp:LinkButton ID="linkSup" CommandName="sel"  runat="server" Text="Select"></asp:LinkButton>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="center" Width="7%" />
                                        </asp:TemplateField>
