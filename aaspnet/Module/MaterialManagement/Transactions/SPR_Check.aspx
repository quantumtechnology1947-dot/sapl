<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SPR_Check.aspx.cs" Inherits="Module_MaterialManagement_Transactions_SPR_Check" Title="ERP" Theme="Default" %>
    ...
    <table align="left" cellpadding="0" cellspacing="0" class="style2">
        <tr>
            <td valign="top">
                ...
                style="background:url(../../../images/hdbg.JPG)" colspan="2">&nbsp;<b>SPR Check</b></td>
                    </tr>
                    <tr>
                        <td height="25">
...
&nbsp;<asp:Button ID="Button1" runat="server" CssClass="redbox" onclick="Button1_Click" Text="Search" />
                        ...
                        <td height="25" align="center">
                            ...
                            <asp:Button ID="Check" runat="server" CommandName="check" CssClass="redbox" 
                                onclick="Check_Click" OnClientClick=" return confirmation()" Text="Checked" />
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">                       
    ...
    onpageindexchanging="GridView2_PageIndexChanging">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="SPR No" ItemStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="For Checking" ItemStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Approved" ItemStyle-HorizontalAlign="center">
                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="lblApproved" runat="server" Text='<%# Bind("AuthorizedDate") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Authorized" Visible="false" ItemStyle-HorizontalAlign="center">
                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                            <ItemTemplate>
