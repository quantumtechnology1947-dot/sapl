...
public partial class Module_MaterialManagement_Transactions_APO_SPR_Print_Page : System.Web.UI.Page
{
    ...
    public void loaddata()
    {
        ...
        //try
        {
            ...
            string selectQuery = "";
            string selectQuery3 = "";
            string StrAmdNo = fun.select("AmendmentNo", "tblMM_PO_MasterA", "Id ='" + MId + "'");
            ...
            if (DSAmdNo.Tables[0].Rows.Count > 0)
            {
                ...
                if (AmdNo == DBAmdNo)
                {
                    selectQuery = fun.select("tblMM_PO_DetailsA.Id As PODId,tblMM_PO_MasterA.Insurance,tblMM_PO_MasterA.AuthorizeDate,tblMM_PO_MasterA.ApproveDate,tblMM_PO_MasterA.SysDate,tblMM_PO_MasterA.CheckedDate,tblMM_PO_MasterA.ReferenceDate,tblMM_PO_MasterA.CheckedBy,tblMM_PO_MasterA.ApprovedBy,tblMM_PO_MasterA.AuthorizedBy,tblMM_PO_MasterA.Id,tblMM_PO_MasterA.PONo,tblMM_PO_MasterA.ModeOfDispatch,tblMM_PO_MasterA.Inspection,tblMM_PO_MasterA.Remarks,tblMM_PO_MasterA.ShipTo,tblMM_PO_MasterA.Reference,tblMM_PO_MasterA.ReferenceDesc,tblMM_PO_MasterA.AmendmentNo,tblMM_PO_DetailsA.Qty,tblMM_PO_DetailsA.Rate,tblMM_PO_DetailsA.Discount,tblMM_PO_DetailsA.DelDate,tblMM_PO_MasterA.SupplierId,tblMM_PO_MasterA.Freight,tblMM_PO_MasterA.Octroi,tblMM_PO_MasterA.Warrenty,tblMM_PO_MasterA.PaymentTerms,tblMM_PO_DetailsA.PF,tblMM_PO_DetailsA.ExST,tblMM_PO_DetailsA.VAT,tblMM_PO_DetailsA.SPRId,tblMM_PO_DetailsA.BudgetCode,tblMM_PO_DetailsA.AddDesc,TC", "tblMM_PO_MasterA,tblMM_PO_DetailsA ", " tblMM_PO_MasterA.Id=tblMM_PO_DetailsA.MId AND tblMM_PO_DetailsA.MId='" + MId + "' And tblMM_PO_MasterA.CompId='" + cId + "' AND tblMM_PO_MasterA.Id='" + MId + "'");
                }
                else
                {
                    selectQuery = fun.select("tblMM_PO_Amd_MasterA.Id,tblMM_PO_Amd_DetailsA.PODId As PODId,tblMM_PO_Amd_MasterA.Insurance,tblMM_PO_Amd_MasterA.AuthorizeDate,tblMM_PO_Amd_MasterA.ApproveDate,tblMM_PO_Amd_MasterA.SysDate,tblMM_PO_Amd_MasterA.CheckedDate,tblMM_PO_Amd_MasterA.ReferenceDate,tblMM_PO_Amd_MasterA.CheckedBy,tblMM_PO_Amd_MasterA.ApprovedBy,tblMM_PO_Amd_MasterA.AuthorizedBy,tblMM_PO_Amd_MasterA.Id,tblMM_PO_Amd_MasterA.PONo,tblMM_PO_Amd_MasterA.ModeOfDispatch,tblMM_PO_Amd_MasterA.Inspection,tblMM_PO_Amd_MasterA.Remarks,tblMM_PO_Amd_MasterA.ShipTo,tblMM_PO_Amd_MasterA.Reference,tblMM_PO_Amd_MasterA.ReferenceDesc,tblMM_PO_Amd_MasterA.AmendmentNo,tblMM_PO_Amd_DetailsA.Qty,tblMM_PO_Amd_DetailsA.Rate,tblMM_PO_Amd_DetailsA.Discount,tblMM_PO_Amd_DetailsA.DelDate,tblMM_PO_Amd_MasterA.SupplierId,tblMM_PO_Amd_MasterA.Freight,tblMM_PO_Amd_MasterA.Octroi,tblMM_PO_Amd_MasterA.Warrenty,tblMM_PO_Amd_MasterA.PaymentTerms,tblMM_PO_Amd_DetailsA.PF,tblMM_PO_Amd_DetailsA.ExST,tblMM_PO_Amd_DetailsA.VAT,tblMM_PO_Amd_DetailsA.SPRId,tblMM_PO_Amd_DetailsA.BudgetCode,tblMM_PO_Amd_DetailsA.AddDesc,TC", "tblMM_PO_Amd_MasterA,tblMM_PO_Amd_DetailsA ", " tblMM_PO_Amd_MasterA.Id=tblMM_PO_Amd_DetailsA.MId And tblMM_PO_Amd_MasterA.CompId='" + cId + "' AND tblMM_PO_Amd_MasterA.POId='" + MId + "' AND tblMM_PO_Amd_MasterA.AmendmentNo='" + AmdNo + "'");

                }

                if ((AmdNo - 1) >= 0)
                {
                    selectQuery3 = fun.select("tblMM_PO_Amd_MasterA.Id,tblMM_PO_Amd_MasterA.Insurance,tblMM_PO_Amd_MasterA.AuthorizeDate,tblMM_PO_Amd_MasterA.ApproveDate,tblMM_PO_Amd_MasterA.SysDate,tblMM_PO_Amd_MasterA.CheckedDate,tblMM_PO_Amd_MasterA.ReferenceDate,tblMM_PO_Amd_MasterA.CheckedBy,tblMM_PO_Amd_MasterA.ApprovedBy,tblMM_PO_Amd_MasterA.AuthorizedBy,tblMM_PO_Amd_MasterA.Id,tblMM_PO_Amd_MasterA.PONo,tblMM_PO_Amd_MasterA.ModeOfDispatch,tblMM_PO_Amd_MasterA.Inspection,tblMM_PO_Amd_MasterA.Remarks,tblMM_PO_Amd_MasterA.ShipTo,tblMM_PO_Amd_MasterA.Reference,tblMM_PO_Amd_MasterA.ReferenceDesc,tblMM_PO_Amd_MasterA.AmendmentNo,tblMM_PO_Amd_MasterA.SupplierId,tblMM_PO_Amd_MasterA.Freight,tblMM_PO_Amd_MasterA.Octroi,tblMM_PO_Amd_MasterA.Warrenty,tblMM_PO_Amd_MasterA.PaymentTerms,TC", "tblMM_PO_Amd_MasterA", "tblMM_PO_Amd_MasterA.CompId='" + cId + "' AND tblMM_PO_Amd_MasterA.POId='" + MId + "' AND tblMM_PO_Amd_MasterA.AmendmentNo='" + (AmdNo - 1) + "'");
            ...
            dt.Columns.Add(new System.Data.DataColumn("SPRNo", typeof(string)));//12
            ...
            dt.Columns.Add(new System.Data.DataColumn("Dept", typeof(string)));//34
            dt.Columns.Add(new System.Data.DataColumn("RefPODesc", typeof(string)));//35
            dt.Columns.Add(new System.Data.DataColumn("Indentor", typeof(string)));//36
            dt.Columns.Add(new System.Data.DataColumn("BudgetCode", typeof(string)));//37
            dt.Columns.Add(new System.Data.DataColumn("SupplierId", typeof(string)));//38
            dt.Columns.Add(new System.Data.DataColumn("Insurance", typeof(string)));//39
            dt.Columns.Add(new System.Data.DataColumn("Symbol", typeof(string)));//40

            //--------------------------------------------------------------------------------

            dt.Columns.Add(new System.Data.DataColumn("SuplierName*", typeof(string)));//41
            dt.Columns.Add(new System.Data.DataColumn("VenderCode*", typeof(string)));//42
            dt.Columns.Add(new System.Data.DataColumn("RefDate*", typeof(string)));//43 **ReferenceDate
            dt.Columns.Add(new System.Data.DataColumn("RefDesc*", typeof(string)));//44 **Reference
            dt.Columns.Add(new System.Data.DataColumn("RefPODesc*", typeof(string)));//45 **ReferenceDesc
            dt.Columns.Add(new System.Data.DataColumn("Rate*", typeof(string)));//46
            dt.Columns.Add(new System.Data.DataColumn("Discount*", typeof(string)));//47
            dt.Columns.Add(new System.Data.DataColumn("PackagingValue*", typeof(string)));//48
            dt.Columns.Add(new System.Data.DataColumn("ExciseValue*", typeof(string)));//49
            dt.Columns.Add(new System.Data.DataColumn("VatValue*", typeof(string)));//50
            dt.Columns.Add(new System.Data.DataColumn("DelDate*", typeof(string)));//51 
            dt.Columns.Add(new System.Data.DataColumn("PaymentTerm*", typeof(string)));//52
            dt.Columns.Add(new System.Data.DataColumn("ModeOfDispatch*", typeof(string)));//53
            dt.Columns.Add(new System.Data.DataColumn("Inspection*", typeof(string)));//54
            dt.Columns.Add(new System.Data.DataColumn("OctriValue*", typeof(string)));//55
            dt.Columns.Add(new System.Data.DataColumn("Warranty*", typeof(string)));//56
            dt.Columns.Add(new System.Data.DataColumn("Fright*", typeof(string)));//57
            dt.Columns.Add(new System.Data.DataColumn("Insurance*", typeof(string)));//58
            dt.Columns.Add(new System.Data.DataColumn("ShipTo*", typeof(string)));//59
            dt.Columns.Add(new System.Data.DataColumn("Remarks*", typeof(string)));//60
            dt.Columns.Add(new System.Data.DataColumn("BudgetCode*", typeof(string)));//61
            dt.Columns.Add(new System.Data.DataColumn("AddDesc", typeof(string)));//62
            dt.Columns.Add(new System.Data.DataColumn("AddDesc*", typeof(string)));//63
            dt.Columns.Add(new System.Data.DataColumn("POQty*", typeof(string)));//64
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    dr[5] = fun.FromDateDMY(ds.Tables[0].Rows[i]["DelDate"].ToString());
                    ...
                    string strSPR = fun.select("tblMM_SPR_MasterA.SessionId AS Indentor,tblMM_SPR_DetailsA.SPRNo,tblMM_SPR_DetailsA.WONo,tblMM_SPR_DetailsA.DeptId,tblMM_SPR_DetailsA.AHId,tblMM_SPR_DetailsA.ItemId", "tblMM_SPR_DetailsA,tblMM_SPR_MasterA", "tblMM_SPR_DetailsA.Id='" + ds.Tables[0].Rows[i]["SPRId"].ToString() + "' And tblMM_SPR_MasterA.Id=tblMM_SPR_DetailsA.MId ");
                    ...
                    {
                        dr[12] = dsSPR.Tables[0].Rows[0]["SPRNo"].ToString();

                        string StrIndentor = fun.select("Title+' '+EmployeeName as Name", "tblHR_OfficeStaff", "EmpId='" + dsSPR.Tables[0].Rows[0]["Indentor"].ToString() + "'And CompId='" + cId + "'");
                        ...
                        dr[36] = DSIndentor.Tables[0].Rows[0]["Name"].ToString() + "[" + dsSPR.Tables[0].Rows[0]["Indentor"].ToString() + "]";
                        ...
                        if (dsSPR.Tables[0].Rows[0]["WONo"] != DBNull.Value)
                        {
                            ...
                            {
                                dr[37] = String.Concat(DSCode1.Tables[0].Rows[0]["Symbol"].ToString(), dr[13]);
                            }
                            else
                            {
                                string StrDept = fun.select("Symbol", "BusinessGroup", "Id='" + dsSPR.Tables[0].Rows[0]["DeptId"].ToString() + "'");
                                SqlCommand cmdDept = new SqlCommand(StrDept, myConnection);
                                SqlDataAdapter daDept = new SqlDataAdapter(cmdDept);
                                DataSet DSDept = new DataSet();
                                daDept.Fill(DSDept);
                                if (DSDept.Tables[0].Rows.Count > 0)
                                {
                                    dr[37] = DSDept.Tables[0].Rows[0]["Symbol"].ToString();
                        ...
                        if (dsSPR.Tables[0].Rows[0]["DeptId"] != DBNull.Value)
                        {
                            string StrDept = fun.select("Symbol", "BusinessGroup", "Id='" + dsSPR.Tables[0].Rows[0]["DeptId"].ToString() + "'");
                            SqlCommand cmdDept = new SqlCommand(StrDept, myConnection);
                            SqlDataAdapter daDept = new SqlDataAdapter(cmdDept);
                            ...
                            if (DSDept.Tables[0].Rows.Count > 0)
                            {
                                dr[34] = DSDept.Tables[0].Rows[0]["Symbol"].ToString();
                    ...
                    dr[20] = ManfDesc;
                    dr[21] = UOMBasic;
                    string SupName = fun.select("SupplierId,SupplierName,ContactPerson,ContactNo,Email,RegdCountry", "tblMM_Supplier_masterA", "SupplierId='" + ds.Tables[0].Rows[i]["SupplierId"].ToString() + "' AND CompId='" + cId + "'");
                    ...
                    if (DSSupName.Tables[0].Rows.Count > 0)
                    {
                        ...
                        dr[40] = dsSym.Tables[0].Rows[0]["Symbol"].ToString();
                        ...
                        dr[38] = DSSupName.Tables[0].Rows[0]["SupplierId"].ToString();
                        dr[39] = ds.Tables[0].Rows[i]["Insurance"].ToString();
                    }
                    ...
                    dr[35] = ds.Tables[0].Rows[i]["ReferenceDesc"].ToString();

                    //-----------------------------------------------------------------------------------------
                    if (p == 1)
                    {
                        string selectQuery4 = fun.select("tblMM_PO_Amd_DetailsA.PODId,tblMM_PO_Amd_DetailsA.Qty,tblMM_PO_Amd_DetailsA.Rate,tblMM_PO_Amd_DetailsA.Discount,tblMM_PO_Amd_DetailsA.DelDate,tblMM_PO_Amd_DetailsA.PF,tblMM_PO_Amd_DetailsA.ExST,tblMM_PO_Amd_DetailsA.VAT,tblMM_PO_Amd_DetailsA.SPRId,tblMM_PO_Amd_DetailsA.BudgetCode,tblMM_PO_Amd_DetailsA.AddDesc", "tblMM_PO_Amd_DetailsA", "tblMM_PO_Amd_DetailsA.MId='" + ds33.Tables[0].Rows[0]["Id"].ToString() + "' AND tblMM_PO_Amd_DetailsA.PODId='" + ds.Tables[0].Rows[i]["PODId"].ToString() + "'");
                    ...
                    {
                        dr[62] = ds.Tables[0].Rows[i]["AddDesc"].ToString();
                    }
                    else
                    {
                        dr[62] = "";
                ...
                if (Country == 1)
                {
                    report.Load(Server.MapPath("~/Module/MaterialManagement/Transactions/Reports/APO_SPR.rpt"));
                }
                else
                {
                    report.Load(Server.MapPath("~/Module/MaterialManagement/Transactions/Reports/APO_SPR_Import.rpt"));
                }

                report.SetDataSource(xsdds);

                //Supplier Address
                string cn = fun.select("SupplierName,RegdAddress,RegdCountry,RegdState,RegdCity,RegdPinNo", "tblMM_Supplier_masterA", "SupplierId='" + SupCode + "' And CompId='" + cId + "'");
                ...
                daAdd.Fill(dsAdd, "tblMM_Supplier_masterA");
                ...
                report.SetParameterValue("Address2", Address);
