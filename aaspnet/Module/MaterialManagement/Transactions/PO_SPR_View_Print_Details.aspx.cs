...
public partial class Module_MaterialManagement_Transactions_PO_SPR_View_Print_Details : System.Web.UI.Page
{  
    string SupCode = "";
    string PoNo = "";
    string parentPage = "";
    ...
    {
        Response.Redirect(parentPage + "?Code=" + SupCode + "&ModId=6&SubModId=35");
    }
}
