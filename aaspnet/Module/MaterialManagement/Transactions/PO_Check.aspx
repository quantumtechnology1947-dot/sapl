<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PO_Check.aspx.cs" Inherits="Module_MaterialManagement_Transactions_PO_Check" Title="ERP" Theme="Default" %>
    ...
    <table align="left" cellpadding="0" cellspacing="0" class="style2">
        <tr>
            <td valign="top">
                ...
                style="background:url(../../../images/hdbg.JPG)" colspan="2">&nbsp;<b>PO Check</b></td>
                    </tr>
                    <tr>
                        <td height="25">
...
&nbsp;<asp:Button ID="Button1" runat="server" CssClass="redbox" Text="Search" onclick="Button1_Click" />
                        ...
                        <td height="25" align="center">
                            ...
                            <asp:Button ID="Check" runat="server" CommandName="check" CssClass="redbox" 
                                OnClientClick=" return confirmation()" Text="Checked" 
                                onclick="Check_Click" />
                        </td>
                    </tr>
                    <tr>
