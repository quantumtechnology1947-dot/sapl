<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_MaterialManagement_Transactions_PO_SPR_Items, newerp_deploy" title="ERP" theme="Default" %>
...
<ContentTemplate><asp:Panel ID="Panel1" runat="server" Height="340px" ScrollBars="Auto" Width="100%"><asp:GridView ID="GridView3" runat="server" AllowPaging="True" 
