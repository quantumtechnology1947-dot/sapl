...
public partial class Module_MaterialManagement_Transactions_SPR_Check : System.Web.UI.Page
{
    ...
    public void makegrid(string sprno,string empid)
    {
        try
        {
            ...
            string sql = fun.select("*", "tblMM_SPR_Master", "FinYearId<='" + FyId + "' AND CompId='" + CompId + "'" + x + y + " AND Checked='0' Order by Id Desc");
    ...
    string parentPage = "SPR_Check.aspx";
        ...
        try
        {
            ...
            foreach (GridViewRow grv in GridView2.Rows)
            {
                ...
                if (chk.Checked == true)
                {
                    ...
                    string sql3 = fun.update("tblMM_SPR_Master", "Checked='1',CheckedBy='" + sId + "',CheckedDate='" + CDate + "',CheckedTime='" + CTime + "'", "CompId='" + CompId + "' AND SPRNo='" + sprno + "' AND Id='" + id + "'");
