<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PO_Authorize.aspx.cs" Inherits="Module_MaterialManagement_Transactions_PO_Authorize" Title="ERP" Theme="Default" %>
   ...
   <table align="left" cellpadding="0" cellspacing="0" class="style2">
        <tr>
            <td valign="top">
                ...
                style="background:url(../../../images/hdbg.JPG)" colspan="2">&nbsp;<b>PO Authorize</b></td>
                    </tr>
...
&nbsp;<asp:Button ID="Button1" runat="server" CssClass="redbox" Text="Search" onclick="Button1_Click" />
                        ...
                        <td height="25" align="center">
                            ...
                            <asp:Button ID="Auth" runat="server" CommandName="Auth" CssClass="redbox" 
                                onclick="Auth_Click" OnClientClick=" return confirmation()" Text="Authorized" />
                        </td>
                    </tr>
    ...
    onpageindexchanging="GridView2_PageIndexChanging">
                                    ...
                                    <asp:Label ID="lblAmendmentNo" runat="server" Text='<%# Eval("AmendmentNo") %>'></asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="Amd No" ItemStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="For Authorize" 
                                        ItemStyle-HorizontalAlign="center">
                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                            <ItemTemplate>
                                                <asp:CheckBox ID="CK" runat="server"/>
                                                <asp:Label ID="lblAutho" runat="server" 
        Text='<%# Bind("AuthorizedDate") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                    <EmptyDataTemplate>
