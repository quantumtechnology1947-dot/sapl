...
public partial class Module_MaterialManagement_Transactions_PO_Print : System.Web.UI.Page
{
    ...
    public void LoadData(string poNo, string empid)
    {
          ...
          try
        {
            ...
            foreach (GridViewRow grv in GridView2.Rows)
            {
                ...
                string StrSql9 = fun.select("AmendmentNo", "tblMM_PO_Master", "Id ='" + Poid + "'");
    ...
    protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        try
        {
            ...
            {                
                string StrFlag = fun.select("PRSPRFlag", "tblMM_PO_Master", "Id="+mid+" ");
                ...
                if (DSFlag.Tables[0].Rows[0][0].ToString() == "0")
                {
                    ...
                    Response.Redirect("PO_Print_Details.aspx?mid=" + mid + "&pono=" + pono + "&Code=" + SupCode + "&AmdNo=" + AmdNo + "&Key=" + getRandomKey + "&ModId=6&SubModId=35");
                }
                else
                {
                    string getRandomKey = fun.GetRandomAlphaNumeric();
                    Response.Redirect("PO_SPR_Print_Details.aspx?mid=" + mid + "&pono=" + pono + "&Code=" + SupCode + "&AmdNo=" + AmdNo + "&Key=" + getRandomKey + "&ModId=6&SubModId=35");
                }
            }

            if (e.CommandName == "Download")
            {
                string StrRef = fun.select("*", "tblMM_PO_Master", "CompId='" + CompId + "' AND PONo='" +pono +"' AND Id='" + mid+ "'");
                ...
                else
                {
                    ...
                    Response.Redirect("~/Controls/DownloadFile.aspx?Id=" + DSRef.Tables[0].Rows[0]["Id"].ToString() + "&tbl=tblMM_PO_Master&qfd=FileData&qfn=fileName&qct=ContentType");
                }
            }
    ...
    {
        Response.Redirect("PO_Print_Supplier.aspx?ModId=6&SubModId=35");
    }
