<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_MaterialManagement_Transactions_PO_New, newerp_deploy" title="ERP" theme="Default" %>
        ...
        <tr>
            <td align="left">
                <cc1:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" 
                    ...
                    <cc1:TabPanel runat="server" HeaderText="PR" ID="PR">
                        <HeaderTemplate>
                            &nbsp;&nbsp;PR&nbsp;&nbsp;
