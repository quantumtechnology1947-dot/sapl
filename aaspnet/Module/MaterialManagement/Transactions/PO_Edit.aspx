<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_MaterialManagement_Transactions_PO_Edit, newerp_deploy" title="ERP" theme="Default" %>
               ...
               <asp:TemplateField HeaderText="SN" ItemStyle-HorizontalAlign="Right">
                ...
                <ItemStyle HorizontalAlign="Right" VerticalAlign="Top" />
                        ...
                        <asp:TemplateField HeaderText="Amd No">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                            <asp:Label ID="lblAmdNo" runat="server" Text='<%# Eval("AmdNo") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
