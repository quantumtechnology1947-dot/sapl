<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PO_PR_ItemGrid.aspx.cs" Inherits="Module_MaterialManagement_Transactions_PO_PR_ItemGrid" %>
        ...
        <tr>
            <td valign="top">
                ...
                <ItemStyle HorizontalAlign="Right" VerticalAlign="Top" />
                           ...
                           <ItemTemplate>
                        <asp:Label ID="lblfinyear" Text='<%# Eval("FinYearId") %>' runat="server"></asp:Label>
                        </ItemTemplate>
