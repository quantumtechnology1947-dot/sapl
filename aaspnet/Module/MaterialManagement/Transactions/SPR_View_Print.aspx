<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_MaterialManagement_Transactions_SPR_View_Print, newerp_deploy" title="ERP" theme="Default" %>
    ...
    <table align="center" cellpadding="0" cellspacing="0" class="style2">
        ...
        <tr>
            <td align="center" class="style3">
                <asp:Panel ID="Panel1" runat="server" Height="430" ScrollBars="Auto" 
                    Width="100%">
