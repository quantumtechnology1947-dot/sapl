...
<CommandItemSettings   ExportToPdfText="Export to Pdf"></CommandItemSettings>
   ...
   <telerik:GridTemplateColumn HeaderText="SN"><ItemTemplate><%# Container.ItemIndex+1 %></ItemTemplate><HeaderStyle Font-Size="9pt" />
       ...
       <HeaderStyle HorizontalAlign="center" Width="60px"  />
        ...
        <telerik:GridTemplateColumn HeaderText="PR Qty" Visible="false">
        <ItemTemplate>
        ...
        <telerik:GridTemplateColumn HeaderText="WIS Qty" Visible="false">
        <ItemTemplate>
        ...
        <telerik:GridTemplateColumn HeaderText="GQN Qty" Visible="false">
        <ItemTemplate>
        ...
        <telerik:GridTemplateColumn HeaderText="Draw/ img" Visible="false">
        <ItemTemplate>
       ...
       <telerik:GridTemplateColumn HeaderText="Spec." Visible="false">
       <ItemTemplate>
        ...
        <asp:Label ID="lblItemId" runat="server" Text='<%#Eval("ItemId") %>'></asp:Label>
          ...
          <telerik:GridTemplateColumn HeaderText="SHORTAGE Qty">
        <ItemTemplate>
        <asp:Label ID="lblgqnqty1" runat="server" Text='<%#Eval("SHORTQty") %>'></asp:Label>
        </ItemTemplate>
           <ItemStyle HorizontalAlign="Right"  VerticalAlign="Top" Width="45px"   />
            <HeaderStyle HorizontalAlign="center" Width="45px"   />
        </telerik:GridTemplateColumn>
