...
public partial class Module_MaterialManagement_Transactions_PO_Check : System.Web.UI.Page
{
    ...
    public void makegrid(string sprno, string empid)
    {
        try
        {
            ...
            string sql = fun.select("*", "tblMM_PO_Master", "FinYearId<='" + FyId + "' AND CompId='" + CompId + "'" + x + " AND Checked='0' Order by Id Desc");
    ...
    string parentPage = "PO_Check.aspx";
            ...
            if (e.CommandName == "check")
            {
                ...
                foreach (GridViewRow grv in GridView2.Rows)
                {
                    ...
                    if (chk.Checked == true)
                    {
                        ...
                        string sql3 = fun.update("tblMM_PO_Master", "Checked='1',CheckedBy='" + sId + "',CheckedDate='" + CDate + "',CheckedTime='" + CTime + "'", "CompId='" + CompId + "' AND PONo='" + sprno + "' AND Id='" + id + "' ");
                        SqlCommand cmd3 = new SqlCommand(sql3, con);
