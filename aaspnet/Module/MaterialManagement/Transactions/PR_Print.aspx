<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_MaterialManagement_Transactions_PR_Print, newerp_deploy" title="ERP" theme="Default" %>
...
&nbsp;<asp:Button ID="Button1" runat="server" CssClass="redbox" onclick="Button1_Click" Text="Search" />
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                        <asp:LinkButton runat="server" CommandName="Sel" Text="Select" ></asp:LinkButton> 
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="PRNo">
                        <ItemTemplate>
                            <asp:Label ID="lblPRNo" runat="server" Text='<%# Bind("PRNo") %>'></asp:Label>
                        </ItemTemplate>                       
                        <ItemStyle HorizontalAlign="Right" />
                    </asp:TemplateField>
