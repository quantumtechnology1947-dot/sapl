<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CPO_SPR_Print_Details.aspx.cs" Inherits="Module_MaterialManagement_Transactions_PO_SPR_Print_Details" Title="ERP" Theme="Default" %>
    ...
    <table align="left" cellpadding="0" cellspacing="0" width="100%" height="340">
        ...
        <tr>
            <td align="Left" colspan="2">                               
                <iframe id="myifram" width="100%" scrolling="auto" height="430" frameborder="0" 
                    runat="server"></iframe>
             </td>
        </tr>
