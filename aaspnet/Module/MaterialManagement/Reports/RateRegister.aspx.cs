...
public class Module_MaterialManagement_Reports_RateRegister : Page, IRequiresSessionState
{
	...
	protected void RadioButtonList1_SelectedIndexChanged(object sender, EventArgs e)
	{
		...
		else
		{
			...
			base.Response.Redirect("RateRegister_Details.aspx?Key=" + randomAlphaNumeric);
		}
	}
	...
	protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		if (e.CommandName == "sel")
		{
			...
			string randomAlphaNumeric = fun.GetRandomAlphaNumeric();
			base.Response.Redirect("~/Module/MaterialManagement/Reports/RateRegister_Details.aspx?ItemId=" + text + "&Key=" + randomAlphaNumeric);
		}
	}
}
