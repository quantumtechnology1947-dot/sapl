<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_MaterialManagement_Reports_Purchase_Reprt, newerp_deploy" title="ERP" theme="Default" culture="en-GB" %>
 ...
 <table class="fontcss" width="100%" cellpadding="0" cellspacing="0">
                ...
                <asp:Label ID="Label2" runat="server" ForeColor="Red" 
                    Visible="False" CssClass="style2"></asp:Label>
                        ...
                        <Report FileName="~/Module/MaterialManagement/Reports/Purchase_Excise.rpt">
                        </Report>
