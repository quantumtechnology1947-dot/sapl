<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_MaterialManagement_Masters_SupplierMaster_Print, newerp_deploy" title="ERP" theme="Default" %>
        ...
        <tr>
            <td>
                <table width="99%" align="center" cellpadding="0" cellspacing="0">
                    <tr height="21">
                        <td style="background:url(../../../images/hdbg.JPG)" class="fontcsswhite">&nbsp;<strong> 
                            Supplier - Print</strong></td>
                    </tr>
   <tr >
...
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                        ...
                        <asp:TemplateField HeaderText="Supplier Name">
                            <ItemTemplate>
                            <asp:LinkButton runat="server" Text='<%# Eval("SupplierName") %>' ID="lnkBtn" CommandName="sel"></asp:LinkButton>                                
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="35%" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Code">
                            <ItemTemplate>
                                <asp:Label ID="lblSupId" runat="server" Text='<%# Bind("SupplierId") %>'></asp:Label>
                            </ItemTemplate>
