<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_MaterialManagement_Masters_SupplierMaster_New, newerp_deploy" title="ERP" theme="Default" %>
...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="2" Class="fontcss">
  ...
  <tr valign="top"  >
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="1">
      ...
      <tr>
        <td width="15%" height="23" align="left" valign="middle" class="fontcss">&nbsp;</td>
      ...
      <tr>
        ...
        <td align="left" valign="middle" class="fontcss">&nbsp;</td>
        <td align="left" valign="middle" class="style6">
            <asp:TextBox ID="txtNewTinCstNo" runat="server" CssClass="box3" Visible="False">-</asp:TextBox>
      ...
      <tr>
        <td height="23" align="left" valign="middle" class="fontcss">&nbsp;Mod GST Applicable</td>
...
&nbsp;<asp:RadioButton ID="rbMVANo" runat="server" Checked="True" GroupName="MVA" 
        ...
        <td align="left" valign="middle" class="fontcss">Mod GST Invoice</td>
        <td align="left" valign="middle" class="style6">
