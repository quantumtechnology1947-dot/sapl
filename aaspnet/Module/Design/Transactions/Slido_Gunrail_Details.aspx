<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Design_Transactions_Slido_Gunrail_Details, newerp_deploy" title="ERP" theme="Default" %>
                ...
                <table width="100%" align="center" cellpadding="0" cellspacing="0">
                    <tr height="21">
                        <td style="background:url(../../../images/hdbg.JPG)" class="fontcsswhite" 
                            colspan="2" ><strong>&nbsp;Slido Gunrail - New For WONo: 
               ...
               <EmptyDataTemplate>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                   ConnectionString="<%$ ConnectionStrings:LocalSqlServer %>" 
                    DeleteCommand="DELETE FROM [tblDG_Gunrail_CrossRail_Temp] WHERE [Id] = @Id" 
                    InsertCommand="INSERT INTO [tblDG_Gunrail_CrossRail_Temp] ([Length], [No], [SessionId], [CompId]) VALUES (@Length, @No, @SessionId, @CompId)" 
                    ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT Id,Length,No,SessionId,CompId,Round((Length*No),3) As Total  FROM [tblDG_Gunrail_CrossRail_Temp] where [SessionId] = @SessionId And [CompId] = @CompId" 
                    UpdateCommand="UPDATE [tblDG_Gunrail_CrossRail_Temp] SET [Length] = @Length,[Total] = @Total , [No] = @No, [SessionId] = @SessionId, [CompId] = @CompId WHERE [Id] = @Id">
                    <DeleteParameters>
...
<ItemStyle HorizontalAlign="Right"></ItemStyle>
      ...
      <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                   ConnectionString="<%$ ConnectionStrings:LocalSqlServer %>" 
                    DeleteCommand="DELETE FROM [tblDG_Gunrail_LongRail_Temp] WHERE [Id] = @Id" 
                    InsertCommand="INSERT INTO [tblDG_Gunrail_LongRail_Temp] ([Length], [No], [SessionId], [CompId]) VALUES (@Length, @No, @SessionId, @CompId)" 
                    ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT Id,Length,No,SessionId,CompId,Round((Length*No),3) As Total  FROM [tblDG_Gunrail_LongRail_Temp] where [SessionId] = @SessionId And [CompId] = @CompId" 
                    UpdateCommand="UPDATE [tblDG_Gunrail_LongRail_Temp] SET [Length] = @Length,[Total] = @Total ,[No] = @No, [SessionId] = @SessionId, [CompId] = @CompId WHERE [Id] = @Id">
                    <DeleteParameters>
                        <asp:Parameter Name="Id" Type="Int32" />
                    </DeleteParameters>
                    <UpdateParameters>
