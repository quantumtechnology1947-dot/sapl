<%@ page language="C#" autoeventwireup="true" inherits="Module_Design_Transactions_BOM_Design_Copy_Tree, newerp_deploy" theme="Default" %>
...
<body  topmargin="0" bottommargin="0" leftmargin="0" rightmargin="0">
    ...
    <tr>
<td align="left" class="fontcss" height="25px" valign="middle">&nbsp;<b>Wo No: </b>
    <asp:Label ID="Label2" runat="server"></asp:Label>
    &nbsp;&nbsp; <asp:CheckBox  runat="server" ID="CheckBox1"
AutoPostBack="True"  Visible="true" oncheckedchanged="CheckBox1_CheckedChanged" /><b>Expand Tree&nbsp;&nbsp;&nbsp;&nbsp;              
                        </b> <asp:Button ID="btnCopy" runat="server" CssClass="redbox"  OnClientClick=" return confirmationCopy()" 
...
<telerik:RadAjaxLoadingPanel ID="RadAjaxLoadingPanel1" runat="server" 
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" LoadingPanelID="RadAjaxLoadingPanel1" 
        ...
        <telerik:RadTreeList runat="server" ID="RadTreeList1" AllowPaging="false" PageSize="17"
