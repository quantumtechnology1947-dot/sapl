<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Design_Transactions_TPL_Design_Edit, newerp_deploy" title="ERP" theme="Default" %>
        ...
        <asp:Button ID="btnSearch" runat="server" 
            ...
            <td>
                ...
                <asp:GridView ID="SearchGridView1" runat="server" AllowPaging="True" 
                    ...
                    DataKeyNames="WONo" RowStyle-HorizontalAlign ="Center"  PageSize="17"                 
...
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                    ...
                    HeaderText="WO No" 
                    DataNavigateUrlFormatString="~/Module/Design/Transactions/TPL_Design_Assembly_Edit_Ass_grid.aspx?WONo={0}" 
                    DataTextField="WONo" />
