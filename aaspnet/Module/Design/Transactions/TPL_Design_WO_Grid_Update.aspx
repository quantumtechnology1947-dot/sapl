<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Design_Transactions_TPL_Design_WO_Grid_Update, newerp_deploy" title="ERP" theme="Default" %>
        ...
        <tr>
            <td>
                <table width="100%" align="center" cellpadding="0" cellspacing="0">
                    <tr height="21">
                        <td style="background:url(../../../images/hdbg.JPG)" class="fontcsswhite" ><strong>&nbsp;TPL Design - Edit
                          </strong>
                        </td>
                    </tr>
...
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                    ...
                    HeaderText="WO No" 
                    DataNavigateUrlFormatString="~/Module/Design/Transactions/TPL_Design_WO_TreeView_Edit.aspx?WONo={0}&ModId=3&SubModId=23" 
                    DataTextField="WONo" />
