<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Design_Transactions_BOM_Design_Assembly_Edit, newerp_deploy" title="ERP" theme="Default" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
   <table cellpadding="2" class="style5" width="98%">
    <tr>
    <td colspan="3" style="background:url(../../../images/hdbg.JPG)" class="fontcsswhite" height="21">&nbsp;<b>BOM 
    ...
    <tr>
        ...
        <tr>
            ...
            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                                          ...
                                          <asp:TemplateField             HeaderText="SN"><ItemTemplate><%# Container.DataItemIndex+1 %>
                                                        </ItemTemplate><ItemStyle HorizontalAlign="Right" Width="3%" />
                                                    </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Equipment No">
                                                    ...
                                                    <asp:TemplateField HeaderText="Description">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:Label ID="Label3" runat="server" Text='<%# Bind("ManfDesc") %>'></asp:Label> <asp:TextBox ID="txtManfDescription" runat="server" CssClass="box3"  Visible="false"  Text='<%# Bind("ManfDesc") %>'                                                   TextMode="MultiLine" Width="90%" Height="30px"> </asp:TextBox>
      ...
      <asp:TextBox ID="txtQuntity" runat="server" CssClass="box3"   Visible="false"  Text='<%# Bind("Qty") %>' Width="70%"> </asp:TextBox>
                                                    ...
                                                    <ItemStyle HorizontalAlign="Right"  VerticalAlign="Top" Width="9%" />
                                                </asp:TemplateField>
     ...
     CommandName="Del1" OnClientClick=" return confirmationDelete()"  Height="16px" style="height: 13px">
                                                ...
                                                <asp:TemplateField HeaderText="Revision">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblRevision" runat="server" Text='<%# Bind("Revision") %>'></asp:Label>
      <asp:TextBox ID="txtRevision" runat="server" CssClass="box3"   Visible="false"  Text='<%# Bind("Revision") %>' Width="70%"> </asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="ReqRevision" runat="server" 
                                                        ControlToValidate="txtRevision" ErrorMessage="*" ValidationGroup="assub"> </asp:RequiredFieldValidator>
