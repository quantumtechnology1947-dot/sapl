<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Design_Transactions_Slido_Gunrail_WO_Grid, newerp_deploy" title="ERP" theme="Default" %>
        ...
        <tr>
            <td>
                <table width="100%" align="center" cellpadding="0" cellspacing="0">
                    <tr height="21">
                        <td style="background:url(../../../images/hdbg.JPG)" class="fontcsswhite" ><strong>&nbsp;Slido GunRail - New
                          </strong>
                        </td>
                    </tr>
...
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                    ...
                    HeaderText="WO No" 
                    DataNavigateUrlFormatString="~/Module/Design/Transactions/Slido_Gunrail_Details.aspx?WONo={0}&ModId=3&SubModId=131" 
                    DataTextField="WONo" />
