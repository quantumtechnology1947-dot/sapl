<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Design_Transactions_BOM_Design_Delete, newerp_deploy" title="ERP" theme="Default" %>
    ...
    <table width="100%" align="center" cellpadding="0" cellspacing="0" class="fontcss">
        <tr height="21">
            <td style="background:url(../../../images/hdbg.JPG)" class="fontcsswhite" >
                <strong>&nbsp;BOM Design - Delete</strong></td>
        </tr>
        <tr>
            ...
            <td>
              <asp:Panel ID="Panel1" Height="445px" ScrollBars="Auto"  runat="server">
                <asp:GridView ID="SearchGridView1" runat="server" AllowPaging="FALSE" 
                    ...
                    HeaderText="WO No" 
                    DataNavigateUrlFormatString="~/Module/Design/Transactions/BOM_Design_WO_TreeView_Delete.aspx?WONo={0}&ModId=3&SubModId=26" 
                    DataTextField="WONo" >
