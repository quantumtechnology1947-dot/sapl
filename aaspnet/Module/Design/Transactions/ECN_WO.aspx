<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Design_Transactions_ECN_WO, newerp_deploy" title="ERP" theme="Default" %>
...
<ItemStyle HorizontalAlign="Right" Width="3%"></ItemStyle>
                 ...
                 <asp:HyperLinkField DataNavigateUrlFields="WONo" 
                    HeaderText="WO No" 
                    DataNavigateUrlFormatString="~/Module/Design/Transactions/ECNUnlock.aspx?WONo={0}" 
                    DataTextField="WONo" 
                    >
                                  <ItemStyle Width="5%" />
                </asp:HyperLinkField>
                    ...
                    DataField="CustomerName" >
                                  ...
                                  <asp:BoundField DataField="TaskProjectTitle" 
