<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Design_Transactions_TPL_Design_Delete, newerp_deploy" title="ERP" theme="Default" %>
    ...
    <table width="100%" align="center" cellpadding="0" cellspacing="0" 
        ...
        <tr height="21">
            <td style="background:url(../../../images/hdbg.JPG)" class="fontcsswhite" >
                <strong>&nbsp;TPL Design - Delete</strong></td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                <asp:GridView ID="SearchGridView1" runat="server" AllowPaging="True" PageSize="20" 
                    ...
                    HeaderText="WO No" 
                    DataNavigateUrlFormatString="~/Module/Design/Transactions/TPL_Design_WO_TreeView_Delete.aspx?WONo={0}&ModId=3&SubModId=23" 
                    DataTextField="WONo" />
