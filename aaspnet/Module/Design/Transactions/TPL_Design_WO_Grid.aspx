<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Design_Transactions_TPL_WO_Grid, newerp_deploy" title="ERP" theme="Default" %>
...
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                    ...
                    HeaderText="WO No" 
                    DataNavigateUrlFormatString="~/Module/Design/Transactions/TPL_Design_WO_TreeView.aspx?WONo={0}&ModId=3&SubModId=23" 
                    DataTextField="WONo" >
                                      <ItemStyle HorizontalAlign="Center" />
                </asp:HyperLinkField>
