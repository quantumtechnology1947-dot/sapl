<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Design_Masters_ItemMasterDelete, newerp_deploy" title="ERP" theme="Default" %>
...
<table cellpadding="0" cellspacing="0" width="100%" align="left">
    ...
    <table cellpadding="0" cellspacing="0" align="left" width="100%">
        <tr>
            <td align="left" width="100%" valign="middle" style="background:url(../../../images/hdbg.JPG)" height="21" class="fontcsswhite">
             &nbsp;<strong>Item Master - Delete</strong></td>
        </tr>
        ...
        <tr>
         ...
         Width="100%" onrowcommand="GridView2_RowCommand" PageSize="17">
...
<ItemStyle HorizontalAlign="Right" ></ItemStyle>
                        ...
                        <asp:TemplateField>
                        <ItemTemplate>
                        <asp:LinkButton ID="del" CommandName="del" Text="Delete" runat="server" OnClientClick=" return confirmationDelete()"  ></asp:LinkButton>
                        </ItemTemplate>
                        ...
                        <asp:BoundField DataField="Id" HeaderText="Id" 
                           ...
                           <asp:BoundField DataField="ItemCode" HeaderText="Item Code">
                            ...
                            <asp:BoundField DataField="UOMConFact" HeaderText="UOM Conv. Fact." 
                                Visible="False">
