...
public class Module_Design_Masters_Category : Page, IRequiresSessionState
{
	...
	protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		if (e.CommandName == "Add")
		{
			...
			if (text != "" && text2 != "")
			{
				SqlDataSource1.InsertParameters["CName"].DefaultValue = text;
		...
		if (e.CommandName == "Add1")
		{
			...
			if (text3 != "" && text4 != "")
			{
				SqlDataSource1.InsertParameters["CName"].DefaultValue = text3;
