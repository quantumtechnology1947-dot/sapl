<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Design_Masters_SubCategory, newerp_deploy" title="ERP" theme="Default" %>
...
<table cellpadding="0" cellspacing="0" width="100%">
    ...
    <table cellpadding="0" cellspacing="0" align="center" style="width: 65%">
        ...
        <tr>
            <td align="left" valign="middle" style="background:url(../../../images/hdbg.JPG)" height="21" class="fontcsswhite"><b>&nbsp;Item SubCategory</b></td>
        </tr>
        <tr>
...
<FooterStyle Wrap="True"></FooterStyle>
                    ...
                    <asp:CommandField ShowDeleteButton="True" ButtonType="Link" />
                        ...
                        <asp:Label ID="lblCId" runat="server" Text='<%#Eval("catsy") %>'>    </asp:Label>
                         ...
                         <EditItemTemplate>
                                            <asp:DropDownList ID="ddCategory1" Width="85%" AutoPostBack="true" runat="server" DataSourceID="SqlDataSource1" DataTextField="Expr1"
                                                DataValueField="CId">
                                            </asp:DropDownList>
                                        </EditItemTemplate>
                        <FooterTemplate>
                       ...
                       <EditItemTemplate>
                       <asp:TextBox ID="txtSCName1" runat="server" Width="85%" Text='<%#Eval("SCName") %>'></asp:TextBox>
           ...
           <asp:TextBox ID="txtSCName" Width="200" CssClass="fontcss" runat="server">
                ...
                <asp:SqlDataSource ID="LocalSqlServer" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:LocalSqlServer %>" 
                      DeleteCommand="DELETE FROM [tblDG_SubCategory_Master] WHERE [SCId] = @SCId" 
                    InsertCommand="INSERT INTO [tblDG_SubCategory_Master] ([CId],[SCName], [Symbol]) VALUES (@CId,@SCName, @Symbol)" 
                    ProviderName="System.Data.SqlClient"
                    SelectCommand="SELECT   [tblDG_SubCategory_Master].[SCId],[tblDG_SubCategory_Master].[CId],[tblDG_SubCategory_Master].SCName,[tblDG_SubCategory_Master].[Symbol],[tblDG_Category_Master].[Symbol] + ' - '+ [tblDG_Category_Master].[CName] as catsy FROM [tblDG_SubCategory_Master],[tblDG_Category_Master] Where [tblDG_SubCategory_Master].[CId]=[tblDG_Category_Master].[CId] order by [tblDG_SubCategory_Master].[SCId] desc"
       UpdateCommand="UPDATE [tblDG_SubCategory_Master] SET [CId] = @CId, [SCName] = @SCName, [Symbol] = @Symbol WHERE [SCId] = @SCId"             
                    >
                    <DeleteParameters>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:LocalSqlServer %>" 
                    ProviderName="System.Data.SqlClient" 
                    SelectCommand="select CId,Symbol + ' - ' + CName AS Expr1 from tblDG_Category_Master">
                </asp:SqlDataSource>
               </td>
        </tr>
        <tr>
