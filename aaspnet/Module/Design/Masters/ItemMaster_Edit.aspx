<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Design_Masters_ItemMaster_Edit, newerp_deploy" title="ERP" theme="Default" %>
  ...
  <asp:GridView ID="GridView2" 
                    ...
                    OnPageIndexChanging="GridView2_PageIndexChanging" AllowPaging="True" 
                        ...
                        <Columns>
                            ...
                            DataNavigateUrlFormatString="~/Module/Design/Masters/ItemMaster_Edit_Details.aspx?ItemId={0}&amp;ModId=3&amp;SubModId=21" 
                            Text="Select" >
