<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_SysSupport_ECN_WO_ViewAll, newerp_deploy" title="ERP" theme="Default" %>
...
<ItemStyle HorizontalAlign="Right" Width="3%"></ItemStyle>
                 ...
                 <asp:HyperLinkField DataNavigateUrlFields="WONo" 
                    HeaderText="WO No" 
                    DataNavigateUrlFormatString="~/Module/SysSupport/ECN_ViewAll.aspx?WONo={0}" 
                    DataTextField="WONo"
                    >
