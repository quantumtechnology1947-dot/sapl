<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Budget_WONo.aspx.cs" Inherits="Module_Accounts_Transactions_Budget_WONo" Theme ="Default"  %>
...
<ItemStyle HorizontalAlign="Right" Width="3%"></ItemStyle>
               ...
               <asp:TemplateField HeaderText="Cash Pay" SortExpression="Cash">
                                    <ItemTemplate>
                                  ...
                                  <asp:TemplateField HeaderText="Cash Rec" SortExpression="Cash">
                                    <ItemTemplate>
                                    ...
                                    <ItemStyle HorizontalAlign="Right" />
                                     ...
                                     <asp:TemplateField HeaderText="Bal Budget" SortExpression ="Budget">
                                     <ItemTemplate>
                                   ...
                                   <asp:TemplateField HeaderText="Invoice">
                                       ...
                                       <FooterTemplate >
                                           <asp:Label runat="server" ID="lblInv1"></asp:Label>
                                    ...
                                    <asp:TemplateField HeaderText="Actual Amount">
                                        ...
                                        <FooterTemplate>
                                            <asp:Label runat="server" ID="lblActAmt1"></asp:Label>
                                        </FooterTemplate><FooterStyle HorizontalAlign="Right" />
                                    </asp:TemplateField>
                    ...
                    <tr>
                        ...
                        onclick="btnCancel_Click" Text="Cancel" />
                            ...
                            SelectCommand="SELECT Id, Description,  Symbol FROM tblMIS_BudgetCode ">
                        </asp:SqlDataSource>
