<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Budget_Dist_WONo.aspx.cs" Inherits="Module_Accounts_Transactions_Budgtet_Dist_WONo" Theme ="Default"  %>
        ...
        <asp:Button ID="btnSearch" runat="server" 
            Text="Search" CssClass="redbox" onclick="btnSearch_Click"  />
                    ...
                    onclick="btnExport_Click" Text="Export" />
                        &nbsp; <input id="Button1" type="button" value="Cancel"  class="redbox" onclick="javascript:parent.location='Menu.aspx?ModId=14&SubModId='" /></td>
             </tr>
...
<ItemStyle HorizontalAlign="Right" Width="2%"></ItemStyle>
                    ...
                    HeaderText="WO No" 
                    DataNavigateUrlFormatString="~/Module/MIS/Transactions/Budget_WONo.aspx?WONo={0}&ModId=14" 
                    DataTextField="WONo"  >
                                      <ItemStyle Width="8%" />
                </asp:HyperLinkField>
