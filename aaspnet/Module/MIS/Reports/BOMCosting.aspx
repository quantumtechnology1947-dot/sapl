<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_MIS_Reports_BOMCosting, newerp_deploy" title="ERP" theme="Default" %>
        ...
        <tr>
            <td>
                <table width="100%" align="center" cellpadding="0" cellspacing="0">
                    <tr height="21">
                        <td style="background:url(../../../images/hdbg.JPG)" class="fontcsswhite" ><strong>&nbsp;BOM Costing
                          </strong>
                        </td>
                    </tr>
...
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                    ...
                    DataField="CustomerName">
                           ...
                           <ItemTemplate>
                               ...
                               <asp:LinkButton ID="LinkButton1" runat="server"  CommandName="Sel" Text='<%#Eval("WONo")%>'  ></asp:LinkButton>
                           </ItemTemplate>
