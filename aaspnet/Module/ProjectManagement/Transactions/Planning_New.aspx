<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Planning_New.aspx.cs" Inherits="Module_MaterialPlanning_Transactions_Plannning_New" Title="ERP" Theme ="Default"  %>
        ...
        <tr>
            <td>
                <table width="100%" align="center" cellpadding="0" cellspacing="0">
                    <tr height="21">
                        <td style="background:url(../../../images/hdbg.JPG)" class="fontcsswhite" ><strong>&nbsp;Project Report - New
                          </strong>
                        </td>
                    </tr>
...
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                    ...
                    HeaderText="WO No" 
                    DataNavigateUrlFormatString="~/Module/ProjectManagement/Transactions/pdt.aspx?WONo={0}&amp;" 
                    DataTextField="WONo">
                                      <ItemStyle HorizontalAlign="Center" />
                </asp:HyperLinkField>
