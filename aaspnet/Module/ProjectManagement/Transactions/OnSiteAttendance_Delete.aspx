<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_ProjectManagement_Transactions_OnSiteAttendance_Delete, newerp_deploy" title="ERP" theme="Default" %>
            ...
            <td >
                <asp:Panel ID="Panel5" runat="server" ScrollBars="Auto">
                    <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" 
                        CssClass="yui-datatable-theme" DataKeyNames="Id" PageSize="20" Width="100%" 
