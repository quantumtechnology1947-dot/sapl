<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_ProjectManagement_Transactions_ManPowerPlanning_Edit, newerp_deploy" title="ERP" theme="Default" %>
...
&nbsp;&nbsp; From Date
        ...
        <td height="25px" valign="top">
            ...
            <asp:Panel ID="Panel1" runat="server" Height="200px" ScrollBars="Both" 
                ...
                <asp:GridView ID="GridView2" runat="server" 
                    AutoGenerateColumns="False" CssClass="yui-datatable-theme" Width="800px" 
        ...
        <td>
            ...
            <asp:Panel ID="Panel2" runat="server" Height="212px" ScrollBars="Both" Width="100%">
    ...
    Width="98%" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Planned">
                            <ItemTemplate>
                          <asp:Label ID="lblPlanned" runat="server" Text='<%# Bind("Planned") %>' >
                          </asp:Label>                                
                        <asp:TextBox ID="TxtPlanned" CssClass="box3" runat="server" Width="80%"
                         Text='<%#Eval("Planned") %>' />
                        <asp:RequiredFieldValidator ID="ReqPlanned" runat="server" ControlToValidate="TxtPlanned" 
                        ValidationGroup="A" ErrorMessage="*">
                        ...
                        <asp:TemplateField HeaderText="Actual">
                            <ItemTemplate>
                                ...
                                <asp:TextBox ID="TxtActual" CssClass="box3" runat="server" Width="80%" 
                                Text='<%#Eval("Actual") %>' />
                                <asp:RequiredFieldValidator ID="ReqActual" runat="server" 
                                ControlToValidate="TxtActual" ValidationGroup="A"  ErrorMessage="*">
                                </asp:RequiredFieldValidator>
                        ...
                        <asp:TemplateField HeaderText="Hours">
                            ...
                            <asp:TextBox ID="TxtHrs" CssClass="box3" runat="server" Width="70%" Text='<%#Eval("Hrs") %>' />
                            <asp:RequiredFieldValidator ID="ReqHrs" runat="server" 
                            ControlToValidate="TxtHrs" ValidationGroup="A" ErrorMessage="*">
                            </asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="RegHrs" runat="server"  ValidationGroup="A"                                                ControlToValidate="TxtHrs" ErrorMessage="*"
                        ...
                        <asp:TemplateField Visible="false" HeaderText="MId">
                            <ItemTemplate>
                                <asp:Label ID="lblMId" runat="server" Text='<%# Bind("MId") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                           <asp:TemplateField Visible="false" HeaderText="WONo">
                            <ItemTemplate>
                                <asp:Label ID="lblWONo" runat="server" Text='<%# Bind("WONo") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                           <asp:TemplateField Visible="false" HeaderText="EquipId">
                            <ItemTemplate>
                                <asp:Label ID="lblEquipId" runat="server" Text='<%# Bind("EquipId") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField Visible="false" HeaderText="SubCat">
                            <ItemTemplate>
                                <asp:Label ID="lblSubCat" runat="server" Text='<%# Bind("SubCat") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                              <EmptyDataTemplate>
        ...
        <tr><td align="center" height="25" valign="middle">
            ...
            <asp:Button ID="btnUpdate" runat="server" CssClass="redbox" Text="Update" Visible="false"
