...
public partial class Module_MaterialManagement_Transactions_PR_New_Detail : System.Web.UI.Page
{
    ...
    public void MP_Tree1()
    {
        ...
        try
        {
            ...
            DataRow dr;
            string sql = "select ItemCode,Description,UOM,BOMQ,Design From tblPM_Project_Hardware_Master_Detail Where PRJCTNO='"+lblreport.Text+"'";
    ...
    protected void RadButton2_Click_Cancel(object sender, EventArgs e)
    {
        ...
        foreach (GridDataItem grv2 in RadGrid1.Items)
        {
            ...
            {
                grv2.BackColor = System.Drawing.Color.Pink;
                cmd1 = new SqlCommand("INSERT INTO tblPM_Project_Vendor_Plan_Detail(PRJCTNO,WONo,ItemCode,Description,UOM,BOMQ,Design,VendorPlanDate,VendorAct,VendorPlan) values(@PRJCTNO,@WONo,@ItemCode,@Description,@UOM,@BOMQ,@Design,@VendorPlanDate,@VendorAct,@VendorPlan)", con);
    ...
    {
        Response.Redirect("~/Module/ProjectManagement/Transactions/Boughtout_Report_Info_Edit.aspx?ModId=7&SubModId=156", true);
    }
    protected void RadButton1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string sqlStatment = "INSERT INTO tblPM_Project_Hardware_VendorD(SysDate,SysTime,CompId,SessionId,FinYearId,PRJCTNO,WONo,GenDate,VendorPlan,VendorDate) VALUES(@SysDate,@SysTime,@CompId,@SessionId,@FinYearId,@PRJCTNO,@WONo,@GenDate,@VendorPlan,@VendorDate)";
