...
public partial class Module_MaterialPlanning_Transactions_pdt : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        //  TextBox lblDesc = (TextBox)SearchGridView1.FindControl("lblitemcode");
            ...
            if (chkitems.Checked)
            {
                ...
                cmd1 = new SqlCommand("INSERT INTO tblPM_Project_Site_Master_Detail(PRJCTNO,WONo,ItemCode,Description,UOM,BOMQ,Design,Manf,BOP ,Assemly) values(@PRJCTNO,@WONo,@ItemCode,@Description,@UOM,@BOMQ,@Design,@Manf,@BOP ,@Assemly)", con);
                ...
                cmd1.Parameters.AddWithValue("@Assemly", txtassemly);
