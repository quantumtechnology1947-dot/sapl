<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report_Detail1.aspx.cs" Inherits="Challanreport" %>
...
&nbsp;<small>Email -&quot;sales@synergytechs.com&quot;</small><br />
    ...
    <center> 
            <hr />
        <asp:Label runat="server" ID="dclabel" Text="Site Report" 
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT [ItemCode],[Description],[UOM],[BOMQ],[WONo] ,[Design],[Manf],[BOP],[Assemly] FROM [tblPM_Project_Site_Master_Detail] WHERE ([PRJCTNO] = @PRJCTNO)">
    <SelectParameters>
