...
public partial class Module_ProjectManagement_Transactions_MaterialCreditNote_MCN_New : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "sel")
        {
            ...
            Response.Redirect("~/Module/ProjectManagement/Transactions/MaterialCreditNote_MCN_New_Details.aspx?WOId=" + woid + "&WONo=" + wono + "&ModId=7&SubModId=127");   
        }
