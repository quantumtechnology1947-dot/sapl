...
public partial class Module_ProjectManagement_Reports_ProjectSummary_Details_Grid : System.Web.UI.Page
{
    ...
    public void FillGrid_Creditors()
    {
        try
        {
            ...
            DataTable dt2 = new DataTable();
            {
                ...
                dt2.Columns.Add(new System.Data.DataColumn("Material", typeof(string)));
                dt2.Columns.Add(new System.Data.DataColumn("Revision", typeof(string)));
                ...
                while (daCustWo.Read())
                {
                    ...
                    dr1[29] = daCustWo["Material"].ToString();
                    dr1[30] = daCustWo["Revision"].ToString();
                            ...
                            while (daPR.Read())
                            {
                                ...
                                while (daPo.Read())
                                {
                                   ...
                                   // daCustWo
                                    ...
                                    //string sqlPR1 = "SELECT Material FROM tblDG_BOM_Master where WONo='" + WONo + "' and  tblDG_Item_Master.CompId='" + CompId + "' ) ";
                                    //SqlCommand cmdPR1 = new SqlCommand(sqlPR1, con);
                                    //SqlDataReader daPR1 = cmdPR1.ExecuteReader();

                                    //while (daPR1.Read())
                                    //{
                                    //    dr1[29] = daPR1["Material"].ToString();
                                    //}
                                }
                            }
            ...
            if (k > 0)
            {
                ...
                foreach (ListItem item in CheckBoxList1.Items)
                {
                    if (item.Selected == false)
                    {
                        ...
                        if (item.Value == "27")
                        {
                            dt1.Columns.Remove(dt1.Columns["Material"]);
                        }
                        if (item.Value == "28")
                        {
                            dt1.Columns.Remove(dt1.Columns["Revision"]);
                        }
                    }
                }
            }
