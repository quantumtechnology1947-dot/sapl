...
public partial class Module_ProjectManagement_Reports_ProjectSummary_Details_Hard : System.Web.UI.Page
{
        ...
        try
        {
            ...
            DataTable dt2 = new DataTable();
            {
                ...
                while (daCustWo.Read())
                {
                    ...
                    //string ic = "SELECT tblDG_Item_Master.ItemCode AS ItemCode Where Itemcode Like 'H%'";
