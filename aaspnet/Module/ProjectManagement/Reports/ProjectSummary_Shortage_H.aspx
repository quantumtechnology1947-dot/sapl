<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ProjectSummary_Shortage_H.aspx.cs" Inherits="Module_ProjectManagement_Reports_ProjectSummary_Shortage_H" %>
...
<tr>
<td>
<b>  WONo : <asp:Label ID="lblWo" runat="server" Text=""></asp:Label>&nbsp;[Hardwear Items]</b></td>
</tr>
</table>
<div class="container" >
    
   
                     <asp:DataList ID="GridView3" CssClass="yui-datatable-theme" ShowFooter="true" GridLines="Both" 
