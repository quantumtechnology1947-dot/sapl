<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_ProjectManagement_Reports_ProjectSummary_Shortage_B, newerp_deploy" title="ERP" theme="Default" %>
...
<tr>
<td>
<b>  WONo : <asp:Label ID="lblWo" runat="server" Text=""></asp:Label>&nbsp;[Bought 
    Out Items]</b></td>
</tr>
</table>
<div class="container" >
