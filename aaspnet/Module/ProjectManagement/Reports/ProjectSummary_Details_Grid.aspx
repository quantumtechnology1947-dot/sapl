<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ProjectSummary_Details_Grid.aspx.cs" Inherits="Module_ProjectManagement_Reports_ProjectSummary_Details_Grid" %>
...
<td>
    ...
    <asp:CheckBoxList ID="CheckBoxList1" runat="server" Font-Bold="True" 
        ...
        <asp:ListItem Value="27" Selected="True">Material</asp:ListItem>
        <asp:ListItem Value="28" Selected="True">Revision</asp:ListItem>
    </asp:CheckBoxList>
    </div>
<table width="100%"> 
