<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_HR_Masters_Department, newerp_deploy" title="ERP" theme="Default" %>
        ...
        <tr>
            <td align="left">
                <table cellpadding="0" cellspacing="0" style="width: 600px" >
                    <tr>
                        <td align="left" valign="middle" style="background:url(../../../images/hdbg.JPG)" height="21" class="fontcsswhite"><b>&nbsp;Department</b></td>
                    </tr>
                    <tr>
                        <td align="center">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                                ...
                                <Columns>
                                    ...
                                    <asp:CommandField  ButtonType="Link"   ValidationGroup="A" 
                                        ShowEditButton="True">
                                    ...
                                    <asp:TemplateField HeaderText="Description">
                                        ...
                                        <EditItemTemplate>
                                        <asp:TextBox ID="lblDescription0" Width="96%" CssClass="box3" runat="server" Text='<%#Bind("Description") %>'>
                                        </asp:TextBox>
                                        ...
                                        <FooterTemplate>
                                        <asp:TextBox ID="txtDescription" runat="server" Width="96%" CssClass="box3">
                                        </asp:TextBox>
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <EditItemTemplate>
                                        <asp:TextBox ID="lblSymbol0" runat="server" Width="96%" CssClass="box3"  Text='<%#Bind("Symbol") %>'>
                                        </asp:TextBox>
                                        ...
                                        <FooterTemplate>
                                        <asp:TextBox ID="txtSymbol" Width="96%" CssClass="box3"  runat="server" >
                                        </asp:TextBox>                                        
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                ...
                                DeleteCommand="DELETE FROM [tblHR_Departments] WHERE [Id] = @Id" 
                                InsertCommand="INSERT INTO [tblHR_Departments] ([Description], [Symbol]) VALUES (@Description, @Symbol)" 
                                ProviderName="System.Data.SqlClient" 
                                SelectCommand="SELECT [Id], [Description], [Symbol] FROM [tblHR_Departments] Order by [Id] Desc" 
                                UpdateCommand="UPDATE [tblHR_Departments] SET [Description] = @Description, [Symbol] = @Symbol WHERE [Id] = @Id">
                                <DeleteParameters>
