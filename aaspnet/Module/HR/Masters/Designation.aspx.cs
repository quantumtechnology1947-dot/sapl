...
public class Module_HR_Masters_Designation : Page, IRequiresSessionState
{
	...
	protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		...
		{
			string text = ((TextBox)GridView1.FooterRow.FindControl("txtType")).Text;
		...
		{
			string text3 = ((TextBox)GridView1.Controls[0].Controls[0].FindControl("txtType")).Text;
			string text4 = ((TextBox)GridView1.Controls[0].Controls[0].FindControl("txtSymbol")).Text;
			if (text3 != "" && text4 != "")
			{
				SqlDataSource1.InsertParameters["Type"].DefaultValue = text3;
