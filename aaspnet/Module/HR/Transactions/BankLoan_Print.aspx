<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_HR_Transactions_BankLoan_Print, newerp_deploy" title="ERP" theme="Default" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    ...
    <tr>
            <td align="left" valign="middle" 
                ...
                class="fontcsswhite" colspan="2"><b>&nbsp;Bank Loan - Print</b></td>
        </tr>
        <tr>
             <td align="right">
             ...
             <td>
                ...
                <asp:RadioButtonList ID="RadioButtonList1" runat="server" AutoPostBack="True" 
                    ...
                    <asp:ListItem Value="0" >Emp Wise</asp:ListItem>
                    <asp:ListItem Value="1">All</asp:ListItem>
                </asp:RadioButtonList></td>
        </tr>
        </table >
        <asp:Panel ID="Panel1" Height="410Px"  ScrollBars="Auto" Visible="false" runat="server">
        <table  class="style2">
