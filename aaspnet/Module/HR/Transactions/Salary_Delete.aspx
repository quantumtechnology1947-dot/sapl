<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_HR_Transactions_Salary_Delete, newerp_deploy" title="ERP" theme="Default" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    ...
    <tr>
            <td align="left" valign="middle" 
                ...
                class="fontcsswhite"><b>&nbsp;PayRoll - Delete</b></td>
        </tr>
        <tr>
             <td align="left">
    ...
    <asp:GridView ID="GridView2" runat="server" 
      ...
      <asp:TemplateField HeaderText="SN" ItemStyle-HorizontalAlign="Center"><ItemTemplate> <%# Container.DataItemIndex + 1%> 
          ...
          <asp:HyperLinkField DataNavigateUrlFields="EmpId" 
              DataNavigateUrlFormatString="~/Module/HR/Transactions/Salary_Delete_Details.aspx?EmpId={0}&ModId=12&SubModId=133" 
              Text="Select" >
