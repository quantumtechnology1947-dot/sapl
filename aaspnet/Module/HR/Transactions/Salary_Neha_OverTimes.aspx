<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_HR_Transactions_Salary_Neha_OverTimes, newerp_deploy" title="ERP" theme="Default" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    ...
    <tr>
        <td align="center">
            <asp:Panel ID="Panel1" runat="server" ScrollBars="Vertical"  Height="465" Width="100%">           
    ...
    <CR:CrystalReportSource ID="CrystalReportSource2" runat="server">
        <Report FileName="~\Module\HR\Transactions\Reports\Salary_Neha_Overtimes.rpt"></Report>
