<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_HR_Transactions_OfferLetter_Edit, newerp_deploy" title="ERP" theme="Default" %>
    ...
    <table class="style2" cellpadding="0" cellspacing="0">
       <tr>
            <td align="left" valign="middle"  
                ...
                &nbsp;Offer Letter - Edit / Increment</b></td>
        </tr>
        <tr>
                ...
                <asp:GridView ID="GridView2" runat="server" AllowPaging="True" 
                    ...
                    <Columns>
                        <asp:TemplateField ShowHeader="False">
                         ...
                         <asp:TemplateField ShowHeader="False">
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkBtnIncrement" runat="server" CausesValidation="False"
                                 CommandName="Increment"  Text="Increment">
                                 </asp:LinkButton>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" Width="2%" />
                        </asp:TemplateField>
