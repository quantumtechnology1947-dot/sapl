<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_HR_Transactions_Salary_New_Details, newerp_deploy" title="ERP" theme="Default" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    ...
    <tr>
        <td align="left" valign="middle" 
            ...
            class="fontcsswhite" colspan="14"><b>&nbsp;PayRoll - New</b></td>
    </tr>
    <tr>
    <td>
    ...
    <tr>  
        ...
        <td colspan="4" 
            style="border-right-style: solid; border-right-color: #C0C0C0">:
            <asp:TextBox ID="txtInstallment" Text="0" runat="server" CssClass="box3" Width="100px">0</asp:TextBox>
...
<EmptyDataTemplate>
    ...
    <tr> 
        ...
        <td colspan="2" 
            style="border-right-style: solid; border-right-color: #C0C0C0;">
            <asp:HiddenField ID="HFInc" runat="server" />
        </td> </tr>
    <tr> <td height="25px" 
