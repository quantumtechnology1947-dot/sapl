<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Salary_SAPL_Summary.aspx.cs" Inherits="Module_HR_Transactions_Salary_SAPL_Neha_Summary" Title="ERP" Theme="Default" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    ...
    <CR:CrystalReportSource ID="CrystalReportSource2" runat="server">
        <Report FileName="~\Module\HR\Transactions\Reports\Salary_SAPL_Summary.rpt"></Report>
