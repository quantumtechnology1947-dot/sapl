<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_HR_Transactions_Salary_Edit, newerp_deploy" title="ERP" theme="Default" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    ...
    <tr>
            <td align="left" valign="middle" 
                ...
                class="fontcsswhite"><b>&nbsp;PayRoll - Edit</b></td>
        </tr>
        <tr>
             <td align="left">
    ...
    <asp:GridView ID="GridView2" runat="server" 
      ...
      <asp:TemplateField HeaderText="SN" ItemStyle-HorizontalAlign="Center"><ItemTemplate> <%# Container.DataItemIndex + 1%> 
          ...
          <asp:HyperLinkField DataNavigateUrlFields="EmpId" 
              DataNavigateUrlFormatString="~/Module/HR/Transactions/Salary_Edit_Details.aspx?EmpId={0}&ModId=12 &SubModId=133 " 
              NavigateUrl="~/Module/HR/Transactions/Salary_Edit_Details.aspx" 
              Text="Select" >
