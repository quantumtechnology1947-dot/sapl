<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="OfferLetter_Print_Details.aspx.cs" Inherits="Module_HR_Transactions_OfferLetter_Print_Details" Title="ERP" %>
...
<asp:Content ID="Content8" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
 ...
 <table align="left" cellpadding="0" cellspacing="0" class="style2">
    ...
    <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" 
        AutoDataBind="True" Height="50px" ReportSourceID="CrystalReportSource1" HasCrystalLogo="False"  Visible="false"
        Width="350px" DisplayGroupTree="False" EnableDatabaseLogonPrompt="False" 
        EnableParameterPrompt="False" />
    <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
    <Report FileName="~\Module\HR\Transactions\Reports\OfferLetter.rpt"></Report>
    </CR:CrystalReportSource>
    
        <CR:CrystalReportViewer ID="CrystalReportViewer2" runat="server" 
        AutoDataBind="True" Height="50px" ReportSourceID="CrystalReportSource2" HasCrystalLogo="False" Visible="false"
        Width="350px" DisplayGroupTree="False" EnableDatabaseLogonPrompt="False" 
        EnableParameterPrompt="False" />
    <CR:CrystalReportSource ID="CrystalReportSource2" runat="server">
     <Report FileName="~\Module\HR\Transactions\Reports\IncrementLetter.rpt"></Report>
    </CR:CrystalReportSource>
