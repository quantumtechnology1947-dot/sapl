<%@ Page Language="C#" MasterPageFile="~/MasterPage.master"   AutoEventWireup="true" CodeFile="Copy of pdt.aspx.cs" Inherits="Module_MaterialPlanning_Transactions_pdt" Title="ERP"    Theme="Default" %>
...
<asp:UpdatePanel ID="pnlData" runat="server" UpdateMode="Conditional">
   ...
   <div id="grdWithScroll" style="WIDTH:auto; HEIGHT: 440px" onscroll="SetDivPosition()">
