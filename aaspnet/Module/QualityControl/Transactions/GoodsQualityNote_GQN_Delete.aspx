<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Inventory_Transactions_GoodsQualityNote_GQN_Delete, newerp_deploy" title="ERP" theme="Default" %>
    ...
    <table align="left" cellpadding="0" cellspacing="0" class="style2">
        <tr>
            <td align="left" valign="middle" style="background:url(../../../images/hdbg.JPG)" height="21" class="fontcsswhite">
                <b>&nbsp;Goods Quality Note [GQN] - Delete</b></td>
        </tr>
      <tr>
            <td class="style3" height="x">
                &nbsp;
                <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" 
                    onselectedindexchanged="DropDownList1_SelectedIndexChanged">
                <%--<asp:ListItem Value="Select">Select</asp:ListItem>--%>
                <asp:ListItem Value="0">SupplierName</asp:ListItem>
                <asp:ListItem Value="1">GQN No</asp:ListItem>
                     <asp:ListItem Value="2">GRR No</asp:ListItem>
                          <asp:ListItem Value="3">PO No</asp:ListItem>
                       
                </asp:DropDownList>
                &nbsp;<asp:TextBox ID="txtSupplier" runat="server" Width="350px" 
        ...
        <tr>
            <td align="center">
                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                    ...
                    Width="99%" onrowcommand="GridView2_RowCommand" 
