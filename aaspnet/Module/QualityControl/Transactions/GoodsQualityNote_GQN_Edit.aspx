<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Inventory_Transactions_GoodsQualityNote_GQN_Edit, newerp_deploy" title="ERP" theme="Default" %>
    ...
    <table align="left" cellpadding="0" cellspacing="0" class="style2">
        <tr>
            <td align="left" valign="middle" 
                ...
                class="fontcsswhite">
                <b>&nbsp;Goods Quality Note [GQN] - Edit</b></td>
        </tr>
         <tr>
            <td class="style3">
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                               <%-- <asp:LinkButton ID="btnlnk" runat="Server" CommandName="Sel" Text="Select" />--%>
                                <asp:Label ID="lblNA" runat="Server" Text="NA"/>
                            </ItemTemplate>
