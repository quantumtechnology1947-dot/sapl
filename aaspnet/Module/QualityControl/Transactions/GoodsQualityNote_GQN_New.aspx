<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Inventory_Transactions_GoodsQualityNote_GQN_New, newerp_deploy" title="ERP" theme="Default" %>
            ...
            <td height="25" >
             <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" 
                   ...
                   <%-- <asp:ListItem Value="Select">Select</asp:ListItem>--%>
                        ...
                        <asp:ListItem Value="1">GRR No</asp:ListItem>
