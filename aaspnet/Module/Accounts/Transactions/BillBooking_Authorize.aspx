<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BillBooking_Authorize.aspx.cs" Inherits="Module_Accounts_Transactions_BillBooking_Authorize" Title="ERP" Theme="Default" %>
...
&nbsp;<asp:TextBox ID="txtSupplier" runat="server" Width="350px" CssClass="box3"></asp:TextBox>
                 <asp:TextBox ID="Txtfield" runat="server" CssClass="box3" Visible="False"></asp:TextBox>
                &nbsp; 
                <asp:CheckBox ID="ViewAll" runat="server" Text="View All" />
                ...
                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Id" Visible="false">
                            <ItemTemplate>
                                <asp:Label ID="lblId" runat="Server" Text='<%#Eval("Id")%>'/></ItemTemplate>
                            </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Fin Year">
                          ...
                          <asp:HyperLinkField DataNavigateUrlFields="Id" 
                            DataNavigateUrlFormatString="~/Module/Accounts/Transactions/BillBooking_Print_Details.aspx?Id={0}&f=2&ModId=11&SubModId=62" 
                            HeaderText="PVEV No"  DataTextField="PVEVNo" ItemStyle-HorizontalAlign="Center">
<ItemStyle HorizontalAlign="Center" Width="7%"></ItemStyle>
                        ...
                        <ItemTemplate>
                            <asp:CheckBox ID="CkAuth"  Checked='<%#Eval("CkAuth") %>' AutoPostBack="true" runat="Server" oncheckedchanged="CkAuth_CheckedChanged"/>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
