...
public class Module_Accounts_Transactions_TourVoucher : Page, IRequiresSessionState
{
	...
	public void binddata(string Search, string EmpId)
	{
		...
		try
		{
			...
			string cmdText = fun.select("*", "tblACC_TourIntimation_Master", "CompId='" + CompId + "' And FinYearId<='" + FyId + "'" + text2 + text + " Order by Id Desc ");
	...
	protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		try
		{
			if (e.CommandName == "Sel")
			{
				...
				base.Response.Redirect("TourVoucher_Details.aspx?Id=" + num + "&ModId=11&SubModId=126");
			}
		}
		catch (Exception)
		{
