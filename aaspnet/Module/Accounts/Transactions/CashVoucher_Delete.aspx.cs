...
public partial class Module_Accounts_Transactions_CashVoucher_Delete : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        try
        {
            if (e.CommandName == "Sel")
            {
                ...
                Response.Redirect("CashVoucher_Delete_Details.aspx?Id=" + id + "&ModId=11&SubModId=113");
           ...
           try
            {
                ...
                GridViewRow row = (GridViewRow)(((LinkButton)e.CommandSource).NamingContainer);
                string Id = ((Label)row.FindControl("lblId_R")).Text;

                con.Open();
                string sql = fun.delete("tblACC_CashVoucher_Receipt_Master", "Id='" + Id + "'");
                SqlCommand cmd = new SqlCommand(sql, con);
                cmd.ExecuteNonQuery();               
                con.Close();
                this.FillDataRec();
