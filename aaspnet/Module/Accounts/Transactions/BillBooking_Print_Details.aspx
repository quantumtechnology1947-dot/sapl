<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BillBooking_Print_Details.aspx.cs" Inherits="Module_Accounts_Transactions_BillBooking_Print_Details" Title="ERP" Theme="Default" %>
            ...
            <td align="left" align="left" height="420" valign="top">
                ...
                <ContentTemplate>
                 <asp:Panel ID="Panel1" runat="server" Height="410px" ScrollBars="Auto" 
                    Width="100%">
                    <CR:CrystalReportSource ID="CrystalReportSource1" runat="server"><Report FileName="~/Module/Accounts/Reports/BillBooking.rpt"></Report></CR:CrystalReportSource>
