<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Module_Accounts_Transactions_SalesInvoice_Edit_Details, newerp_deploy" title="ERP" theme="Default" %>
                ...
                <cc1:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="3" 
                            ...
                            <asp:Button ID="Button1" runat="server" CssClass="redbox" Text="Search" 
                                ...
                                <td class="style13" width="10%">City</td><td class="style13"><asp:DropDownList 
                                    ...
                                    <asp:TextBox 
                                        ...
                                        ValidationGroup="A"></asp:RegularExpressionValidator></td><td class="style23">&nbsp;</td><td class="style24">
                                    <asp:TextBox 
                                        ...
                                        &nbsp;</td><td>
                                    <asp:TextBox 
                                        ID="TxtByTINVATNo" runat="server" CssClass="box3" Width="170px" 
                                            Visible="False">-</asp:TextBox><asp:RequiredFieldValidator ID="ReqByTinVatNo" runat="server" 
                                            ControlToValidate="TxtByTINVATNo" ErrorMessage="*" ValidationGroup="A"></asp:RequiredFieldValidator></td></tr><tr><td class="style21" height="25">
                                    &nbsp;</td><td class="style22">
                                        <asp:TextBox 
                                    ID="TxtByECCNo" runat="server" CssClass="box3" Visible="False">-</asp:TextBox>
                                    ...
                                    </td><td class="style23">GST No.</td><td class="style24">
                                    <asp:TextBox 
                                    ID="TxtByTINCSTNo" runat="server" CssClass="box3" Width="150px"></asp:TextBox><asp:RequiredFieldValidator ID="ReqByTInCStNo" runat="server" 
                                            ...
                                            <td class="style23"></td><td class="style23">
                                    <asp:TextBox ID="TxtByTINGSTNo" runat="server" Text="27410344315/G DT 01/04/06" 
                                        Visible=False CssClass="box3" Width="150px"></asp:TextBox> <asp:RequiredFieldValidator ID="ReqByTINGSTNo" runat="server"  ControlToValidate="TxtByTINGSTNo" ErrorMessage="*" ValidationGroup="A"></asp:RequiredFieldValidator></td>        <caption>
                                          <tr>
                                              <td class="style23">
                                              </td>
                                              <caption>
                    ...
                    runat="server" CompletionInterval="100" CompletionSetCount="1" 
                                ...
                                <td 
                                    ...
                                    ID="DrpCoCity" runat="server" AutoPostBack="True"></asp:DropDownList></td></tr><tr><td 
                                        ...
                                        &nbsp;</td><td>
                                        <asp:TextBox 
                                        ID="TxtCoTinVatNo" runat="server" CssClass="box3" Width="170px" 
                                        ...
                                        class="style20" height="25">&nbsp;</td><td class="style15">
                                        <asp:TextBox 
                                        ID="TxtECoCCNo" runat="server" CssClass="box3" Visible="False">-</asp:TextBox><asp:RequiredFieldValidator ID="ReqCECCNo" runat="server" 
                    ...
                    <cc1:TabPanel ID="TabPanel4" runat="server" HeaderText="Taxation">
                        ...
                        <ContentTemplate><table align="left" cellpadding="0" cellspacing="0"  width="750"><tr>
                            ...
                            <td height="25">
                                &nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="TxtOtherAmt" runat="server" CssClass="box3" Visible="False">0</asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td height="25" width="20%" style="width: 35%" colspan="2">
                                    ...
                                    <asp:DropDownList ID="DrpSED" runat="server" 
                                        style="margin-top: 0px" Visible="False">
                                        <asp:ListItem Text="Amt(Rs)" Value="0" Selected="True"></asp:ListItem>
                                        <asp:ListItem Text="Per(%)" Value="1"></asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                            ...
                            <tr>
                                ...
                                <td height="25" width="17%" colspan="2">
                                    <asp:TextBox ID="TxtInsurance" runat="server" CssClass="box3" Visible="False">0</asp:TextBox>
