...
public partial class Challan : System.Web.UI.Page
{
    ...
    private void BindGrid()
    {
        ...
        using (SqlConnection con = new SqlConnection(constr))
        {
            ...
            {
                cmd.CommandText = "Select Id,CVDate,CVName,CVFileName from tblACC_POLICY";
                cmd.Connection = con;
                con.Open();
    ...
    protected void Btnsubmit_Click(object sender, EventArgs e)
    {
        Save();
        // clear();
        Response.Redirect("ACC_POLICY.aspx", true);
    }
    protected void Save()
    {
        try
        {
            ...
            string StrAdd = fun.insert("tblACC_POLICY", "SysDate,SysTime,CompId,FinYearId,SessionId,CVFileName,CVSize,CVContentType,CVData,CVDate,CVName", "'" + CDate + "','" + CTime + "','" + CompId + "','" + FinYearId + "','" + sId + "','" + strcv + "','" + mycvdata.Length + "','" + mycv.ContentType + "',@CV,'" + txtfileDate.Text + "','" + txtpdf.Text + "'");
        ...
        try
        {
            ...
            using (SqlConnection con = new SqlConnection(constr1))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    cmd.CommandText = "select CVFileName,CVContentType,CVData from  tblACC_POLICY where Id=@Id";
