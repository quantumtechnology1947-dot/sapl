...
public partial class Module_Accounts_Transactions_BillBooking_Delete : System.Web.UI.Page
{
    ...
    public void loadData(string spid, string pono)
    {
         try
        {
            ...
            while (DSSql.Read())
            {
                ...
                dr[9] = DSSql["BillNo"].ToString();
                dr[10] = fun.FromDateDMY(DSSql["BillDate"].ToString());
