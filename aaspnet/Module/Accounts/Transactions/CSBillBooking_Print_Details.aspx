<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CSBillBooking_Print_Details.aspx.cs" Inherits="Module_Accounts_Transactions_BillBooking_Print_Details" Title="ERP" Theme="Default" %>
            ...
            <td align="left" align="left" height="420" valign="top">
                ...
                <ContentTemplate>
                 <asp:Panel ID="Panel1" runat="server" Height="410px" ScrollBars="Auto" 
                    ...
                    <CR:CrystalReportSource ID="CrystalReportSource1" runat="server"><Report FileName="~/Module/Accounts/Reports/CSBillBooking.rpt"></Report></CR:CrystalReportSource>
