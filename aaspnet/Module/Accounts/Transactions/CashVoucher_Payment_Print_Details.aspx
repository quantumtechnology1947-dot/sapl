<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CashVoucher_Payment_Print_Details.aspx.cs" Inherits="Module_Accounts_Transactions_CashVoucher_Payment_Print_Details" Title="ERP" Theme="Default" %>
...
<CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" HasCrystalLogo="False"
        ...
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server" >
            <Report FileName="Module\Accounts\Reports\CashVoucher_Payment.rpt">
            </Report>
