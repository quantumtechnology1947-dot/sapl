...
public class Module_Accounts_Masters_ExcisableCommodity : Page, IRequiresSessionState
{
	...
	protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
	{
		try
		{
			...
			{
				sqlConnection.Open();
				string cmdText = "UPDATE tblExciseCommodity_Master SET Terms ='" + text + "' WHERE Id ='" + num + "'";
