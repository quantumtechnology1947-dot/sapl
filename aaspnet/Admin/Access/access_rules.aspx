<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Admin_Access_access_rules, newerp_deploy" title="ERP" theme="Default" %>
...
<table width="100%">
<tr>
	<th>ERP Access Rules</th>
</tr>

<tr>
	<td class="details" valign="top">
		<p>
		Use this page to manage access rules for your ERP System. Rules are applied to 
            Modules, thus providing robust module-level security enforced by the ERP infrastructure.</p>
		...
		<tr>
			...
			<asp:Panel runat="server" ID="SecurityInfoSection" Visible="false">
				...
				<asp:GridView runat="server" ID="RulesGrid" Width="100%" AutoGenerateColumns="false"
