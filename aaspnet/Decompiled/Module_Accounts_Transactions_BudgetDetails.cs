...
public class Module_Accounts_Transactions_BudgetDetails : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			try
			{
				...
				lblCode.Text = dataSet.Tables[0].Rows[0]["Symbol"].ToString();
			}
			catch (Exception)
			{
			}
	...
	protected void BtnExport_Click(object sender, EventArgs e)
	{
		...
		{
			string text = base.Request.QueryString["Id"];
			base.Response.Redirect("~/Module/MIS/Transactions/Budget_Dept_Print.aspx?Id=" + text);
		}
		catch (Exception)
		{
		}
