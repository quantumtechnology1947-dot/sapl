...
public class Module_SalesDistribution_Transactions_Quotation_Check : Page, IRequiresSessionState
{
	...
	protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		...
		try
		{
			...
			if (e.CommandName == "check")
			{
				foreach (GridViewRow row in GridView2.Rows)
				{
					...
					if (checkBox.Checked)
					{
						...
						string cmdText = fun.update("SD_Cust_Quotation_Master", "Checked='1',CheckedBy='" + sId + "',CheckedDate='" + currDate + "',CheckedTime='" + currTime + "'", "CompId='" + CompId + "' AND QuotationNo='" + text + "' AND Id='" + text2 + "' ");
			...
			if (e.CommandName == "view")
			{
				...
				{
					base.Response.Redirect("Quotation_Print_Details.aspx?ModId=2&SubModId=63&Id=" + text5 + "&QuotationNo=" + text3 + "&EnqId=" + dataSet.Tables[0].Rows[0]["EnqId"].ToString() + "&CustomerId=" + text4 + "&parentpage=1");
				}
			}
		}
		catch (Exception)
