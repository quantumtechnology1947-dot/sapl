...
public class OfferLetter : DataSet
{
	...
	public class DataTable1DataTable : TypedTableBase<DataTable1Row>
	{
		...
		public DataTable1Row AddDataTable1Row(int OfferId, int CompId, string EmployeeName, string StaffType, int TypeOf, double salary, string DutyHrs, string OTHrs, string OverTime, string InterviewedBy, string AuthorizedBy, string ReferenceBy, string Designation, double ExGratia, double VehicleAllowance, double LTA, double Loyalty, double PaidLeaves, string Remarks, string HeaderText, string FooterText, string SysDate, double PerMonth, double PerMonthA, double Basic, double BasicA, double DA, double DAA, double HRA, double HRAA, double Conveyance, double ConveyanceA, double Education, double EducationA, double MedicalAllowance, double MedicalAllowanceA, double AttendanceBonus, double AttendanceBonusA, double ExGratiaA, double TakeHomeINR, double TakeHomeWithAttend1, double TakeHomeWithAttend2, double LoyaltyBenefitA, double LTAA, double PFE, double PFEA, double PFC, double PFCA, double Bonus, double BonusA, double Gratuity, double GratuityA, double VehicleAllowanceA, double CTCinINR, double CTCinINRA, double CTCinINRwithAttendBonus1, double CTCinINRwithAttendBonus1A, double CTCinINRwithAttendBonus2, double CTCinINRwithAttendBonus2A, string AttBonPer, string AttBonPer2, double AttendanceBonus2, double AttendanceBonusB, string PFEmployee, string PFCompany)
		{
			...
			object[] itemArray = new object[65]
			{
				...
				AttBonPer2, AttendanceBonus2, AttendanceBonusB, PFEmployee, PFCompany
			};
		...
		public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
		{
			...
			xmlSchemaAttribute.FixedValue = offerLetter.Namespace;
			...
			XmlSchema schemaSerializable = offerLetter.GetSchemaSerializable();
	...
	[DebuggerNonUserCode]
	protected OfferLetter(SerializationInfo info, StreamingContext context)
	...
	{
		OfferLetter offerLetter = (OfferLetter)base.Clone();
		offerLetter.InitVars();
		offerLetter.SchemaSerializationMode = SchemaSerializationMode;
		return offerLetter;
	}
	...
	private void InitClass()
	{
		base.DataSetName = "OfferLetter";
		base.Prefix = "";
		base.Namespace = "http://tempuri.org/OfferLetter.xsd";
	...
	public static XmlSchemaComplexType GetTypedDataSetSchema(XmlSchemaSet xs)
	{
		...
		XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
		XmlSchemaAny xmlSchemaAny = new XmlSchemaAny();
		xmlSchemaAny.Namespace = offerLetter.Namespace;
		xmlSchemaSequence.Items.Add(xmlSchemaAny);
		xmlSchemaComplexType.Particle = xmlSchemaSequence;
		XmlSchema schemaSerializable = offerLetter.GetSchemaSerializable();
		if (xs.Contains(schemaSerializable.TargetNamespace))
