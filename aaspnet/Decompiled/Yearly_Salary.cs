...
[Serializable]
[XmlRoot("Yearly_Salary")]
[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "2.0.0.0")]
[HelpKeyword("vs.data.DataSet")]
[DesignerCategory("code")]
[ToolboxItem(true)]
[XmlSchemaProvider("GetTypedDataSetSchema")]
public class Yearly_Salary : DataSet
{
	...
	public class DataTable1DataTable : TypedTableBase<DataTable1Row>
	{
		...
		public DataTable1Row AddDataTable1Row(string EmpId, int CompId, string EmployeeName, string Month, string Year, string Dept, string Designation, string Status, string Grade, double Basic, double DA, double HRA, double Conveyance, double Education, double Medical, double SundayP, double GrossTotal, double AttendanceBonus, double SpecialAllowance, double ExGratia, double TravellingAllowance, double Miscellaneous, double Total, double NetPay, double WorkingDays, double PreasentDays, double AbsentDays, double Sunday, double Holiday, double LateIn, double Coff, double HalfDays, double PL, double LWP, double PFofEmployee, double PTax, double PersonalLoanInstall, double MobileBill, double Miscellaneous2, double Total2, string EmpACNo, string Date, double BasicCal, double DACal, double HRACal, double ConveyanceCal, double EducationCal, double MedicalCal, double GrossTotalCal, double AttBonusType, double AttBonusAmt, string PFNo, string PANNo, double OTHrs1, double OTRate, string Path, int SN)
		{
			...
			object[] itemArray = new object[57]
			{
				...
				AttBonusAmt, PFNo, PANNo, OTHrs1, OTRate, Path, SN
			};
		...
		private void InitClass()
		{
			...
			columnAttBonusType = new DataColumn("AttBonusType", typeof(double), null, MappingType.Element);
		...
		public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
		{
			...
			Yearly_Salary yearly_Salary = new Yearly_Salary();
			...
			xmlSchemaAttribute.FixedValue = yearly_Salary.Namespace;
			...
			XmlSchema schemaSerializable = yearly_Salary.GetSchemaSerializable();
	...
	public class DataTable1Row : DataRow
	{
		...
		[DebuggerNonUserCode]
		public double AttBonusType
		{
			get
			{
				try
				{
					return (double)base[tableDataTable1.AttBonusTypeColumn];
				}
				catch (InvalidCastException innerException)
				{
	...
	[DebuggerNonUserCode]
	protected Yearly_Salary(SerializationInfo info, StreamingContext context)
	...
	{
		Yearly_Salary yearly_Salary = (Yearly_Salary)base.Clone();
		yearly_Salary.InitVars();
		yearly_Salary.SchemaSerializationMode = SchemaSerializationMode;
	...
	private void InitClass()
	{
		base.DataSetName = "Yearly_Salary";
		base.Prefix = "";
		base.Namespace = "http://tempuri.org/Yearly_Salary.xsd";
	...
	public static XmlSchemaComplexType GetTypedDataSetSchema(XmlSchemaSet xs)
	{
		...
		XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
		XmlSchemaAny xmlSchemaAny = new XmlSchemaAny();
		xmlSchemaAny.Namespace = yearly_Salary.Namespace;
		xmlSchemaSequence.Items.Add(xmlSchemaAny);
		xmlSchemaComplexType.Particle = xmlSchemaSequence;
		XmlSchema schemaSerializable = yearly_Salary.GetSchemaSerializable();
		if (xs.Contains(schemaSerializable.TargetNamespace))
