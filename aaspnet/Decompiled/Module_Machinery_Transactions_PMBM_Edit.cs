...
public class Module_Machinery_Transactions_PMBM_Edit : Page, IRequiresSessionState
{
	...
	protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		try
		{
			if (e.CommandName == "Sel")
			{
				...
				if (num != 0)
				{
					base.Response.Redirect("~/Module/Machinery/Transactions/PMBM_Edit_Details.aspx?PMBMId=" + num + "&ModId=15&SubModId=68");
				}
			}
		}
		catch (Exception)
