...
public class Module_Inventory_Transactions_CustomerChallan_Print : Page, IRequiresSessionState
{
	...
	protected void SearchGridView1_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		if (e.CommandName == "sel")
		{
			...
			base.Response.Redirect("~/Module/Inventory/Transactions/CustomerChallan_Print_Details.aspx?Id=" + text + "&Key=" + randomAlphaNumeric + "&Key1=" + randomAlphaNumeric2 + "&ModId=9&SubModId=121");
		}
	}
}
