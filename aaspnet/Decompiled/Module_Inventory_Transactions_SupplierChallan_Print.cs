...
public class Module_Inventory_Transactions_SupplierChallan_Print : Page, IRequiresSessionState
{
	...
	protected void SearchGridView1_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		if (e.CommandName == "sel")
		{
			...
			base.Response.Redirect("~/Module/Inventory/Transactions/SupplierChallan_Print_Details.aspx?Id=" + text + "&Key=" + randomAlphaNumeric + "&Key1=" + randomAlphaNumeric2 + "&T=" + selectedValue + "&ModId=9&SubModId=118");
		}
	}
}
