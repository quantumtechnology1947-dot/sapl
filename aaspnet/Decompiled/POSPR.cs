...
public class POSPR : DataSet
{
	...
	public class DataTable1DataTable : TypedTableBase<DataTable1Row>
	{
		...
		private DataColumn columnSPRNo;
		...
		[DebuggerNonUserCode]
		public DataColumn SPRNoColumn => columnSPRNo;
		...
		internal void InitVars()
		{
			...
			columnSPRNo = base.Columns["SPRNo"];
		...
		private void InitClass()
		{
			...
			columnSPRNo = new DataColumn("SPRNo", typeof(string), null, MappingType.Element);
			base.Columns.Add(columnSPRNo);
		...
		public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
		{
			...
			xmlSchemaAttribute.FixedValue = pOSPR.Namespace;
			...
			XmlSchema schemaSerializable = pOSPR.GetSchemaSerializable();
	...
	public class DataTable1Row : DataRow
	{
		...
		public string SPRNo
		{
			get
			{
				try
				{
					return (string)base[tableDataTable1.SPRNoColumn];
				}
				catch (InvalidCastException innerException)
				{
					throw new StrongTypingException("The value for column 'SPRNo' in table 'DataTable1' is DBNull.", innerException);
				}
			}
			set
			{
				base[tableDataTable1.SPRNoColumn] = value;
			}
		}
		...
		[DebuggerNonUserCode]
		public bool IsSPRNoNull()
		{
			return IsNull(tableDataTable1.SPRNoColumn);
		}

		[DebuggerNonUserCode]
		public void SetSPRNoNull()
		{
			base[tableDataTable1.SPRNoColumn] = Convert.DBNull;
		}
	...
	[DebuggerNonUserCode]
	protected POSPR(SerializationInfo info, StreamingContext context)
	...
	{
		POSPR pOSPR = (POSPR)base.Clone();
		pOSPR.InitVars();
		pOSPR.SchemaSerializationMode = SchemaSerializationMode;
		return pOSPR;
	}
	...
	private void InitClass()
	{
		base.DataSetName = "POSPR";
		base.Prefix = "";
		base.Namespace = "http://tempuri.org/POSPR.xsd";
	...
	public static XmlSchemaComplexType GetTypedDataSetSchema(XmlSchemaSet xs)
	{
		...
		XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
		XmlSchemaAny xmlSchemaAny = new XmlSchemaAny();
		xmlSchemaAny.Namespace = pOSPR.Namespace;
		xmlSchemaSequence.Items.Add(xmlSchemaAny);
		xmlSchemaComplexType.Particle = xmlSchemaSequence;
		XmlSchema schemaSerializable = pOSPR.GetSchemaSerializable();
		if (xs.Contains(schemaSerializable.TargetNamespace))
