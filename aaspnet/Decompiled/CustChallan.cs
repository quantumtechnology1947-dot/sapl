...
public class CustChallan : DataSet
{
	...
	public class DataTable1DataTable : TypedTableBase<DataTable1Row>
	{
		...
		private DataColumn columnCCDate;
		...
		[DebuggerNonUserCode]
		public DataColumn CCDateColumn => columnCCDate;
		...
		[DebuggerNonUserCode]
		public DataTable1Row AddDataTable1Row(int Id, string WONo, string CCNo, string CCDate, string ItemCode, string Description, string UOM, double ChallanQty, string SysTime, int CompId)
		{
			DataTable1Row dataTable1Row = (DataTable1Row)NewRow();
			object[] itemArray = new object[10] { Id, WONo, CCNo, CCDate, ItemCode, Description, UOM, ChallanQty, SysTime, CompId };
		...
		internal void InitVars()
		{
			...
			columnCCDate = base.Columns["CCDate"];
		...
		private void InitClass()
		{
			...
			columnCCDate = new DataColumn("CCDate", typeof(string), null, MappingType.Element);
			base.Columns.Add(columnCCDate);
		...
		public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
		{
			...
			CustChallan custChallan = new CustChallan();
			...
			xmlSchemaAttribute.FixedValue = custChallan.Namespace;
			...
			XmlSchema schemaSerializable = custChallan.GetSchemaSerializable();
	...
	public class DataTable1Row : DataRow
	{
		...
		public string CCDate
		{
			get
			{
				try
				{
					return (string)base[tableDataTable1.CCDateColumn];
				}
				catch (InvalidCastException innerException)
				{
					throw new StrongTypingException("The value for column 'CCDate' in table 'DataTable1' is DBNull.", innerException);
				}
			}
			set
			{
				base[tableDataTable1.CCDateColumn] = value;
			}
		}
		...
		{
			return IsNull(tableDataTable1.CCDateColumn);
		}

		[DebuggerNonUserCode]
		public void SetCCDateNull()
		{
			base[tableDataTable1.CCDateColumn] = Convert.DBNull;
		}
	...
	[DebuggerNonUserCode]
	protected CustChallan(SerializationInfo info, StreamingContext context)
	...
	{
		CustChallan custChallan = (CustChallan)base.Clone();
		custChallan.InitVars();
		custChallan.SchemaSerializationMode = SchemaSerializationMode;
		return custChallan;
	}
	...
	private void InitClass()
	{
		base.DataSetName = "CustChallan";
		base.Prefix = "";
		base.Namespace = "http://tempuri.org/CustChallan.xsd";
	...
	public static XmlSchemaComplexType GetTypedDataSetSchema(XmlSchemaSet xs)
	{
		...
		XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
		XmlSchemaAny xmlSchemaAny = new XmlSchemaAny();
		xmlSchemaAny.Namespace = custChallan.Namespace;
		xmlSchemaSequence.Items.Add(xmlSchemaAny);
		xmlSchemaComplexType.Particle = xmlSchemaSequence;
		XmlSchema schemaSerializable = custChallan.GetSchemaSerializable();
		if (xs.Contains(schemaSerializable.TargetNamespace))
