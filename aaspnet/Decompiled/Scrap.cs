...
public class Scrap : DataSet
{
	...
	public class DataTable1DataTable : TypedTableBase<DataTable1Row>
	{
		...
		private DataColumn columnRetQty;

		private DataColumn columnRemarks;

		private DataColumn columnQty;

		private DataColumn columnScrapNo;
		...
		[DebuggerNonUserCode]
		public DataColumn RetQtyColumn => columnRetQty;
		...
		[DebuggerNonUserCode]
		public DataColumn ScrapNoColumn => columnScrapNo;
		...
		[DebuggerNonUserCode]
		public DataTable1Row AddDataTable1Row(int Id, string ItemCode, string ManfDesc, string UOMBasic, string Symbol, string WONo, double AcceptedQty, double RetQty, string Remarks, double Qty, string ScrapNo, int CompId, string SysDate)
		{
			DataTable1Row dataTable1Row = (DataTable1Row)NewRow();
			object[] itemArray = new object[13]
			{
				Id, ItemCode, ManfDesc, UOMBasic, Symbol, WONo, AcceptedQty, RetQty, Remarks, Qty,
				ScrapNo, CompId, SysDate
			};
		...
		internal void InitVars()
		{
			...
			columnRetQty = base.Columns["RetQty"];
			columnRemarks = base.Columns["Remarks"];
			columnQty = base.Columns["Qty"];
			columnScrapNo = base.Columns["ScrapNo"];
		...
		private void InitClass()
		{
			...
			columnRetQty = new DataColumn("RetQty", typeof(double), null, MappingType.Element);
			base.Columns.Add(columnRetQty);
			...
			columnScrapNo = new DataColumn("ScrapNo", typeof(string), null, MappingType.Element);
			base.Columns.Add(columnScrapNo);
		...
		public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
		{
			...
			xmlSchemaAttribute.FixedValue = scrap.Namespace;
			...
			XmlSchema schemaSerializable = scrap.GetSchemaSerializable();
	...
	public class DataTable1Row : DataRow
	{
		...
		public double RetQty
		{
			get
			{
				try
				{
					return (double)base[tableDataTable1.RetQtyColumn];
				}
				catch (InvalidCastException innerException)
				{
					throw new StrongTypingException("The value for column 'RetQty' in table 'DataTable1' is DBNull.", innerException);
				}
			}
			set
			{
				base[tableDataTable1.RetQtyColumn] = value;
			}
		}
		...
		public string ScrapNo
		{
			get
			{
				try
				{
					return (string)base[tableDataTable1.ScrapNoColumn];
				}
				catch (InvalidCastException innerException)
				{
					throw new StrongTypingException("The value for column 'ScrapNo' in table 'DataTable1' is DBNull.", innerException);
				}
			}
			set
			{
				base[tableDataTable1.ScrapNoColumn] = value;
			}
		}
		...
		{
			return IsNull(tableDataTable1.RetQtyColumn);
		}

		[DebuggerNonUserCode]
		public void SetRetQtyNull()
		{
			base[tableDataTable1.RetQtyColumn] = Convert.DBNull;
		}
		...
		[DebuggerNonUserCode]
		public bool IsScrapNoNull()
		{
			return IsNull(tableDataTable1.ScrapNoColumn);
		}

		[DebuggerNonUserCode]
		public void SetScrapNoNull()
		{
			base[tableDataTable1.ScrapNoColumn] = Convert.DBNull;
		}
	...
	[DebuggerNonUserCode]
	protected Scrap(SerializationInfo info, StreamingContext context)
	...
	{
		Scrap scrap = (Scrap)base.Clone();
		scrap.InitVars();
		scrap.SchemaSerializationMode = SchemaSerializationMode;
		return scrap;
	}
	...
	private void InitClass()
	{
		base.DataSetName = "Scrap";
		base.Prefix = "";
		base.Namespace = "http://tempuri.org/Scrap.xsd";
	...
	public static XmlSchemaComplexType GetTypedDataSetSchema(XmlSchemaSet xs)
	{
		...
		XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
		XmlSchemaAny xmlSchemaAny = new XmlSchemaAny();
		xmlSchemaAny.Namespace = scrap.Namespace;
		xmlSchemaSequence.Items.Add(xmlSchemaAny);
		xmlSchemaComplexType.Particle = xmlSchemaSequence;
		XmlSchema schemaSerializable = scrap.GetSchemaSerializable();
		if (xs.Contains(schemaSerializable.TargetNamespace))
