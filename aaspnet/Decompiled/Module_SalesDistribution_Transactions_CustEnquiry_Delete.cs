...
public class Module_SalesDistribution_Transactions_CustEnquiry_Delete : Page, IRequiresSessionState
{
	...
	public void BindDataCust(string Cid, string EID)
	{
		try
		{
			...
			for (int i = 0; i < dataSet.Tables[0].Rows.Count; i++)
			{
				...
				string cmdText2 = fun.select("CloseOpen", "SD_Cust_WorkOrder_Master", "FinYearId<='" + FinYearId + "' AND CompId='" + CompId + "'  And EnqId='" + dataSet.Tables[0].Rows[i]["EnqId"].ToString() + "'");
