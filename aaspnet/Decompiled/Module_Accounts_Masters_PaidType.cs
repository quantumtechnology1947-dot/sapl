...
public class Module_Accounts_Masters_PaidType : Page, IRequiresSessionState
{
	...
	protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		try
		{
			if (e.CommandName == "Add")
			{
				...
				if (text != "")
				{
					SqlDataSource1.InsertParameters["Particulars"].DefaultValue = text;
			...
			if (e.CommandName == "Add1")
			{
				...
				if (text2 != "")
				{
					SqlDataSource1.InsertParameters["Particulars"].DefaultValue = text2;
					SqlDataSource1.Insert();
					lblMessage.Text = "Record Inserted";
				}
			}
	...
	protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
	{
		try
		{
			...
			{
				sqlConnection.Open();
				string cmdText = "UPDATE tblACC_PaidType SET Particulars ='" + text + "' WHERE Id ='" + num + "'";
