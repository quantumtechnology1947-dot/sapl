...
public class Module_Accounts_Transactions_ProformaInvoice_Print : Page, IRequiresSessionState
{
	...
	public void bindgrid(string Cid, string wn)
	{
		...
		try
		{
			...
			string cmdText = fun.select("Id,FinYearId,SysDate,InvoiceNo,WONo,PONo,CustomerCode", "tblACC_ProformaInvoice_Master", "CompId='" + CompId + "' And FinYearId<='" + FinYearId + "'" + text + text2 + text3 + " Order by InvoiceNo DESC");
	...
	protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		if (e.CommandName == "Sel")
		{
			try
			{
				...
				base.Response.Redirect("ProformaInvoice_Print_Details.aspx?InvNo=" + text + "&InvId=" + text2 + "&cid=" + text3 + "&PT=" + selectedValue + "&ModId=11&SubModId=104&Key=" + randomAlphaNumeric);
			}
			catch (Exception)
			{
			}
