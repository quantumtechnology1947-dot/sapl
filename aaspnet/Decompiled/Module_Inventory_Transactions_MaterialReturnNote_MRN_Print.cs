...
public class Module_Inventory_Transactions_MaterialReturnNote_MRN_Print : Page, IRequiresSessionState
{
	...
	protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		try
		{
			...
			{
				base.Response.Redirect("MaterialReturnNote_MRN_Print_Details.aspx?Id=" + text + "&Key=" + randomAlphaNumeric + "&MRNNo=" + MrnNo + "&FYId=" + FyId + "&ModId=9&SubModId=48");
			}
		}
		catch (Exception)
		{
