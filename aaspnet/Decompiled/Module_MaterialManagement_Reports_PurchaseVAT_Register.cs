...
public class Module_MaterialManagement_Reports_PurchaseVAT_Register : Page, IRequiresSessionState
{
	...
	{
		base.Response.Redirect("Purchase_Reprt.aspx?ModId=6&SubModId=");
	}
}
