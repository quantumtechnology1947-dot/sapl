...
public class Advice : DataSet
{
	...
	public class DataTable1DataTable : TypedTableBase<DataTable1Row>
	{
		...
		[DebuggerNonUserCode]
		public DataColumn ADNoColumn => columnADNo;
		...
		[DebuggerNonUserCode]
		public DataTable1Row AddDataTable1Row(string PaidTo, int CompId, string ChequeDate, double Amount, string Address, string ADNo, string ChequeNo, string SysDate, string BillNo, string TypeECS, string ECS, string InvoiceNo, string Particulars, string InvDate)
		{
			DataTable1Row dataTable1Row = (DataTable1Row)NewRow();
			object[] itemArray = new object[14]
			{
				PaidTo, CompId, ChequeDate, Amount, Address, ADNo, ChequeNo, SysDate, BillNo, TypeECS,
				ECS, InvoiceNo, Particulars, InvDate
			};
		...
		private void InitClass()
		{
			...
			columnADNo = new DataColumn("ADNo", typeof(string), null, MappingType.Element);
			base.Columns.Add(columnADNo);
		...
		public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
		{
			...
			xmlSchemaAttribute.FixedValue = advice.Namespace;
			...
			XmlSchema schemaSerializable = advice.GetSchemaSerializable();
	...
	public class DataTable1Row : DataRow
	{
		...
		public string ADNo
		{
			get
			{
				try
				{
					return (string)base[tableDataTable1.ADNoColumn];
				}
				catch (InvalidCastException innerException)
				{
					throw new StrongTypingException("The value for column 'ADNo' in table 'DataTable1' is DBNull.", innerException);
				}
			}
			set
			{
				base[tableDataTable1.ADNoColumn] = value;
			}
		}
		...
		{
			return IsNull(tableDataTable1.ADNoColumn);
		}

		[DebuggerNonUserCode]
		public void SetADNoNull()
		{
			base[tableDataTable1.ADNoColumn] = Convert.DBNull;
		}
	...
	[DebuggerNonUserCode]
	protected Advice(SerializationInfo info, StreamingContext context)
	...
	{
		Advice advice = (Advice)base.Clone();
		advice.InitVars();
		advice.SchemaSerializationMode = SchemaSerializationMode;
		return advice;
	}
	...
	private void InitClass()
	{
		base.DataSetName = "Advice";
		base.Prefix = "";
		base.Namespace = "http://tempuri.org/Advice.xsd";
	...
	public static XmlSchemaComplexType GetTypedDataSetSchema(XmlSchemaSet xs)
	{
		...
		XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
		XmlSchemaAny xmlSchemaAny = new XmlSchemaAny();
		xmlSchemaAny.Namespace = advice.Namespace;
		xmlSchemaSequence.Items.Add(xmlSchemaAny);
		xmlSchemaComplexType.Particle = xmlSchemaSequence;
		XmlSchema schemaSerializable = advice.GetSchemaSerializable();
		if (xs.Contains(schemaSerializable.TargetNamespace))
