...
public class Module_Accounts_Masters_TourExpencess : Page, IRequiresSessionState
{
	...
	protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
	{
		try
		{
			...
			{
				sqlConnection.Open();
				string cmdText = "UPDATE tblACC_TourExpencessType SET Terms ='" + text + "' WHERE Id ='" + num + "'";
