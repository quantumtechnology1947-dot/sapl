...
public class Module_Inventory_Transactions_SupplierChallan_Delete : Page, IRequiresSessionState
{
	...
	public void BindData(string spid)
	{
		try
		{
			...
			SqlDataAdapter sqlDataAdapter = new SqlDataAdapter("GetSupChallan", selectConnection);
