...
[XmlRoot("ABCAnalysis")]
public class ABCAnalysis : DataSet
{
	...
	public class DataTable1DataTable : TypedTableBase<DataTable1Row>
	{
		...
		[DebuggerNonUserCode]
		public DataColumn APColumn => columnAP;
		...
		[DebuggerNonUserCode]
		public DataTable1Row AddDataTable1Row(int Id, string ItemCode, string ManfDesc, string Category, string SubCategory, string UOM, int CompId, double GQNQTY, double ISSUEQTY, double OPENINGQTY, double CLOSINGQTY, double RateReg, double Amount, string Type, double AP, double CP)
		{
			...
			object[] itemArray = new object[16]
			{
				...
				CLOSINGQTY, RateReg, Amount, Type, AP, CP
			};
		...
		private void InitClass()
		{
			...
			columnAP = new DataColumn("AP", typeof(double), null, MappingType.Element);
			base.Columns.Add(columnAP);
			columnCP = new DataColumn("CP", typeof(double), null, MappingType.Element);
		...
		public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
		{
			...
			xmlSchemaAttribute.FixedValue = aBCAnalysis.Namespace;
			...
			XmlSchema schemaSerializable = aBCAnalysis.GetSchemaSerializable();
	...
	public class DataTable1Row : DataRow
	{
		...
		public double AP
		{
			get
			{
				try
				{
					return (double)base[tableDataTable1.APColumn];
				}
				catch (InvalidCastException innerException)
				{
					throw new StrongTypingException("The value for column 'AP' in table 'DataTable1' is DBNull.", innerException);
				}
			}
			set
			{
				base[tableDataTable1.APColumn] = value;
			}
		}
		...
		public double CP
		{
			get
			{
				try
				{
					return (double)base[tableDataTable1.CPColumn];
				}
				catch (InvalidCastException innerException)
				{
					throw new StrongTypingException("The value for column 'CP' in table 'DataTable1' is DBNull.", innerException);
				}
			}
			set
			{
				base[tableDataTable1.CPColumn] = value;
			}
		}
		...
		{
			return IsNull(tableDataTable1.APColumn);
		}

		[DebuggerNonUserCode]
		public void SetAPNull()
		{
			base[tableDataTable1.APColumn] = Convert.DBNull;
		}

		[DebuggerNonUserCode]
		public bool IsCPNull()
		{
			return IsNull(tableDataTable1.CPColumn);
		}

		[DebuggerNonUserCode]
		public void SetCPNull()
		{
			base[tableDataTable1.CPColumn] = Convert.DBNull;
		}
	}
	...
	[DebuggerNonUserCode]
	protected ABCAnalysis(SerializationInfo info, StreamingContext context)
	...
	{
		ABCAnalysis aBCAnalysis = (ABCAnalysis)base.Clone();
		aBCAnalysis.InitVars();
		aBCAnalysis.SchemaSerializationMode = SchemaSerializationMode;
		return aBCAnalysis;
	}
	...
	private void InitClass()
	{
		base.DataSetName = "ABCAnalysis";
		base.Prefix = "";
		base.Namespace = "http://tempuri.org/ABCAnalysis.xsd";
	...
	public static XmlSchemaComplexType GetTypedDataSetSchema(XmlSchemaSet xs)
	{
		...
		XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
		XmlSchemaAny xmlSchemaAny = new XmlSchemaAny();
		xmlSchemaAny.Namespace = aBCAnalysis.Namespace;
		xmlSchemaSequence.Items.Add(xmlSchemaAny);
		xmlSchemaComplexType.Particle = xmlSchemaSequence;
		XmlSchema schemaSerializable = aBCAnalysis.GetSchemaSerializable();
		if (xs.Contains(schemaSerializable.TargetNamespace))
