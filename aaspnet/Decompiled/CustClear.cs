...
public class CustClear : DataSet
{
	...
	public class DataTable1DataTable : TypedTableBase<DataTable1Row>
	{
		...
		private DataColumn columnClearQty;
		...
		[DebuggerNonUserCode]
		public DataColumn CCNoColumn => columnCCNo;
		...
		[DebuggerNonUserCode]
		public DataColumn ClearQtyColumn => columnClearQty;
		...
		[DebuggerNonUserCode]
		public DataTable1Row AddDataTable1Row(int Id, string WONo, string CCNo, string SysDate, string ItemCode, string Description, string UOM, double ChallanQty, double ClearQty, string SysTime, int CompId)
		{
			DataTable1Row dataTable1Row = (DataTable1Row)NewRow();
			object[] itemArray = new object[11]
			{
				Id, WONo, CCNo, SysDate, ItemCode, Description, UOM, ChallanQty, ClearQty, SysTime,
				CompId
			};
		...
		internal void InitVars()
		{
			...
			columnClearQty = base.Columns["ClearQty"];
		...
		private void InitClass()
		{
			...
			columnCCNo = new DataColumn("CCNo", typeof(string), null, MappingType.Element);
			base.Columns.Add(columnCCNo);
			...
			columnClearQty = new DataColumn("ClearQty", typeof(double), null, MappingType.Element);
			base.Columns.Add(columnClearQty);
		...
		public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
		{
			...
			CustClear custClear = new CustClear();
			...
			xmlSchemaAttribute.FixedValue = custClear.Namespace;
			...
			XmlSchema schemaSerializable = custClear.GetSchemaSerializable();
	...
	public class DataTable1Row : DataRow
	{
		...
		public string CCNo
		{
			get
			{
				try
				{
					return (string)base[tableDataTable1.CCNoColumn];
				}
				catch (InvalidCastException innerException)
				{
					throw new StrongTypingException("The value for column 'CCNo' in table 'DataTable1' is DBNull.", innerException);
				}
			}
			set
			{
				base[tableDataTable1.CCNoColumn] = value;
			}
		}
		...
		[DebuggerNonUserCode]
		public double ClearQty
		{
			get
			{
				try
				{
					return (double)base[tableDataTable1.ClearQtyColumn];
				}
				catch (InvalidCastException innerException)
				{
					throw new StrongTypingException("The value for column 'ClearQty' in table 'DataTable1' is DBNull.", innerException);
				}
			}
			set
			{
				base[tableDataTable1.ClearQtyColumn] = value;
			}
		}
		...
		[DebuggerNonUserCode]
		public bool IsCCNoNull()
		{
			return IsNull(tableDataTable1.CCNoColumn);
		}

		[DebuggerNonUserCode]
		public void SetCCNoNull()
		{
			base[tableDataTable1.CCNoColumn] = Convert.DBNull;
		}
		...
		[DebuggerNonUserCode]
		public bool IsClearQtyNull()
		{
			return IsNull(tableDataTable1.ClearQtyColumn);
		}

		[DebuggerNonUserCode]
		public void SetClearQtyNull()
		{
			base[tableDataTable1.ClearQtyColumn] = Convert.DBNull;
		}
	...
	[DebuggerNonUserCode]
	protected CustClear(SerializationInfo info, StreamingContext context)
	...
	{
		CustClear custClear = (CustClear)base.Clone();
		custClear.InitVars();
		custClear.SchemaSerializationMode = SchemaSerializationMode;
		return custClear;
	}
	...
	private void InitClass()
	{
		base.DataSetName = "CustClear";
		base.Prefix = "";
		base.Namespace = "http://tempuri.org/CustClear.xsd";
	...
	public static XmlSchemaComplexType GetTypedDataSetSchema(XmlSchemaSet xs)
	{
		...
		XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
		XmlSchemaAny xmlSchemaAny = new XmlSchemaAny();
		xmlSchemaAny.Namespace = custClear.Namespace;
		xmlSchemaSequence.Items.Add(xmlSchemaAny);
		xmlSchemaComplexType.Particle = xmlSchemaSequence;
		XmlSchema schemaSerializable = custClear.GetSchemaSerializable();
		if (xs.Contains(schemaSerializable.TargetNamespace))
