...
public class Module_Accounts_Transactions_TourVoucher_Edit : Page, IRequiresSessionState
{
	...
	protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		try
		{
			if (e.CommandName == "Sel")
			{
				...
				base.Response.Redirect("TourVoucher_Edit_Details.aspx?Id=" + num + "&TIMId=" + num2 + "&ModId=11&SubModId=126");
			}
		}
		catch (Exception)
		{
