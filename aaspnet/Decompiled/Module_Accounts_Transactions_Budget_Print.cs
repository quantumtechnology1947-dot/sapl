...
public class Module_Accounts_Transactions_Budget_Print : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		try
		{
			...
			string text6 = base.Server.MapPath("~/Module/MIS/Transactions/Reports/Budger_Labour_Print.rpt");
			report.Load(text6);
