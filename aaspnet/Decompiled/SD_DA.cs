...
public class SD_DA : DataSet
{
	...
	public class DataTable1DataTable : TypedTableBase<DataTable1Row>
	{
		...
		private DataColumn columnDAQty;

		private DataColumn columnWONo;

		private DataColumn columnDANo;
		...
		[DebuggerNonUserCode]
		public DataColumn DAQtyColumn => columnDAQty;

		[DebuggerNonUserCode]
		public DataColumn WONoColumn => columnWONo;

		[DebuggerNonUserCode]
		public DataColumn DANoColumn => columnDANo;
		...
		[DebuggerNonUserCode]
		public DataTable1Row AddDataTable1Row(int Id, string ItemCode, string Description, double Qty, double DAQty, string WONo, string DANo, int CompId)
		{
			DataTable1Row dataTable1Row = (DataTable1Row)NewRow();
			object[] itemArray = new object[8] { Id, ItemCode, Description, Qty, DAQty, WONo, DANo, CompId };
		...
		internal void InitVars()
		{
			...
			columnDAQty = base.Columns["DAQty"];
			columnWONo = base.Columns["WONo"];
			columnDANo = base.Columns["DANo"];
		...
		private void InitClass()
		{
			...
			columnDAQty = new DataColumn("DAQty", typeof(double), null, MappingType.Element);
			base.Columns.Add(columnDAQty);
			columnWONo = new DataColumn("WONo", typeof(string), null, MappingType.Element);
			base.Columns.Add(columnWONo);
			columnDANo = new DataColumn("DANo", typeof(string), null, MappingType.Element);
			base.Columns.Add(columnDANo);
		...
		public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
		{
			...
			xmlSchemaAttribute.FixedValue = sD_DA.Namespace;
			...
			XmlSchema schemaSerializable = sD_DA.GetSchemaSerializable();
	...
	public class DataTable1Row : DataRow
	{
		...
		public double DAQty
		{
			get
			{
				try
				{
					return (double)base[tableDataTable1.DAQtyColumn];
				}
				catch (InvalidCastException innerException)
				{
					throw new StrongTypingException("The value for column 'DAQty' in table 'DataTable1' is DBNull.", innerException);
				}
			}
			set
			{
				base[tableDataTable1.DAQtyColumn] = value;
			}
		}
		...
		public string DANo
		{
			get
			{
				try
				{
					return (string)base[tableDataTable1.DANoColumn];
				}
				catch (InvalidCastException innerException)
				{
					throw new StrongTypingException("The value for column 'DANo' in table 'DataTable1' is DBNull.", innerException);
				}
			}
			set
			{
				base[tableDataTable1.DANoColumn] = value;
			}
		}
		...
		[DebuggerNonUserCode]
		public bool IsDAQtyNull()
		{
			return IsNull(tableDataTable1.DAQtyColumn);
		}

		[DebuggerNonUserCode]
		public void SetDAQtyNull()
		{
			base[tableDataTable1.DAQtyColumn] = Convert.DBNull;
		}
		...
		{
			return IsNull(tableDataTable1.DANoColumn);
		}

		[DebuggerNonUserCode]
		public void SetDANoNull()
		{
			base[tableDataTable1.DANoColumn] = Convert.DBNull;
		}
	...
	[DebuggerNonUserCode]
	protected SD_DA(SerializationInfo info, StreamingContext context)
	...
	{
		SD_DA sD_DA = (SD_DA)base.Clone();
		sD_DA.InitVars();
		sD_DA.SchemaSerializationMode = SchemaSerializationMode;
		return sD_DA;
	}
	...
	private void InitClass()
	{
		base.DataSetName = "SD_DA";
		base.Prefix = "";
		base.Namespace = "http://tempuri.org/SD_DA.xsd";
	...
	public static XmlSchemaComplexType GetTypedDataSetSchema(XmlSchemaSet xs)
	{
		...
		XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
		XmlSchemaAny xmlSchemaAny = new XmlSchemaAny();
		xmlSchemaAny.Namespace = sD_DA.Namespace;
		xmlSchemaSequence.Items.Add(xmlSchemaAny);
		xmlSchemaComplexType.Particle = xmlSchemaSequence;
		XmlSchema schemaSerializable = sD_DA.GetSchemaSerializable();
		if (xs.Contains(schemaSerializable.TargetNamespace))
