...
public class Module_Accounts_Transactions_SalesInvoice_Edit : Page, IRequiresSessionState
{
	...
	protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		if (e.CommandName == "Sel")
		{
			try
			{
				...
				base.Response.Redirect("SalesInvoice_Edit_Details.aspx?InvNo=" + base.Server.UrlEncode(fun.Encrypt(text)) + "&invId=" + base.Server.UrlEncode(fun.Encrypt(text2)) + "&cid=" + base.Server.UrlEncode(fun.Encrypt(text3)) + "&ModId=11&SubModId=51");
			}
			catch (Exception)
			{
			}
