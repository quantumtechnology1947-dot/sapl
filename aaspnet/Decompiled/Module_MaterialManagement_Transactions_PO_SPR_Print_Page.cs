...
public class Module_MaterialManagement_Transactions_PO_SPR_Print_Page : Page, IRequiresSessionState
{
	...
	public void loaddata()
	{
		...
		if (dataSet3.Tables[0].Rows.Count > 0)
		{
			for (int i = 0; i < dataSet3.Tables[0].Rows.Count; i++)
			{
				...
				string cmdText3 = fun.select("RefDesc", "tblMM_PO_Reference", "Id='" + dataSet3.Tables[0].Rows[i]["Reference"].ToString() + "'");
				...
				dataRow[1] = dataSet3.Tables[0].Rows[i]["PONo"].ToString();
				dataRow[2] = dataSet3.Tables[0].Rows[i]["Qty"].ToString();
				dataRow[3] = dataSet3.Tables[0].Rows[i]["Rate"].ToString();
				dataRow[4] = dataSet3.Tables[0].Rows[i]["Discount"].ToString();
				dataRow[5] = fun.FromDateDMY(dataSet3.Tables[0].Rows[i]["DelDate"].ToString());
				dataRow[6] = dataSet3.Tables[0].Rows[i]["AmendmentNo"].ToString();
				dataRow[8] = dataSet3.Tables[0].Rows[i]["ModeOfDispatch"].ToString();
				dataRow[9] = dataSet3.Tables[0].Rows[i]["Inspection"].ToString();
				dataRow[10] = dataSet3.Tables[0].Rows[i]["ShipTo"].ToString();
				dataRow[11] = dataSet3.Tables[0].Rows[i]["Remarks"].ToString();
				string cmdText4 = fun.select("tblMM_SPR_Master.SessionId AS Indentor,tblMM_SPR_Details.SPRNo,tblMM_SPR_Details.WONo,tblMM_SPR_Details.DeptId,tblMM_SPR_Details.AHId,tblMM_SPR_Details.ItemId", "tblMM_SPR_Details,tblMM_SPR_Master", "tblMM_SPR_Details.Id='" + dataSet3.Tables[0].Rows[i]["SPRId"].ToString() + "' And tblMM_SPR_Master.Id=tblMM_SPR_Details.MId ");
				...
				{
					dataRow[12] = dataSet6.Tables[0].Rows[0]["SPRNo"].ToString();
					string cmdText5 = fun.select("Title+' '+EmployeeName as Name", "tblHR_OfficeStaff", "EmpId='" + dataSet6.Tables[0].Rows[0]["Indentor"].ToString() + "'And CompId='" + cId + "'");
					...
					dataRow[36] = dataSet7.Tables[0].Rows[0]["Name"].ToString() + "[" + dataSet6.Tables[0].Rows[0]["Indentor"].ToString() + "]";
					if (dataSet6.Tables[0].Rows[0]["WONo"] != DBNull.Value)
					{
						dataRow[13] = dataSet6.Tables[0].Rows[0]["WONo"].ToString();
						string cmdText6 = fun.select("*", "tblMIS_BudgetCode", "Id='" + dataSet3.Tables[0].Rows[i]["BudgetCode"].ToString() + "'");
						...
						{
							dataRow[37] = dataSet8.Tables[0].Rows[0]["Symbol"].ToString() + dataRow[13];
						}
						else
						{
							string cmdText7 = fun.select("Symbol", "BusinessGroup", "Id='" + dataSet6.Tables[0].Rows[0]["DeptId"].ToString() + "'");
							...
							{
								dataRow[37] = dataSet9.Tables[0].Rows[0]["Symbol"].ToString();
							}
						}
					}
					else
					...
					string cmdText8 = fun.select("Id,ItemCode,ManfDesc,UOMBasic", "tblDG_Item_Master", "Id='" + dataSet6.Tables[0].Rows[0]["ItemId"].ToString() + "'");
					...
					if (dataSet10.Tables[0].Rows.Count > 0)
					{
						...
						value3 = dataSet10.Tables[0].Rows[0]["ManfDesc"].ToString();
						...
						{
							value2 = dataSet11.Tables[0].Rows[0][0].ToString();
						}
					}
					string cmdText10 = fun.select("Symbol", "AccHead", "Id='" + dataSet6.Tables[0].Rows[0]["AHId"].ToString() + "'");
					...
					{
						dataRow[22] = dataSet12.Tables[0].Rows[0]["Symbol"].ToString();
					}
					if (dataSet6.Tables[0].Rows[0]["DeptId"] != DBNull.Value)
					{
						string cmdText11 = fun.select("Symbol", "BusinessGroup", "Id='" + dataSet6.Tables[0].Rows[0]["DeptId"].ToString() + "'");
						...
						{
							dataRow[34] = dataSet13.Tables[0].Rows[0]["Symbol"].ToString();
						}
					}
				}
				dataRow[14] = cId;
				...
				dataRow[20] = value3;
				dataRow[21] = value2;
				string cmdText12 = fun.select("SupplierId,SupplierName,ContactPerson,ContactNo,Email,RegdCountry", "tblMM_Supplier_master", "SupplierId='" + dataSet3.Tables[0].Rows[i]["SupplierId"].ToString() + "' AND CompId='" + cId + "'");
				...
				{
					Country = Convert.ToInt32(dataSet14.Tables[0].Rows[0]["RegdCountry"]);
					string cmdText13 = fun.select("Symbol", "tblCountry", "CId='" + dataSet14.Tables[0].Rows[0]["RegdCountry"].ToString() + "' ");
					...
					sqlDataAdapter14.Fill(dataSet15, "tblCountry");
					dataRow[40] = dataSet15.Tables[0].Rows[0]["Symbol"].ToString();
					dataRow[15] = dataSet14.Tables[0].Rows[0]["SupplierName"].ToString();
					dataRow[16] = dataSet14.Tables[0].Rows[0]["ContactPerson"].ToString();
					dataRow[18] = dataSet14.Tables[0].Rows[0]["ContactNo"].ToString();
					dataRow[17] = dataSet14.Tables[0].Rows[0]["Email"].ToString();
					dataRow[38] = dataSet14.Tables[0].Rows[0]["SupplierId"].ToString();
					dataRow[39] = dataSet3.Tables[0].Rows[i]["Insurance"].ToString();
				}
				string cmdText14 = fun.select("Terms,Value", "tblPacking_Master", "Id='" + Convert.ToInt32(dataSet3.Tables[0].Rows[i]["PF"]) + "'");
				...
				{
					dataRow[25] = dataSet16.Tables[0].Rows[0]["Terms"].ToString();
					dataRow[26] = Convert.ToDouble(dataSet16.Tables[0].Rows[0]["Value"]);
				}
				string cmdText15 = fun.select("Terms,Value", "tblVAT_Master", "Id='" + Convert.ToInt32(dataSet3.Tables[0].Rows[i]["VAT"]) + "'");
				...
				{
					dataRow[30] = dataSet17.Tables[0].Rows[0]["Terms"].ToString();
					dataRow[31] = Convert.ToDouble(dataSet17.Tables[0].Rows[0]["Value"]);
				}
				string cmdText16 = fun.select("Terms,Value", "tblExciseser_Master", "Id='" + Convert.ToInt32(dataSet3.Tables[0].Rows[i]["ExST"]) + "'");
				...
				{
					dataRow[28] = dataSet18.Tables[0].Rows[0]["Terms"].ToString();
					dataRow[29] = Convert.ToDouble(dataSet18.Tables[0].Rows[0]["Value"]);
				}
				string cmdText17 = fun.select("Terms,Value", "tblOctroi_Master", "Id='" + Convert.ToInt32(dataSet3.Tables[0].Rows[i]["Octroi"]) + "'");
				...
				{
					dataRow[23] = dataSet19.Tables[0].Rows[0]["Terms"].ToString();
					dataRow[24] = Convert.ToDouble(dataSet19.Tables[0].Rows[0]["Value"]);
				}
				string cmdText18 = fun.select("Terms", "tblPayment_Master", "Id='" + Convert.ToInt32(dataSet3.Tables[0].Rows[i]["PaymentTerms"]) + "'");
				...
				{
					dataRow[27] = dataSet20.Tables[0].Rows[0]["Terms"].ToString();
				}
				string cmdText19 = fun.select("Terms", "tblWarrenty_Master", "Id='" + Convert.ToInt32(dataSet3.Tables[0].Rows[i]["Warrenty"]) + "'");
				...
				{
					dataRow[32] = dataSet21.Tables[0].Rows[0]["Terms"].ToString();
				}
				string cmdText20 = fun.select("Terms", "tblFreight_Master", "Id='" + Convert.ToInt32(dataSet3.Tables[0].Rows[i]["Freight"]) + "'");
				...
				{
					dataRow[33] = dataSet22.Tables[0].Rows[0]["Terms"].ToString();
				}
				dataRow[35] = dataSet3.Tables[0].Rows[i]["ReferenceDesc"].ToString();
				if (num == 1)
				{
					string cmdText21 = fun.select("tblMM_PO_Amd_Details.PODId,tblMM_PO_Amd_Details.Qty,tblMM_PO_Amd_Details.Rate,tblMM_PO_Amd_Details.Discount,tblMM_PO_Amd_Details.DelDate,tblMM_PO_Amd_Details.PF,tblMM_PO_Amd_Details.ExST,tblMM_PO_Amd_Details.VAT,tblMM_PO_Amd_Details.SPRId,tblMM_PO_Amd_Details.BudgetCode,tblMM_PO_Amd_Details.AddDesc", "tblMM_PO_Amd_Details", "tblMM_PO_Amd_Details.MId='" + dataSet.Tables[0].Rows[0]["Id"].ToString() + "' AND tblMM_PO_Amd_Details.PODId='" + dataSet3.Tables[0].Rows[i]["PODId"].ToString() + "'");
					...
					sqlDataAdapter22.Fill(dataSet23);
					if (dataSet23.Tables[0].Rows.Count > 0)
					{
						if (dataSet3.Tables[0].Rows[i]["SupplierId"].ToString() == dataSet.Tables[0].Rows[0]["SupplierId"].ToString())
						{
							dataRow[41] = "";
						}
						else
						...
						if (dataSet3.Tables[0].Rows[i]["ReferenceDate"].ToString() == dataSet.Tables[0].Rows[0]["ReferenceDate"].ToString())
						{
							dataRow[43] = "";
						}
						else
						...
						if (dataSet3.Tables[0].Rows[i]["Reference"].ToString() == dataSet.Tables[0].Rows[0]["Reference"].ToString())
						{
							dataRow[44] = "";
						}
						else
						...
						if (dataSet3.Tables[0].Rows[i]["ReferenceDesc"].ToString() == dataSet.Tables[0].Rows[0]["ReferenceDesc"].ToString())
						{
							dataRow[45] = "";
						}
						else
						...
						if (dataSet3.Tables[0].Rows[i]["Rate"].ToString() == dataSet23.Tables[0].Rows[0]["Rate"].ToString())
						{
							dataRow[46] = "";
						}
						else
						...
						if (dataSet3.Tables[0].Rows[i]["Discount"].ToString() == dataSet23.Tables[0].Rows[0]["Discount"].ToString())
						{
							dataRow[47] = "";
						}
						else
						...
						if (dataSet3.Tables[0].Rows[i]["PF"].ToString() == dataSet23.Tables[0].Rows[0]["PF"].ToString())
						{
							dataRow[48] = "";
						}
						else
						...
						if (dataSet3.Tables[0].Rows[i]["ExST"].ToString() == dataSet23.Tables[0].Rows[0]["ExST"].ToString())
						{
							dataRow[49] = "";
						}
						else
						...
						if (dataSet3.Tables[0].Rows[i]["VAT"].ToString() == dataSet23.Tables[0].Rows[0]["VAT"].ToString())
						{
							dataRow[50] = "";
						}
						else
						...
						if (dataSet3.Tables[0].Rows[i]["DelDate"].ToString() == dataSet23.Tables[0].Rows[0]["DelDate"].ToString())
						{
							dataRow[51] = "";
						}
						else
						...
						if (dataSet3.Tables[0].Rows[i]["PaymentTerms"].ToString() == dataSet.Tables[0].Rows[0]["PaymentTerms"].ToString())
						{
							dataRow[52] = "";
						}
						else
						...
						if (dataSet3.Tables[0].Rows[i]["ModeOfDispatch"].ToString() == dataSet.Tables[0].Rows[0]["ModeOfDispatch"].ToString())
						{
							dataRow[53] = "";
						}
						else
						...
						if (dataSet3.Tables[0].Rows[i]["Inspection"].ToString() == dataSet.Tables[0].Rows[0]["Inspection"].ToString())
						{
							dataRow[54] = "";
						}
						else
						...
						if (dataSet3.Tables[0].Rows[i]["Octroi"].ToString() == dataSet.Tables[0].Rows[0]["Octroi"].ToString())
						{
							dataRow[55] = "";
						}
						else
						...
						if (dataSet3.Tables[0].Rows[i]["Warrenty"].ToString() == dataSet.Tables[0].Rows[0]["Warrenty"].ToString())
						{
							dataRow[56] = "";
						}
						else
						...
						if (dataSet3.Tables[0].Rows[i]["Freight"].ToString() == dataSet.Tables[0].Rows[0]["Freight"].ToString())
						{
							dataRow[57] = "";
						}
						else
						...
						if (dataSet3.Tables[0].Rows[i]["Insurance"].ToString() == dataSet.Tables[0].Rows[0]["Insurance"].ToString())
						{
							dataRow[58] = "";
						}
						else
						...
						if (dataSet3.Tables[0].Rows[i]["ShipTo"].ToString() == dataSet.Tables[0].Rows[0]["ShipTo"].ToString())
						{
							dataRow[59] = "";
						}
						else
						...
						if (dataSet3.Tables[0].Rows[i]["Remarks"].ToString() == dataSet.Tables[0].Rows[0]["Remarks"].ToString())
						{
							dataRow[60] = "";
						}
						else
						...
						if (dataSet3.Tables[0].Rows[i]["BudgetCode"].ToString() == dataSet23.Tables[0].Rows[0]["BudgetCode"].ToString())
						{
							dataRow[61] = "";
						}
						else
						...
						if (dataSet3.Tables[0].Rows[i]["AddDesc"].ToString() == dataSet23.Tables[0].Rows[0]["AddDesc"].ToString())
						{
							dataRow[63] = "";
						}
						else
						...
						if (dataSet3.Tables[0].Rows[i]["Qty"].ToString() == dataSet23.Tables[0].Rows[0]["Qty"].ToString())
						{
							dataRow[64] = "";
						}
						else
						...
						if (dataSet3.Tables[0].Rows[i]["TC"].ToString() == dataSet.Tables[0].Rows[0]["TC"].ToString())
						{
							dataRow[65] = "";
						}
						else
				...
				if (dataSet3.Tables[0].Rows[i]["AddDesc"] != DBNull.Value && dataSet3.Tables[0].Rows[i]["AddDesc"].ToString() != "")
				{
					dataRow[62] = dataSet3.Tables[0].Rows[i]["AddDesc"].ToString();
				}
				else
				{
					dataRow[62] = "";
			...
			DataSet dataSet24 = new POSPR();
			dataSet24.Tables[0].Merge(dataSet4.Tables[0]);
			dataSet24.AcceptChanges();
			report = new ReportDocument();
			if (Country == 1)
			{
				report.Load(base.Server.MapPath("~/Module/MaterialManagement/Transactions/Reports/PO_SPR.rpt"));
			}
			else
			{
				report.Load(base.Server.MapPath("~/Module/MaterialManagement/Transactions/Reports/PO_SPR_Import.rpt"));
			}
			report.SetDataSource(dataSet24);
			string cmdText22 = fun.select("SupplierName,RegdAddress,RegdCountry,RegdState,RegdCity,RegdPinNo", "tblMM_Supplier_master", "SupplierId='" + SupCode + "' And CompId='" + cId + "'");
			...
			sqlDataAdapter23.Fill(dataSet25, "tblMM_Supplier_master");
			string cmdText23 = fun.select("CountryName", "tblcountry", string.Concat("CId='", dataSet25.Tables[0].Rows[0]["RegdCountry"], "'"));
			string cmdText24 = fun.select("StateName", "tblState", string.Concat("SId='", dataSet25.Tables[0].Rows[0]["RegdState"], "'"));
			string cmdText25 = fun.select("CityName", "tblCity", string.Concat("CityId='", dataSet25.Tables[0].Rows[0]["RegdCity"], "'"));
			...
			sqlDataAdapter24.Fill(dataSet26, "tblCountry");
			sqlDataAdapter25.Fill(dataSet27, "tblState");
			sqlDataAdapter26.Fill(dataSet28, "tblcity");
			string text2 = dataSet25.Tables[0].Rows[0]["RegdAddress"].ToString() + "," + dataSet28.Tables[0].Rows[0]["CityName"].ToString() + "," + dataSet27.Tables[0].Rows[0]["StateName"].ToString() + "," + dataSet26.Tables[0].Rows[0]["CountryName"].ToString() + "." + dataSet25.Tables[0].Rows[0]["RegdPinNo"].ToString() + ".";
			report.SetParameterValue("SupplierAddress", (object)text2);
			string fD = dataSet3.Tables[0].Rows[0]["SysDate"].ToString();
			string text3 = fun.FromDateDMY(fD);
			report.SetParameterValue("RegDate", (object)text3);
			string fD2 = dataSet3.Tables[0].Rows[0]["ReferenceDate"].ToString();
			string text4 = fun.FromDateDMY(fD2);
			report.SetParameterValue("RefDate", (object)text4);
			string text5 = dataSet3.Tables[0].Rows[0]["CheckedBy"].ToString();
			string text6 = dataSet3.Tables[0].Rows[0]["ApprovedBy"].ToString();
			string text7 = dataSet3.Tables[0].Rows[0]["AuthorizedBy"].ToString();
			string text8 = "";
			if (dataSet3.Tables[0].Rows[0]["CheckedBy"] != DBNull.Value && dataSet3.Tables[0].Rows[0]["CheckedBy"] != "")
			{
				string cmdText26 = fun.select("Title,EmployeeName", "tblHR_OfficeStaff", "EmpId='" + text5 + "'And CompId='" + cId + "'");
				...
				text8 = dataSet29.Tables[0].Rows[0]["Title"].ToString() + ". " + dataSet29.Tables[0].Rows[0]["EmployeeName"].ToString();
			}
			else
			{
				text8 = " ";
			...
			string text9 = "";
			if (dataSet3.Tables[0].Rows[0]["ApprovedBy"] != DBNull.Value && dataSet3.Tables[0].Rows[0]["ApprovedBy"] != "")
			{
				string cmdText27 = fun.select("Title,EmployeeName", "tblHR_OfficeStaff", "EmpId='" + text6 + "'And CompId='" + cId + "'");
				SqlCommand selectCommand28 = new SqlCommand(cmdText27, sqlConnection);
				SqlDataAdapter sqlDataAdapter28 = new SqlDataAdapter(selectCommand28);
				DataSet dataSet30 = new DataSet();
				sqlDataAdapter28.Fill(dataSet30, "tblHR_OfficeStaff");
				text9 = dataSet30.Tables[0].Rows[0]["Title"].ToString() + ". " + dataSet30.Tables[0].Rows[0]["EmployeeName"].ToString();
			}
			else
			{
				text9 = " ";
			...
			string text10 = "";
			if (dataSet3.Tables[0].Rows[0]["AuthorizedBy"] != DBNull.Value && dataSet3.Tables[0].Rows[0]["AuthorizedBy"] != "")
			{
				string cmdText28 = fun.select("Title,EmployeeName", "tblHR_OfficeStaff", "EmpId='" + text7 + "'And CompId='" + cId + "'");
				SqlCommand selectCommand29 = new SqlCommand(cmdText28, sqlConnection);
				SqlDataAdapter sqlDataAdapter29 = new SqlDataAdapter(selectCommand29);
				DataSet dataSet31 = new DataSet();
				sqlDataAdapter29.Fill(dataSet31, "tblHR_OfficeStaff");
				text10 = dataSet31.Tables[0].Rows[0]["Title"].ToString() + ". " + dataSet31.Tables[0].Rows[0]["EmployeeName"].ToString();
			}
			else
			{
				text10 = " ";
			...
			string text11 = "";
			if (dataSet3.Tables[0].Rows[0]["CheckedDate"] != DBNull.Value)
			{
				string fD3 = dataSet3.Tables[0].Rows[0]["CheckedDate"].ToString();
			...
			string text12 = "";
			if (dataSet3.Tables[0].Rows[0]["ApproveDate"] != DBNull.Value)
			{
				string fD4 = dataSet3.Tables[0].Rows[0]["ApproveDate"].ToString();
			...
			string text13 = "";
			if (dataSet3.Tables[0].Rows[0]["AuthorizeDate"] != DBNull.Value)
			{
				string fD5 = dataSet3.Tables[0].Rows[0]["AuthorizeDate"].ToString();
			...
			report.SetParameterValue("Address2", (object)text14);
			StringBuilder stringBuilder = new StringBuilder();
			string text15 = "";
			if (dataSet3.Tables[0].Rows[0]["TC"] != DBNull.Value)
			{
				stringBuilder.AppendLine(dataSet3.Tables[0].Rows[0]["TC"].ToString());
