...
[XmlRoot("CashVoucher_Receipt")]
[HelpKeyword("vs.data.DataSet")]
[ToolboxItem(true)]
[XmlSchemaProvider("GetTypedDataSetSchema")]
public class CashVoucher_Receipt : DataSet
{
	...
	public class DataTable1DataTable : TypedTableBase<DataTable1Row>
	{
		...
		private DataColumn columnCVRNo;

		private DataColumn columnCashReceivedAgainst;

		private DataColumn columnCashReceivedBy;
		...
		[DebuggerNonUserCode]
		public DataColumn CVRNoColumn => columnCVRNo;

		[DebuggerNonUserCode]
		public DataColumn CashReceivedAgainstColumn => columnCashReceivedAgainst;

		[DebuggerNonUserCode]
		public DataColumn CashReceivedByColumn => columnCashReceivedBy;
		...
		[DebuggerNonUserCode]
		public DataTable1Row AddDataTable1Row(int Id, string Date, string CVRNo, string CashReceivedAgainst, string CashReceivedBy, string WONo, string BGGroup, string AcHead, string BudgetCode, double Amount, string Remarks, int CompId)
		{
			DataTable1Row dataTable1Row = (DataTable1Row)NewRow();
			object[] itemArray = new object[12]
			{
				Id, Date, CVRNo, CashReceivedAgainst, CashReceivedBy, WONo, BGGroup, AcHead, BudgetCode, Amount,
				Remarks, CompId
			};
		...
		internal void InitVars()
		{
			...
			columnCVRNo = base.Columns["CVRNo"];
			columnCashReceivedAgainst = base.Columns["CashReceivedAgainst"];
			columnCashReceivedBy = base.Columns["CashReceivedBy"];
		...
		private void InitClass()
		{
			...
			columnCVRNo = new DataColumn("CVRNo", typeof(string), null, MappingType.Element);
			base.Columns.Add(columnCVRNo);
			columnCashReceivedAgainst = new DataColumn("CashReceivedAgainst", typeof(string), null, MappingType.Element);
			base.Columns.Add(columnCashReceivedAgainst);
			columnCashReceivedBy = new DataColumn("CashReceivedBy", typeof(string), null, MappingType.Element);
			base.Columns.Add(columnCashReceivedBy);
		...
		public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
		{
			...
			CashVoucher_Receipt cashVoucher_Receipt = new CashVoucher_Receipt();
			...
			xmlSchemaAttribute.FixedValue = cashVoucher_Receipt.Namespace;
			...
			XmlSchema schemaSerializable = cashVoucher_Receipt.GetSchemaSerializable();
	...
	public class DataTable1Row : DataRow
	{
		...
		public string CVRNo
		{
			get
			{
				try
				{
					return (string)base[tableDataTable1.CVRNoColumn];
				}
				catch (InvalidCastException innerException)
				{
					throw new StrongTypingException("The value for column 'CVRNo' in table 'DataTable1' is DBNull.", innerException);
				}
			}
			set
			{
				base[tableDataTable1.CVRNoColumn] = value;
			}
		}

		[DebuggerNonUserCode]
		public string CashReceivedAgainst
		{
			get
			{
				try
				{
					return (string)base[tableDataTable1.CashReceivedAgainstColumn];
				}
				catch (InvalidCastException innerException)
				{
					throw new StrongTypingException("The value for column 'CashReceivedAgainst' in table 'DataTable1' is DBNull.", innerException);
				}
			}
			set
			{
				base[tableDataTable1.CashReceivedAgainstColumn] = value;
			}
		}
		...
		public string CashReceivedBy
		{
			get
			{
				try
				{
					return (string)base[tableDataTable1.CashReceivedByColumn];
				}
				catch (InvalidCastException innerException)
				{
					throw new StrongTypingException("The value for column 'CashReceivedBy' in table 'DataTable1' is DBNull.", innerException);
				}
			}
			set
			{
				base[tableDataTable1.CashReceivedByColumn] = value;
			}
		}
		...
		[DebuggerNonUserCode]
		public bool IsCVRNoNull()
		{
			return IsNull(tableDataTable1.CVRNoColumn);
		}

		[DebuggerNonUserCode]
		public void SetCVRNoNull()
		{
			base[tableDataTable1.CVRNoColumn] = Convert.DBNull;
		}

		[DebuggerNonUserCode]
		public bool IsCashReceivedAgainstNull()
		{
			return IsNull(tableDataTable1.CashReceivedAgainstColumn);
		}

		[DebuggerNonUserCode]
		public void SetCashReceivedAgainstNull()
		{
			base[tableDataTable1.CashReceivedAgainstColumn] = Convert.DBNull;
		}

		[DebuggerNonUserCode]
		public bool IsCashReceivedByNull()
		{
			return IsNull(tableDataTable1.CashReceivedByColumn);
		}

		[DebuggerNonUserCode]
		public void SetCashReceivedByNull()
		{
			base[tableDataTable1.CashReceivedByColumn] = Convert.DBNull;
		}
	...
	[DebuggerNonUserCode]
	protected CashVoucher_Receipt(SerializationInfo info, StreamingContext context)
	...
	{
		CashVoucher_Receipt cashVoucher_Receipt = (CashVoucher_Receipt)base.Clone();
		cashVoucher_Receipt.InitVars();
		cashVoucher_Receipt.SchemaSerializationMode = SchemaSerializationMode;
		return cashVoucher_Receipt;
	}
	...
	private void InitClass()
	{
		base.DataSetName = "CashVoucher_Receipt";
		base.Prefix = "";
		base.Namespace = "http://tempuri.org/CashVoucher_Receipt.xsd";
	...
	public static XmlSchemaComplexType GetTypedDataSetSchema(XmlSchemaSet xs)
	{
		...
		XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
		XmlSchemaAny xmlSchemaAny = new XmlSchemaAny();
		xmlSchemaAny.Namespace = cashVoucher_Receipt.Namespace;
		xmlSchemaSequence.Items.Add(xmlSchemaAny);
		xmlSchemaComplexType.Particle = xmlSchemaSequence;
		XmlSchema schemaSerializable = cashVoucher_Receipt.GetSchemaSerializable();
		if (xs.Contains(schemaSerializable.TargetNamespace))
