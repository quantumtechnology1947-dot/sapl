...
public class GSN : DataSet
{
	...
	public class DataTable1DataTable : TypedTableBase<DataTable1Row>
	{
		...
		[DebuggerNonUserCode]
		public DataTable1Row AddDataTable1Row(int Id, string ItemCode, string Description, string UOM, double POQty, double InvQty, double RecedQty, int CompId)
		{
			DataTable1Row dataTable1Row = (DataTable1Row)NewRow();
			object[] itemArray = new object[8] { Id, ItemCode, Description, UOM, POQty, InvQty, RecedQty, CompId };
		...
		public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
		{
			...
			xmlSchemaAttribute.FixedValue = gSN.Namespace;
			...
			XmlSchema schemaSerializable = gSN.GetSchemaSerializable();
	...
	[DebuggerNonUserCode]
	protected GSN(SerializationInfo info, StreamingContext context)
	...
	{
		GSN gSN = (GSN)base.Clone();
		gSN.InitVars();
		gSN.SchemaSerializationMode = SchemaSerializationMode;
		return gSN;
	}
	...
	private void InitClass()
	{
		base.DataSetName = "GSN";
		base.Prefix = "";
		base.Namespace = "http://tempuri.org/GSN.xsd";
	...
	public static XmlSchemaComplexType GetTypedDataSetSchema(XmlSchemaSet xs)
	{
		...
		XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
		XmlSchemaAny xmlSchemaAny = new XmlSchemaAny();
		xmlSchemaAny.Namespace = gSN.Namespace;
		xmlSchemaSequence.Items.Add(xmlSchemaAny);
		xmlSchemaComplexType.Particle = xmlSchemaSequence;
		XmlSchema schemaSerializable = gSN.GetSchemaSerializable();
		if (xs.Contains(schemaSerializable.TargetNamespace))
