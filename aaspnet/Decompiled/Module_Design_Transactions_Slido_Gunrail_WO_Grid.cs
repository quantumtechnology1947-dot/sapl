...
public class Module_Design_Transactions_Slido_Gunrail_WO_Grid : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		try
		{
			...
			string cmdText2 = fun.delete("tblDG_Gunrail_CrossRail_Temp", "CompId='" + CompId + "' AND SessionId='" + sId + "'");
			SqlCommand sqlCommand = new SqlCommand(cmdText2, sqlConnection);
			sqlConnection.Open();
			sqlCommand.ExecuteNonQuery();
			sqlConnection.Close();
			string cmdText3 = fun.delete("tblDG_Gunrail_LongRail_Temp", "CompId='" + CompId + "' AND SessionId='" + sId + "'");
