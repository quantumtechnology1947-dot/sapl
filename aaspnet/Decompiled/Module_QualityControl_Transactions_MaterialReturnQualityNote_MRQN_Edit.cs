...
public class Module_QualityControl_Transactions_MaterialReturnQualityNote_MRQN_Edit : Page, IRequiresSessionState
{
	...
	protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		try
		{
			...
			{
				base.Response.Redirect("MaterialReturnQualityNote_MRQN_Edit_Details.aspx?Id=" + text + "&MRNNo=" + MrnNo + "&FYId=" + FyId + "&MRQNNo=" + MrqNo + "&ModId=10&SubModId=49");
			}
		}
		catch (Exception)
		{
