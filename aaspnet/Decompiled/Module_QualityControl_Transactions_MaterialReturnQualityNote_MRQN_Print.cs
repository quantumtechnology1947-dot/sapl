...
public class Module_QualityControl_Transactions_MaterialReturnQualityNote_MRQN_Print : Page, IRequiresSessionState
{
	...
	protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		try
		{
			...
			if (e.CommandName == "Sel")
			{
				...
				base.Response.Redirect("MaterialReturnQualityNote_MRQN_Print_Details.aspx?Id=" + text + "&ModId=10&SubModId=49&MRNNo=" + MrnNo + "&FYId=" + FyId + "&MRQNNo=" + MrqNo + "&Key=" + randomAlphaNumeric);
			}
		}
		catch (Exception)
		{
