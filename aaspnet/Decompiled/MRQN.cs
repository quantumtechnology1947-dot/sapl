...
public class MRQN : DataSet
{
	...
	public class DataTable1DataTable : TypedTableBase<DataTable1Row>
	{
		...
		[DebuggerNonUserCode]
		public DataTable1Row AddDataTable1Row(int Id, string ItemCode, string Description, string UOM, string Symbol, string WONo, double AcceptedQty, double RetQty, string Remarks, int CompId)
		{
			DataTable1Row dataTable1Row = (DataTable1Row)NewRow();
			object[] itemArray = new object[10] { Id, ItemCode, Description, UOM, Symbol, WONo, AcceptedQty, RetQty, Remarks, CompId };
		...
		public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
		{
			...
			xmlSchemaAttribute.FixedValue = mRQN.Namespace;
			...
			XmlSchema schemaSerializable = mRQN.GetSchemaSerializable();
	...
	[DebuggerNonUserCode]
	protected MRQN(SerializationInfo info, StreamingContext context)
	...
	{
		MRQN mRQN = (MRQN)base.Clone();
		mRQN.InitVars();
		mRQN.SchemaSerializationMode = SchemaSerializationMode;
		return mRQN;
	}
	...
	private void InitClass()
	{
		base.DataSetName = "MRQN";
		base.Prefix = "";
		base.Namespace = "http://tempuri.org/MRQN.xsd";
	...
	public static XmlSchemaComplexType GetTypedDataSetSchema(XmlSchemaSet xs)
	{
		...
		XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
		XmlSchemaAny xmlSchemaAny = new XmlSchemaAny();
		xmlSchemaAny.Namespace = mRQN.Namespace;
		xmlSchemaSequence.Items.Add(xmlSchemaAny);
		xmlSchemaComplexType.Particle = xmlSchemaSequence;
		XmlSchema schemaSerializable = mRQN.GetSchemaSerializable();
		if (xs.Contains(schemaSerializable.TargetNamespace))
