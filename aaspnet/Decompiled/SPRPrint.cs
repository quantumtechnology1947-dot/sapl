...
public class SPRPrint : DataSet
{
	...
	public class DataTable1DataTable : TypedTableBase<DataTable1Row>
	{
		...
		[DebuggerNonUserCode]
		public DataTable1Row AddDataTable1Row(string ItemCode, string PurchDesc, string UomPurch, string DelDate, double SPRQTY, double Rate, string WONo, string SupplierName, string DeptName, string AcHead, string Remarks, int CompId, string Intender, double Discount)
		{
			DataTable1Row dataTable1Row = (DataTable1Row)NewRow();
			object[] itemArray = new object[14]
			{
				ItemCode, PurchDesc, UomPurch, DelDate, SPRQTY, Rate, WONo, SupplierName, DeptName, AcHead,
				Remarks, CompId, Intender, Discount
			};
		...
		public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
		{
			...
			SPRPrint sPRPrint = new SPRPrint();
			...
			xmlSchemaAttribute.FixedValue = sPRPrint.Namespace;
			...
			XmlSchema schemaSerializable = sPRPrint.GetSchemaSerializable();
	...
	[DebuggerNonUserCode]
	protected SPRPrint(SerializationInfo info, StreamingContext context)
	...
	{
		SPRPrint sPRPrint = (SPRPrint)base.Clone();
		sPRPrint.InitVars();
		sPRPrint.SchemaSerializationMode = SchemaSerializationMode;
		return sPRPrint;
	}
	...
	private void InitClass()
	{
		base.DataSetName = "SPRPrint";
		base.Prefix = "";
		base.Namespace = "http://tempuri.org/SPRPrint.xsd";
	...
	public static XmlSchemaComplexType GetTypedDataSetSchema(XmlSchemaSet xs)
	{
		...
		XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
		XmlSchemaAny xmlSchemaAny = new XmlSchemaAny();
		xmlSchemaAny.Namespace = sPRPrint.Namespace;
		xmlSchemaSequence.Items.Add(xmlSchemaAny);
		xmlSchemaComplexType.Particle = xmlSchemaSequence;
		XmlSchema schemaSerializable = sPRPrint.GetSchemaSerializable();
		if (xs.Contains(schemaSerializable.TargetNamespace))
