...
public class Module_Machinery_Transactions_Schedule_Output_Delete : Page, IRequiresSessionState
{
	...
	protected void SearchGridView1_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		try
		{
			if (e.CommandName == "Sel")
			{
				...
				base.Response.Redirect("schedule_Output_Delete_Details.aspx?id=" + text + "&wono=" + text2 + "&ModId=15&SubModId=70");
			}
		}
		catch (Exception)
		{
