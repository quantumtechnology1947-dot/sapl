...
public class Module_HR_TourIntimation_Print : Page, IRequiresSessionState
{
	...
	protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		try
		{
			if (e.CommandName == "Sel")
			{
				...
				base.Response.Redirect("TourIntimation_Print_Details.aspx?Id=" + num + "&Key=" + randomAlphaNumeric + "&ModId=12&SubModId=124");
			}
		}
		catch (Exception)
		{
