...
public class Module_Inventory_Transactions_GoodsQualityNote_GQN_Edit : Page, IRequiresSessionState
{
	...
	protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		try
		{
			if (e.CommandName == "Sel")
			{
				...
				base.Response.Redirect("GoodsQualityNote_GQN_Edit_Details.aspx?Id=" + text7 + "&SUPId=" + text + "&GQNNo=" + text2 + "&GRRNo=" + text3 + "&GINNo=" + text4 + "&PONo=" + text5 + "&FyId=" + text6 + "&ModId=10&SubModId=46");
			}
		}
		catch (Exception)
		{
