...
[XmlRoot("Challan_Clear")]
[ToolboxItem(true)]
public class Challan_Clear : DataSet
{
	...
	public class DataTable1DataTable : TypedTableBase<DataTable1Row>
	{
		...
		private DataColumn columnPRDate;
		...
		private DataColumn columnClearedQty;
		...
		[DebuggerNonUserCode]
		public DataColumn PRDateColumn => columnPRDate;
		...
		[DebuggerNonUserCode]
		public DataColumn ClearedQtyColumn => columnClearedQty;
		...
		[DebuggerNonUserCode]
		public DataTable1Row AddDataTable1Row(int Id, string PRNo, string WONo, string SCNo, string PRDate, string ItemCode, string Descr, string Symbol, double ClearedQty, double ChallanQty, int CompId, string SysTime)
		{
			DataTable1Row dataTable1Row = (DataTable1Row)NewRow();
			object[] itemArray = new object[12]
			{
				Id, PRNo, WONo, SCNo, PRDate, ItemCode, Descr, Symbol, ClearedQty, ChallanQty,
				CompId, SysTime
			};
		...
		private void InitClass()
		{
			...
			columnPRDate = new DataColumn("PRDate", typeof(string), null, MappingType.Element);
			base.Columns.Add(columnPRDate);
			...
			columnClearedQty = new DataColumn("ClearedQty", typeof(double), null, MappingType.Element);
			base.Columns.Add(columnClearedQty);
			...
			columnPRDate.Caption = "SCDate";
			columnDescr.Caption = "ManfDesc";
			columnClearedQty.Caption = "PRQty";
		}
		...
		public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
		{
			...
			Challan_Clear challan_Clear = new Challan_Clear();
			...
			xmlSchemaAttribute.FixedValue = challan_Clear.Namespace;
			...
			XmlSchema schemaSerializable = challan_Clear.GetSchemaSerializable();
	...
	public class DataTable1Row : DataRow
	{
		...
		public string PRDate
		{
			get
			{
				try
				{
					return (string)base[tableDataTable1.PRDateColumn];
				}
				catch (InvalidCastException innerException)
				{
					throw new StrongTypingException("The value for column 'PRDate' in table 'DataTable1' is DBNull.", innerException);
				}
			}
			set
			{
				base[tableDataTable1.PRDateColumn] = value;
			}
		}
		...
		[DebuggerNonUserCode]
		public double ClearedQty
		{
			get
			{
				try
				{
					return (double)base[tableDataTable1.ClearedQtyColumn];
				}
				catch (InvalidCastException innerException)
				{
					throw new StrongTypingException("The value for column 'ClearedQty' in table 'DataTable1' is DBNull.", innerException);
				}
			}
			set
			{
				base[tableDataTable1.ClearedQtyColumn] = value;
			}
		}
		...
		{
			return IsNull(tableDataTable1.PRDateColumn);
		}

		[DebuggerNonUserCode]
		public void SetPRDateNull()
		{
			base[tableDataTable1.PRDateColumn] = Convert.DBNull;
		}
		...
		[DebuggerNonUserCode]
		public bool IsClearedQtyNull()
		{
			return IsNull(tableDataTable1.ClearedQtyColumn);
		}

		[DebuggerNonUserCode]
		public void SetClearedQtyNull()
		{
			base[tableDataTable1.ClearedQtyColumn] = Convert.DBNull;
		}
	...
	[DebuggerNonUserCode]
	protected Challan_Clear(SerializationInfo info, StreamingContext context)
	...
	{
		Challan_Clear challan_Clear = (Challan_Clear)base.Clone();
		challan_Clear.InitVars();
		challan_Clear.SchemaSerializationMode = SchemaSerializationMode;
		return challan_Clear;
	}
	...
	private void InitClass()
	{
		base.DataSetName = "Challan_Clear";
		base.Prefix = "";
		base.Namespace = "http://tempuri.org/Challan_Clear.xsd";
	...
	public static XmlSchemaComplexType GetTypedDataSetSchema(XmlSchemaSet xs)
	{
		...
		XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
		XmlSchemaAny xmlSchemaAny = new XmlSchemaAny();
		xmlSchemaAny.Namespace = challan_Clear.Namespace;
		xmlSchemaSequence.Items.Add(xmlSchemaAny);
		xmlSchemaComplexType.Particle = xmlSchemaSequence;
		XmlSchema schemaSerializable = challan_Clear.GetSchemaSerializable();
		if (xs.Contains(schemaSerializable.TargetNamespace))
