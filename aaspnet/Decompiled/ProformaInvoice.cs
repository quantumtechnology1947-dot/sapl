...
[ToolboxItem(true)]
[XmlRoot("ProformaInvoice")]
[DesignerCategory("code")]
[XmlSchemaProvider("GetTypedDataSetSchema")]
public class ProformaInvoice : DataSet
{
	...
	public class DataTable1DataTable : TypedTableBase<DataTable1Row>
	{
		...
		[DebuggerNonUserCode]
		public DataTable1Row AddDataTable1Row(int Id, string SysDate, int CompId, string InvoiceNo, string PONo, string WONo, string InvoiceMode, string DateOfIssueInvoice, string TimeOfIssueInvoice, string CustomerCode, string Buyer_name, string Buyer_cotper, string Buyer_ph, string Buyer_email, string Buyer_ecc, string Buyer_tin, string Buyer_mob, string Buyer_fax, string Buyer_vat, string Cong_name, string Cong_cotper, string Cong_ph, string Cong_email, string Cong_ecc, string Cong_tin, string Cong_mob, string Cong_fax, string Cong_vat, int AddType, double AddAmt, int DeductionType, double Deduction, string PODate, int POId)
		{
			DataTable1Row dataTable1Row = (DataTable1Row)NewRow();
			object[] itemArray = new object[34]
			{
				Id, SysDate, CompId, InvoiceNo, PONo, WONo, InvoiceMode, DateOfIssueInvoice, TimeOfIssueInvoice, CustomerCode,
				Buyer_name, Buyer_cotper, Buyer_ph, Buyer_email, Buyer_ecc, Buyer_tin, Buyer_mob, Buyer_fax, Buyer_vat, Cong_name,
				Cong_cotper, Cong_ph, Cong_email, Cong_ecc, Cong_tin, Cong_mob, Cong_fax, Cong_vat, AddType, AddAmt,
				DeductionType, Deduction, PODate, POId
			};
		...
		public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
		{
			...
			xmlSchemaAttribute.FixedValue = proformaInvoice.Namespace;
			...
			XmlSchema schemaSerializable = proformaInvoice.GetSchemaSerializable();
	...
	[DebuggerNonUserCode]
	protected ProformaInvoice(SerializationInfo info, StreamingContext context)
	...
	{
		ProformaInvoice proformaInvoice = (ProformaInvoice)base.Clone();
		proformaInvoice.InitVars();
		proformaInvoice.SchemaSerializationMode = SchemaSerializationMode;
	...
	private void InitClass()
	{
		base.DataSetName = "ProformaInvoice";
		base.Prefix = "";
		base.Namespace = "http://tempuri.org/ProformaInvoice.xsd";
	...
	public static XmlSchemaComplexType GetTypedDataSetSchema(XmlSchemaSet xs)
	{
		...
		XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
		XmlSchemaAny xmlSchemaAny = new XmlSchemaAny();
		xmlSchemaAny.Namespace = proformaInvoice.Namespace;
		xmlSchemaSequence.Items.Add(xmlSchemaAny);
		xmlSchemaComplexType.Particle = xmlSchemaSequence;
		XmlSchema schemaSerializable = proformaInvoice.GetSchemaSerializable();
		if (xs.Contains(schemaSerializable.TargetNamespace))
