...
public class Module_Inventory_Transactions_GoodsReceivedReceipt_GRR_Delete : Page, IRequiresSessionState
{
	...
	protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		try
		{
			if (e.CommandName == "Sel")
			{
				...
				base.Response.Redirect("GoodsReceivedReceipt_GRR_Delete_Details.aspx?Id=" + text7 + "&SupId=" + text + "&GRRNo=" + text2 + "&GINNo=" + text3 + "&GINId=" + text4 + "&PONo=" + text5 + "&FyId=" + text6 + "&ModId=9&SubModId=38");
			}
		}
		catch (Exception)
		{
