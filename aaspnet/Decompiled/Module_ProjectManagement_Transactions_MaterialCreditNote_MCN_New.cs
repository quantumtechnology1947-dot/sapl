...
public class Module_ProjectManagement_Transactions_MaterialCreditNote_MCN_New : Page, IRequiresSessionState
{
	...
	protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		if (e.CommandName == "sel")
		{
			...
			base.Response.Redirect("~/Module/ProjectManagement/Transactions/MaterialCreditNote_MCN_New_Details.aspx?WOId=" + text + "&WONo=" + text2 + "&ModId=7&SubModId=127");
		}
	}
}
