...
public class Module_HR_TourIntimation_Edit : Page, IRequiresSessionState
{
	...
	protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		try
		{
			if (e.CommandName == "Sel")
			{
				...
				base.Response.Redirect("TourIntimation_Edit_Details.aspx?Id=" + num + "&ModId=12&SubModId=124");
			}
		}
		catch (Exception)
		{
