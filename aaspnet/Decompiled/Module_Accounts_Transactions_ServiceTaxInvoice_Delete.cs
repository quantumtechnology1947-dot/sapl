...
public class Module_Accounts_Transactions_ServiceTaxInvoice_Delete : Page, IRequiresSessionState
{
	...
	protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		if (e.CommandName == "Sel")
		{
			try
			{
				...
				base.Response.Redirect("ServiceTaxInvoice_Delete_Details.aspx?InvNo=" + base.Server.UrlEncode(fun.Encrypt(text)) + "&invid=" + base.Server.UrlEncode(fun.Encrypt(text2)) + "&cid=" + base.Server.UrlEncode(fun.Encrypt(text3)) + "&ModId=11&SubModId=52");
			}
			catch (Exception)
			{
			}
