...
public class Module_Inventory_Transactions_GoodsQualityNote_GQN_Delete : Page, IRequiresSessionState
{
	...
	protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		try
		{
			if (e.CommandName == "Sel")
			{
				...
				string text2 = ((Label)gridViewRow.FindControl("lblgqnno")).Text;
				string text3 = ((Label)gridViewRow.FindControl("lblGrrNo")).Text;
				string text4 = ((Label)gridViewRow.FindControl("lblGin")).Text;
				...
				string text8 = ((Label)gridViewRow.FindControl("lblginid")).Text;
				SupId = ((Label)gridViewRow.FindControl("lblsupp")).Text;
				base.Response.Redirect("GoodsQualityNote_GQN_Delete_Details.aspx?Id=" + text7 + "&SUPId=" + text + "&GQNNo=" + text2 + "&GINId=" + text8 + "&GRRNo=" + text3 + "&GINNo=" + text4 + "&PONo=" + text5 + "&FyId=" + text6 + "&ModId=10&SubModId=46");
			}
		}
		catch (Exception)
		{
