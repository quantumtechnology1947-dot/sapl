...
public class Module_Inventory_Transactions_GoodsServiceNote_SN_Edit : Page, IRequiresSessionState
{
	...
	protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		try
		{
			if (e.CommandName == "Sel")
			{
				...
				base.Response.Redirect("GoodsServiceNote_SN_Edit_Details.aspx?Id=" + text7 + "&SupId=" + text + "&GSNNo=" + text2 + "&GINNo=" + text3 + "&GINId=" + text6 + "&PONo=" + text4 + "&FyId=" + text5 + "&ModId=9&SubModId=39");
			}
		}
		catch (Exception)
		{
