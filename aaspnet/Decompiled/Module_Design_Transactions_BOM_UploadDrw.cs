...
public class Module_Design_Transactions_BOM_UploadDrw : Page, IRequiresSessionState
{
	...
	{
		base.Response.Redirect("~/Module/Design/Transactions/BOM_Design_WO_TreeView.aspx?WONo=" + wono + "&ModId=3&SubModId=26");
	}
