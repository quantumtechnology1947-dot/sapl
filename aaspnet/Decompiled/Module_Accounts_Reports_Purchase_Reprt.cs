...
public class Module_Accounts_Reports_Purchase_Reprt : Page, IRequiresSessionState
{
	...
	public void cryrpt_create2()
	{
		...
		try
		{
			...
			if (dataTable.Rows.Count > 0 || dataTable2.Rows.Count > 0)
			{
				...
				cryRpt2.Load(base.Server.MapPath("~/Module/Accounts/Reports/Purchase_Excise.rpt"));
