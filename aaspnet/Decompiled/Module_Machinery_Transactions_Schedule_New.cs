...
public class Module_Machinery_Transactions_Schedule_New : Page, IRequiresSessionState
{
	...
	protected void SearchGridView1_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		try
		{
			if (e.CommandName == "Sel")
			{
				...
				if (text != "")
				{
					base.Response.Redirect("Schedule_New_Details.aspx?WONo=" + text + "&ModId=15&SubModId=69");
				}
			}
		}
		catch (Exception)
