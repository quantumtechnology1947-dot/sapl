...
public class Module_Inventory_Transactions_SupplierChallan_New : Page, IRequiresSessionState
{
	...
	public void BindData(string spid)
	{
		try
		{
			...
			if (spid != "")
			{
				value = " And SupplierId='" + spid + "'";
			}
			SqlDataAdapter sqlDataAdapter = new SqlDataAdapter("GetSupplier", selectConnection);
