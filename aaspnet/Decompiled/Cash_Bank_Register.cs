...
[XmlRoot("Cash_Bank_Register")]
[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "2.0.0.0")]
[HelpKeyword("vs.data.DataSet")]
[ToolboxItem(true)]
[XmlSchemaProvider("GetTypedDataSetSchema")]
public class Cash_Bank_Register : DataSet
{
	...
	public class DataTable1DataTable : TypedTableBase<DataTable1Row>
	{
		...
		[DebuggerNonUserCode]
		public DataColumn OpColumn => columnOp;

		[DebuggerNonUserCode]
		public DataColumn DebitColumn => columnDebit;

		[DebuggerNonUserCode]
		public DataColumn TransTypeColumn => columnTransType;
		...
		[DebuggerNonUserCode]
		public DataTable1Row AddDataTable1Row(string SysDate, string PaidTo, string VchType, string VchNo, double Op, double Debit, int TransType, int CompId, string Particulars, double Credit)
		{
			DataTable1Row dataTable1Row = (DataTable1Row)NewRow();
			object[] itemArray = new object[10] { SysDate, PaidTo, VchType, VchNo, Op, Debit, TransType, CompId, Particulars, Credit };
		...
		internal void InitVars()
		{
			...
			columnOp = base.Columns["Op"];
			columnDebit = base.Columns["Debit"];
			columnTransType = base.Columns["TransType"];
		...
		private void InitClass()
		{
			...
			columnOp = new DataColumn("Op", typeof(double), null, MappingType.Element);
			base.Columns.Add(columnOp);
			columnDebit = new DataColumn("Debit", typeof(double), null, MappingType.Element);
			base.Columns.Add(columnDebit);
			columnTransType = new DataColumn("TransType", typeof(int), null, MappingType.Element);
			base.Columns.Add(columnTransType);
		...
		public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
		{
			...
			Cash_Bank_Register cash_Bank_Register = new Cash_Bank_Register();
			...
			xmlSchemaAttribute.FixedValue = cash_Bank_Register.Namespace;
			...
			XmlSchema schemaSerializable = cash_Bank_Register.GetSchemaSerializable();
	...
	public class DataTable1Row : DataRow
	{
		...
		public double Op
		{
			get
			{
				try
				{
					return (double)base[tableDataTable1.OpColumn];
				}
				catch (InvalidCastException innerException)
				{
					throw new StrongTypingException("The value for column 'Op' in table 'DataTable1' is DBNull.", innerException);
				}
			}
			set
			{
				base[tableDataTable1.OpColumn] = value;
			}
		}
		...
		public int TransType
		{
			get
			{
				try
				{
					return (int)base[tableDataTable1.TransTypeColumn];
				}
				catch (InvalidCastException innerException)
				{
					throw new StrongTypingException("The value for column 'TransType' in table 'DataTable1' is DBNull.", innerException);
				}
			}
			set
			{
				base[tableDataTable1.TransTypeColumn] = value;
			}
		}
		...
		{
			return IsNull(tableDataTable1.OpColumn);
		}

		[DebuggerNonUserCode]
		public void SetOpNull()
		{
			base[tableDataTable1.OpColumn] = Convert.DBNull;
		}
		...
		{
			return IsNull(tableDataTable1.TransTypeColumn);
		}

		[DebuggerNonUserCode]
		public void SetTransTypeNull()
		{
			base[tableDataTable1.TransTypeColumn] = Convert.DBNull;
		}
	...
	[DebuggerNonUserCode]
	protected Cash_Bank_Register(SerializationInfo info, StreamingContext context)
	...
	{
		Cash_Bank_Register cash_Bank_Register = (Cash_Bank_Register)base.Clone();
		cash_Bank_Register.InitVars();
		cash_Bank_Register.SchemaSerializationMode = SchemaSerializationMode;
		return cash_Bank_Register;
	}
	...
	private void InitClass()
	{
		base.DataSetName = "Cash_Bank_Register";
		base.Prefix = "";
		base.Namespace = "http://tempuri.org/Cash_Bank_Register.xsd";
	...
	public static XmlSchemaComplexType GetTypedDataSetSchema(XmlSchemaSet xs)
	{
		...
		XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
		XmlSchemaAny xmlSchemaAny = new XmlSchemaAny();
		xmlSchemaAny.Namespace = cash_Bank_Register.Namespace;
		xmlSchemaSequence.Items.Add(xmlSchemaAny);
		xmlSchemaComplexType.Particle = xmlSchemaSequence;
		XmlSchema schemaSerializable = cash_Bank_Register.GetSchemaSerializable();
		if (xs.Contains(schemaSerializable.TargetNamespace))
