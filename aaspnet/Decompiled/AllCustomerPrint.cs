...
[XmlRoot("AllCustomerPrint")]
[HelpKeyword("vs.data.DataSet")]
[DesignerCategory("code")]
[ToolboxItem(true)]
[XmlSchemaProvider("GetTypedDataSetSchema")]
public class AllCustomerPrint : DataSet
{
	...
	public class DataTable1DataTable : TypedTableBase<DataTable1Row>
	{
		...
		[DebuggerNonUserCode]
		public DataColumn SalesIdColumn => columnSalesId;
		...
		[DebuggerNonUserCode]
		public DataTable1Row AddDataTable1Row(int SalesId, int CompId, string CustomerName, string Code, string RegdAdd, string ContactPerson, string MobileNo, string Email)
		{
			DataTable1Row dataTable1Row = (DataTable1Row)NewRow();
			object[] itemArray = new object[8] { SalesId, CompId, CustomerName, Code, RegdAdd, ContactPerson, MobileNo, Email };
		...
		{
			columnSalesId = base.Columns["SalesId"];
		...
		{
			columnSalesId = new DataColumn("SalesId", typeof(int), null, MappingType.Element);
			base.Columns.Add(columnSalesId);
		...
		public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
		{
			...
			AllCustomerPrint allCustomerPrint = new AllCustomerPrint();
			...
			xmlSchemaAttribute.FixedValue = allCustomerPrint.Namespace;
			...
			XmlSchema schemaSerializable = allCustomerPrint.GetSchemaSerializable();
	...
	public class DataTable1Row : DataRow
	{
		...
		public int SalesId
		{
			get
			{
				try
				{
					return (int)base[tableDataTable1.SalesIdColumn];
				}
				catch (InvalidCastException innerException)
				{
					throw new StrongTypingException("The value for column 'SalesId' in table 'DataTable1' is DBNull.", innerException);
				}
			}
			set
			{
				base[tableDataTable1.SalesIdColumn] = value;
			}
		}
		...
		{
			return IsNull(tableDataTable1.SalesIdColumn);
		}

		[DebuggerNonUserCode]
		public void SetSalesIdNull()
		{
			base[tableDataTable1.SalesIdColumn] = Convert.DBNull;
		}
	...
	[DebuggerNonUserCode]
	protected AllCustomerPrint(SerializationInfo info, StreamingContext context)
	...
	{
		AllCustomerPrint allCustomerPrint = (AllCustomerPrint)base.Clone();
		allCustomerPrint.InitVars();
		allCustomerPrint.SchemaSerializationMode = SchemaSerializationMode;
		return allCustomerPrint;
	}
	...
	private void InitClass()
	{
		base.DataSetName = "AllCustomerPrint";
		base.Prefix = "";
		base.Namespace = "http://tempuri.org/AllCustomerPrint.xsd";
	...
	public static XmlSchemaComplexType GetTypedDataSetSchema(XmlSchemaSet xs)
	{
		...
		XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
		XmlSchemaAny xmlSchemaAny = new XmlSchemaAny();
		xmlSchemaAny.Namespace = allCustomerPrint.Namespace;
		xmlSchemaSequence.Items.Add(xmlSchemaAny);
		xmlSchemaComplexType.Particle = xmlSchemaSequence;
		XmlSchema schemaSerializable = allCustomerPrint.GetSchemaSerializable();
		if (xs.Contains(schemaSerializable.TargetNamespace))
