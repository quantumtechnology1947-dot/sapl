...
public class Module_Inventory_Transactions_MaterialRequisitionSlip_MRS_Print : Page, IRequiresSessionState
{
	...
	protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		try
		{
			if (e.CommandName == "Sel")
			{
				...
				base.Response.Redirect("MaterialRequisitionSlip_MRS_Print_Details.aspx?Id=" + text3 + "&MRSNo=" + text + "&FyId=" + text2 + "&Key=" + randomAlphaNumeric + "&ModId=9&SubModId=40");
			}
		}
		catch (Exception)
		{
