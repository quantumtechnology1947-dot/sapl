...
public class GRN : DataSet
{
	...
	public class DataTable1DataTable : TypedTableBase<DataTable1Row>
	{
		...
		[DebuggerNonUserCode]
		public DataColumn DescColumn => columnDesc;
		...
		[DebuggerNonUserCode]
		public DataTable1Row AddDataTable1Row(int Id, string ItemCode, string Desc, string UOM, double POQty, double InvQty, double RecedQty, int CompId, double AcceptedQty, string RejReason, string Remarks, double RejectedQty)
		{
			DataTable1Row dataTable1Row = (DataTable1Row)NewRow();
			object[] itemArray = new object[12]
			{
				Id, ItemCode, Desc, UOM, POQty, InvQty, RecedQty, CompId, AcceptedQty, RejReason,
				Remarks, RejectedQty
			};
		...
		private void InitClass()
		{
			...
			columnDesc = new DataColumn("Desc", typeof(string), null, MappingType.Element);
			base.Columns.Add(columnDesc);
		...
		public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
		{
			...
			xmlSchemaAttribute.FixedValue = gRN.Namespace;
			...
			XmlSchema schemaSerializable = gRN.GetSchemaSerializable();
	...
	public class DataTable1Row : DataRow
	{
		...
		public string Desc
		{
			get
			{
				try
				{
					return (string)base[tableDataTable1.DescColumn];
				}
				catch (InvalidCastException innerException)
				{
					throw new StrongTypingException("The value for column 'Desc' in table 'DataTable1' is DBNull.", innerException);
				}
			}
			set
			{
				base[tableDataTable1.DescColumn] = value;
			}
		}
		...
		{
			return IsNull(tableDataTable1.DescColumn);
		}

		[DebuggerNonUserCode]
		public void SetDescNull()
		{
			base[tableDataTable1.DescColumn] = Convert.DBNull;
		}
	...
	[DebuggerNonUserCode]
	protected GRN(SerializationInfo info, StreamingContext context)
	...
	{
		GRN gRN = (GRN)base.Clone();
		gRN.InitVars();
		gRN.SchemaSerializationMode = SchemaSerializationMode;
		return gRN;
	}
	...
	private void InitClass()
	{
		base.DataSetName = "GRN";
		base.Prefix = "";
		base.Namespace = "http://tempuri.org/GRN.xsd";
	...
	public static XmlSchemaComplexType GetTypedDataSetSchema(XmlSchemaSet xs)
	{
		...
		XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
		XmlSchemaAny xmlSchemaAny = new XmlSchemaAny();
		xmlSchemaAny.Namespace = gRN.Namespace;
		xmlSchemaSequence.Items.Add(xmlSchemaAny);
		xmlSchemaComplexType.Particle = xmlSchemaSequence;
		XmlSchema schemaSerializable = gRN.GetSchemaSerializable();
		if (xs.Contains(schemaSerializable.TargetNamespace))
