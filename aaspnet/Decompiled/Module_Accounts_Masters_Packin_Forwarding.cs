...
public class Module_Accounts_Masters_Packin_Forwarding : Page, IRequiresSessionState
{
	...
	protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		try
		{
			...
			if (e.CommandName == "Add1")
			{
				...
				if (text3 != "" && text4 != "" && fun.NumberValidationQty(text4))
				{
	...
	protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
	{
		try
		{
			...
			{
				sqlConnection.Open();
				string cmdText = "UPDATE tblPacking_Master SET Terms ='" + text + "',Value='" + text2 + "' WHERE Id ='" + num + "'";
