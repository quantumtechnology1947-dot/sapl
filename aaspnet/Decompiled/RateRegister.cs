...
[XmlRoot("RateRegister")]
[ToolboxItem(true)]
public class RateRegister : DataSet
{
	...
	public class DataTable1DataTable : TypedTableBase<DataTable1Row>
	{
		...
		[DebuggerNonUserCode]
		public DataTable1Row AddDataTable1Row(int Id, string ItemCode, string ManfDesc, string UOMBasic, string FinYear, string PONo, double Rate, double Discount, string Excise, string SupplierName, string SupplierId, double IndirectCost, double DirectCost, int CompId, string VAT, string PF, double Amount, string Symbol)
		{
			DataTable1Row dataTable1Row = (DataTable1Row)NewRow();
			object[] itemArray = new object[18]
			{
				Id, ItemCode, ManfDesc, UOMBasic, FinYear, PONo, Rate, Discount, Excise, SupplierName,
				SupplierId, IndirectCost, DirectCost, CompId, VAT, PF, Amount, Symbol
			};
		...
		public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
		{
			...
			RateRegister rateRegister = new RateRegister();
			...
			xmlSchemaAttribute.FixedValue = rateRegister.Namespace;
			...
			XmlSchema schemaSerializable = rateRegister.GetSchemaSerializable();
	...
	[DebuggerNonUserCode]
	protected RateRegister(SerializationInfo info, StreamingContext context)
	...
	{
		RateRegister rateRegister = (RateRegister)base.Clone();
		rateRegister.InitVars();
		rateRegister.SchemaSerializationMode = SchemaSerializationMode;
		return rateRegister;
	}
	...
	private void InitClass()
	{
		base.DataSetName = "RateRegister";
		base.Prefix = "";
		base.Namespace = "http://tempuri.org/RateRegister.xsd";
	...
	public static XmlSchemaComplexType GetTypedDataSetSchema(XmlSchemaSet xs)
	{
		...
		XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
		XmlSchemaAny xmlSchemaAny = new XmlSchemaAny();
		xmlSchemaAny.Namespace = rateRegister.Namespace;
		xmlSchemaSequence.Items.Add(xmlSchemaAny);
		xmlSchemaComplexType.Particle = xmlSchemaSequence;
		XmlSchema schemaSerializable = rateRegister.GetSchemaSerializable();
		if (xs.Contains(schemaSerializable.TargetNamespace))
