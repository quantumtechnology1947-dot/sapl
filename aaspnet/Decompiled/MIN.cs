...
public class MIN : DataSet
{
	...
	public class DataTable1DataTable : TypedTableBase<DataTable1Row>
	{
		...
		[DebuggerNonUserCode]
		public DataTable1Row AddDataTable1Row(int Id, string ItemCode, string ManfDesc, string UOM, string Symbol, string WONo, double ReqQty, double IssueQty, string Remarks, int CompId)
		{
			DataTable1Row dataTable1Row = (DataTable1Row)NewRow();
			object[] itemArray = new object[10] { Id, ItemCode, ManfDesc, UOM, Symbol, WONo, ReqQty, IssueQty, Remarks, CompId };
		...
		public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
		{
			...
			xmlSchemaAttribute.FixedValue = mIN.Namespace;
			...
			XmlSchema schemaSerializable = mIN.GetSchemaSerializable();
	...
	[DebuggerNonUserCode]
	protected MIN(SerializationInfo info, StreamingContext context)
	...
	{
		MIN mIN = (MIN)base.Clone();
		mIN.InitVars();
		mIN.SchemaSerializationMode = SchemaSerializationMode;
		return mIN;
	}
	...
	private void InitClass()
	{
		base.DataSetName = "MIN";
		base.Prefix = "";
		base.Namespace = "http://tempuri.org/MIN.xsd";
	...
	public static XmlSchemaComplexType GetTypedDataSetSchema(XmlSchemaSet xs)
	{
		...
		XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
		XmlSchemaAny xmlSchemaAny = new XmlSchemaAny();
		xmlSchemaAny.Namespace = mIN.Namespace;
		xmlSchemaSequence.Items.Add(xmlSchemaAny);
		xmlSchemaComplexType.Particle = xmlSchemaSequence;
		XmlSchema schemaSerializable = mIN.GetSchemaSerializable();
		if (xs.Contains(schemaSerializable.TargetNamespace))
