...
public class MRS : DataSet
{
	...
	public class DataTable1DataTable : TypedTableBase<DataTable1Row>
	{
		...
		private DataColumn columnMRSNo;
		...
		[DebuggerNonUserCode]
		public DataColumn MRSNoColumn => columnMRSNo;
		...
		[DebuggerNonUserCode]
		public DataColumn ReqQtyColumn => columnReqQty;
		...
		[DebuggerNonUserCode]
		public DataTable1Row AddDataTable1Row(int Id, string MRSNo, string ItemCode, string Description, string UOM, string Symbol, string WONo, double ReqQty, string Remarks, int CompId)
		{
			DataTable1Row dataTable1Row = (DataTable1Row)NewRow();
			object[] itemArray = new object[10] { Id, MRSNo, ItemCode, Description, UOM, Symbol, WONo, ReqQty, Remarks, CompId };
		...
		internal void InitVars()
		{
			...
			columnMRSNo = base.Columns["MRSNo"];
			...
			columnReqQty = base.Columns["ReqQty"];
		...
		private void InitClass()
		{
			...
			columnMRSNo = new DataColumn("MRSNo", typeof(string), null, MappingType.Element);
			base.Columns.Add(columnMRSNo);
			...
			columnReqQty = new DataColumn("ReqQty", typeof(double), null, MappingType.Element);
			base.Columns.Add(columnReqQty);
		...
		public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
		{
			...
			xmlSchemaAttribute.FixedValue = mRS.Namespace;
			...
			XmlSchema schemaSerializable = mRS.GetSchemaSerializable();
	...
	public class DataTable1Row : DataRow
	{
		...
		public string MRSNo
		{
			get
			{
				try
				{
					return (string)base[tableDataTable1.MRSNoColumn];
				}
				catch (InvalidCastException innerException)
				{
					throw new StrongTypingException("The value for column 'MRSNo' in table 'DataTable1' is DBNull.", innerException);
				}
			}
			set
			{
				base[tableDataTable1.MRSNoColumn] = value;
			}
		}
		...
		public double ReqQty
		{
			get
			{
				try
				{
					return (double)base[tableDataTable1.ReqQtyColumn];
				}
				catch (InvalidCastException innerException)
				{
					throw new StrongTypingException("The value for column 'ReqQty' in table 'DataTable1' is DBNull.", innerException);
				}
			}
			set
			{
				base[tableDataTable1.ReqQtyColumn] = value;
			}
		}
		...
		[DebuggerNonUserCode]
		public bool IsMRSNoNull()
		{
			return IsNull(tableDataTable1.MRSNoColumn);
		}

		[DebuggerNonUserCode]
		public void SetMRSNoNull()
		{
			base[tableDataTable1.MRSNoColumn] = Convert.DBNull;
		}
		...
		{
			return IsNull(tableDataTable1.ReqQtyColumn);
		}

		[DebuggerNonUserCode]
		public void SetReqQtyNull()
		{
			base[tableDataTable1.ReqQtyColumn] = Convert.DBNull;
		}
	...
	[DebuggerNonUserCode]
	protected MRS(SerializationInfo info, StreamingContext context)
	...
	{
		MRS mRS = (MRS)base.Clone();
		mRS.InitVars();
		mRS.SchemaSerializationMode = SchemaSerializationMode;
		return mRS;
	}
	...
	private void InitClass()
	{
		base.DataSetName = "MRS";
		base.Prefix = "";
		base.Namespace = "http://tempuri.org/MRS.xsd";
	...
	public static XmlSchemaComplexType GetTypedDataSetSchema(XmlSchemaSet xs)
	{
		...
		XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
		XmlSchemaAny xmlSchemaAny = new XmlSchemaAny();
		xmlSchemaAny.Namespace = mRS.Namespace;
		xmlSchemaSequence.Items.Add(xmlSchemaAny);
		xmlSchemaComplexType.Particle = xmlSchemaSequence;
		XmlSchema schemaSerializable = mRS.GetSchemaSerializable();
		if (xs.Contains(schemaSerializable.TargetNamespace))
