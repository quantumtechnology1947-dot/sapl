...
public class Module_Accounts_Transactions_TourVoucher_Delete : Page, IRequiresSessionState
{
	...
	protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		...
		try
		{
			if (e.CommandName == "Del")
			{
				...
				SqlCommand sqlCommand = new SqlCommand(fun.delete("tblACC_TourVoucherAdvance", "MId='" + num + "'"), sqlConnection);
				sqlCommand.ExecuteNonQuery();
				string cmdText = fun.select("*", "tblACC_TourVoucherAdvance", "MId='" + num + "' ");
				SqlCommand selectCommand = new SqlCommand(cmdText, sqlConnection);
				SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(selectCommand);
				DataSet dataSet = new DataSet();
				sqlDataAdapter.Fill(dataSet);
				SqlCommand sqlCommand2 = new SqlCommand(fun.delete("tblACC_TourVoucherAdvance_Details", "MId='" + num + "'"), sqlConnection);
				sqlCommand2.ExecuteNonQuery();
				string cmdText2 = fun.select("*", "tblACC_TourVoucherAdvance_Details", "MId='" + num + "' ");
				SqlCommand selectCommand2 = new SqlCommand(cmdText2, sqlConnection);
				SqlDataAdapter sqlDataAdapter2 = new SqlDataAdapter(selectCommand2);
				DataSet dataSet2 = new DataSet();
				sqlDataAdapter2.Fill(dataSet2);
				...
				{
					SqlCommand sqlCommand3 = new SqlCommand(fun.delete("tblACC_TourVoucher_Master", "Id='" + num + "'"), sqlConnection);
