...
[XmlRoot("balAmount")]
public class balAmount : DataSet
{
	...
	{
		private DataColumn columnBalAmt;

		private DataColumn columnAllowAmt;
		...
		[DebuggerNonUserCode]
		public DataColumn BalAmtColumn => columnBalAmt;

		[DebuggerNonUserCode]
		public DataColumn AllowAmtColumn => columnAllowAmt;
		...
		[DebuggerNonUserCode]
		public DataTable1Row AddDataTable1Row(string BalAmt, string AllowAmt, string Symbol, string Description, string Category)
		{
			DataTable1Row dataTable1Row = (DataTable1Row)NewRow();
			object[] itemArray = new object[5] { BalAmt, AllowAmt, Symbol, Description, Category };
		...
		{
			columnBalAmt = base.Columns["BalAmt"];
			columnAllowAmt = base.Columns["AllowAmt"];
		...
		{
			columnBalAmt = new DataColumn("BalAmt", typeof(string), null, MappingType.Element);
			base.Columns.Add(columnBalAmt);
			columnAllowAmt = new DataColumn("AllowAmt", typeof(string), null, MappingType.Element);
			base.Columns.Add(columnAllowAmt);
		...
		public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
		{
			...
			balAmount balAmount2 = new balAmount();
			...
			xmlSchemaAttribute.FixedValue = balAmount2.Namespace;
			...
			XmlSchema schemaSerializable = balAmount2.GetSchemaSerializable();
	...
	public class DataTable1Row : DataRow
	{
		...
		public string BalAmt
		{
			get
			{
				try
				{
					return (string)base[tableDataTable1.BalAmtColumn];
				}
				catch (InvalidCastException innerException)
				{
					throw new StrongTypingException("The value for column 'BalAmt' in table 'DataTable1' is DBNull.", innerException);
				}
			}
			set
			{
				base[tableDataTable1.BalAmtColumn] = value;
			}
		}
		...
		public string AllowAmt
		{
			get
			{
				try
				{
					return (string)base[tableDataTable1.AllowAmtColumn];
				}
				catch (InvalidCastException innerException)
				{
					throw new StrongTypingException("The value for column 'AllowAmt' in table 'DataTable1' is DBNull.", innerException);
				}
			}
			set
			{
				base[tableDataTable1.AllowAmtColumn] = value;
			}
		}
		...
		{
			return IsNull(tableDataTable1.BalAmtColumn);
		}

		[DebuggerNonUserCode]
		public void SetBalAmtNull()
		{
			base[tableDataTable1.BalAmtColumn] = Convert.DBNull;
		}

		[DebuggerNonUserCode]
		public bool IsAllowAmtNull()
		{
			return IsNull(tableDataTable1.AllowAmtColumn);
		}

		[DebuggerNonUserCode]
		public void SetAllowAmtNull()
		{
			base[tableDataTable1.AllowAmtColumn] = Convert.DBNull;
		}
	...
	[DebuggerNonUserCode]
	protected balAmount(SerializationInfo info, StreamingContext context)
	...
	{
		balAmount balAmount2 = (balAmount)base.Clone();
		balAmount2.InitVars();
		balAmount2.SchemaSerializationMode = SchemaSerializationMode;
		return balAmount2;
	}
	...
	private void InitClass()
	{
		base.DataSetName = "balAmount";
		base.Prefix = "";
		base.Namespace = "http://tempuri.org/balAmount.xsd";
	...
	public static XmlSchemaComplexType GetTypedDataSetSchema(XmlSchemaSet xs)
	{
		...
		XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
		XmlSchemaAny xmlSchemaAny = new XmlSchemaAny();
		xmlSchemaAny.Namespace = balAmount2.Namespace;
		xmlSchemaSequence.Items.Add(xmlSchemaAny);
		xmlSchemaComplexType.Particle = xmlSchemaSequence;
		XmlSchema schemaSerializable = balAmount2.GetSchemaSerializable();
		if (xs.Contains(schemaSerializable.TargetNamespace))
