...
public class Module_Inventory_Transactions_GoodsReceivedReceipt_GRR_New : Page, IRequiresSessionState
{
	...
	public void loadData()
	{
		...
		try
		{
			...
			SqlCommand sqlCommand = new SqlCommand("Sp_GRR_New", con);
			...
			while (sqlDataReader.Read())
			{
				...
				{
					num5 = Convert.ToDouble(sqlDataReader["GRRQty"]);
				}
	...
	protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		try
		{
			if (e.CommandName == "Sel")
			{
				...
				base.Response.Redirect("GoodsReceivedReceipt_GRR_New_Details.aspx?Id=" + text5 + "&SupId=" + text + "&GINNo=" + text2 + "&PONo=" + text3 + "&FyId=" + text4 + "&ModId=9&SubModId=38");
			}
		}
		catch (Exception)
		{
