...
public class Module_Accounts_Transactions_SalesInvoice_Print : Page, IRequiresSessionState
{
	...
	protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		if (e.CommandName == "Sel")
		{
			try
			{
				...
				base.Response.Redirect("SalesInvoice_Print_Details.aspx?InvNo=" + text + "&InvId=" + text2 + "&cid=" + text3 + "&PT=" + selectedValue + "&ModId=11&SubModId=51&Key=" + randomAlphaNumeric + "&K=0&T=0");
			}
			catch (Exception)
			{
			}
