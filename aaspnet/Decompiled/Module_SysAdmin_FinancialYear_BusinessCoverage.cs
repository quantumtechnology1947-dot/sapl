...
public class Module_SysAdmin_FinancialYear_BusinessCoverage : Page, IRequiresSessionState
{
	...
	protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		try
		{
			...
			{
				string text = ((TextBox)GridView1.FooterRow.FindControl("txtServiceCoverage")).Text;
				if (text != "")
				{
			...
			{
				string text2 = ((TextBox)GridView1.Controls[0].Controls[0].FindControl("txtServiceCoverage")).Text;
				if (text2 != "")
				{
