...
public class Module_Inventory_Transactions_MaterialIssueNote_MIN_Edit : Page, IRequiresSessionState
{
	...
	protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		try
		{
			...
			{
				base.Response.Redirect("MaterialIssueNote_MIN_Edit_Details.aspx?Id=" + text + "&MINNo=" + MinNo + "&MRSNo=" + MrsNo + "&FYId=" + FyId + "&ModId=9&SubModId=41");
			}
		}
		catch (Exception)
		{
