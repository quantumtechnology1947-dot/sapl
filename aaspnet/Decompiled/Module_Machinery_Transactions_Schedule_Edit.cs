...
public class Module_Machinery_Transactions_Schedule_Edit : Page, IRequiresSessionState
{
	...
	protected void SearchGridView1_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		try
		{
			if (e.CommandName == "Sel")
			{
				...
				base.Response.Redirect("schedule_Edit_Details.aspx?id=" + text + "&wono=" + text2 + "&ModId=15&SubModId=69");
			}
		}
		catch (Exception)
		{
