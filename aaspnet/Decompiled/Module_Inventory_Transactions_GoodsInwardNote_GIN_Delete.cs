...
public class Module_Inventory_Transactions_GoodsInwardNote_GIN_Delete : Page, IRequiresSessionState
{
	...
	protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		try
		{
			if (e.CommandName == "sel")
			{
				...
				base.Response.Redirect("GoodsInwardNote_GIN_Delete_Details.aspx?ModId=9&SubModId=37&Id=" + text5 + "&GNo=" + text2 + "&ChNo=" + text3 + "&ChDt=" + text4 + "&fyid=" + text + "&SupId=" + supplierid);
			}
		}
		catch (Exception)
		{
