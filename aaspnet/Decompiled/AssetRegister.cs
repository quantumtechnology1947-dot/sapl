...
[XmlRoot("AssetRegister")]
public class AssetRegister : DataSet
{
	...
	public class DataTable1DataTable : TypedTableBase<DataTable1Row>
	{
		...
		private DataColumn columnAssetNo;
		...
		[DebuggerNonUserCode]
		public DataColumn AssetNoColumn => columnAssetNo;
		...
		[DebuggerNonUserCode]
		public DataTable1Row AddDataTable1Row(int Id, string ItemCode, string Description, string UOM, string GQNNo, string AssetNo, string PONo, int CompId)
		{
			DataTable1Row dataTable1Row = (DataTable1Row)NewRow();
			object[] itemArray = new object[8] { Id, ItemCode, Description, UOM, GQNNo, AssetNo, PONo, CompId };
		...
		internal void InitVars()
		{
			...
			columnAssetNo = base.Columns["AssetNo"];
		...
		private void InitClass()
		{
			...
			columnAssetNo = new DataColumn("AssetNo", typeof(string), null, MappingType.Element);
			base.Columns.Add(columnAssetNo);
		...
		public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
		{
			...
			xmlSchemaAttribute.FixedValue = assetRegister.Namespace;
			...
			XmlSchema schemaSerializable = assetRegister.GetSchemaSerializable();
	...
	public class DataTable1Row : DataRow
	{
		...
		public string AssetNo
		{
			get
			{
				try
				{
					return (string)base[tableDataTable1.AssetNoColumn];
				}
				catch (InvalidCastException innerException)
				{
					throw new StrongTypingException("The value for column 'AssetNo' in table 'DataTable1' is DBNull.", innerException);
				}
			}
			set
			{
				base[tableDataTable1.AssetNoColumn] = value;
			}
		}
		...
		{
			return IsNull(tableDataTable1.AssetNoColumn);
		}

		[DebuggerNonUserCode]
		public void SetAssetNoNull()
		{
			base[tableDataTable1.AssetNoColumn] = Convert.DBNull;
		}
	...
	[DebuggerNonUserCode]
	protected AssetRegister(SerializationInfo info, StreamingContext context)
	...
	{
		AssetRegister assetRegister = (AssetRegister)base.Clone();
		assetRegister.InitVars();
		assetRegister.SchemaSerializationMode = SchemaSerializationMode;
	...
	private void InitClass()
	{
		base.DataSetName = "AssetRegister";
		base.Prefix = "";
		base.Namespace = "http://tempuri.org/AssetRegister.xsd";
	...
	public static XmlSchemaComplexType GetTypedDataSetSchema(XmlSchemaSet xs)
	{
		...
		XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
		XmlSchemaAny xmlSchemaAny = new XmlSchemaAny();
		xmlSchemaAny.Namespace = assetRegister.Namespace;
		xmlSchemaSequence.Items.Add(xmlSchemaAny);
		xmlSchemaComplexType.Particle = xmlSchemaSequence;
		XmlSchema schemaSerializable = assetRegister.GetSchemaSerializable();
		if (xs.Contains(schemaSerializable.TargetNamespace))
