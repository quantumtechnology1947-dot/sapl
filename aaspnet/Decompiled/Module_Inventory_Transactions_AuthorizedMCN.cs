...
public class Module_Inventory_Transactions_AuthorizedMCN : Page, IRequiresSessionState
{
	...
	protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		if (e.CommandName == "sel")
		{
			...
			base.Response.Redirect("AuthorizedMCN_Details.aspx?WOId=" + text + "&WONo=" + text2 + "&ModId=10&SubModId=128");
		}
	}
}
