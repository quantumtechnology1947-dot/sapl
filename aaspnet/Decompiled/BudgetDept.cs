...
[XmlRoot("BudgetDept")]
public class BudgetDept : DataSet
{
	...
	public class DataTable1DataTable : TypedTableBase<DataTable1Row>
	{
		...
		private DataColumn columnAbbrivation;
		...
		[DebuggerNonUserCode]
		public DataColumn AbbrivationColumn => columnAbbrivation;

		[DebuggerNonUserCode]
		public DataColumn DeptNameColumn => columnDeptName;
		...
		[DebuggerNonUserCode]
		public DataTable1Row AddDataTable1Row(string Description, string Symbol, string Abbrivation, string DeptName, double Amount)
		{
			DataTable1Row dataTable1Row = (DataTable1Row)NewRow();
			object[] itemArray = new object[5] { Description, Symbol, Abbrivation, DeptName, Amount };
		...
		internal void InitVars()
		{
			...
			columnAbbrivation = base.Columns["Abbrivation"];
			columnDeptName = base.Columns["DeptName"];
		...
		private void InitClass()
		{
			...
			columnAbbrivation = new DataColumn("Abbrivation", typeof(string), null, MappingType.Element);
			base.Columns.Add(columnAbbrivation);
			columnDeptName = new DataColumn("DeptName", typeof(string), null, MappingType.Element);
			base.Columns.Add(columnDeptName);
		...
		public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
		{
			...
			BudgetDept budgetDept = new BudgetDept();
			...
			xmlSchemaAttribute.FixedValue = budgetDept.Namespace;
			...
			XmlSchema schemaSerializable = budgetDept.GetSchemaSerializable();
	...
	public class DataTable1Row : DataRow
	{
		...
		public string Abbrivation
		{
			get
			{
				try
				{
					return (string)base[tableDataTable1.AbbrivationColumn];
				}
				catch (InvalidCastException innerException)
				{
					throw new StrongTypingException("The value for column 'Abbrivation' in table 'DataTable1' is DBNull.", innerException);
				}
			}
			set
			{
				base[tableDataTable1.AbbrivationColumn] = value;
			}
		}
		...
		public string DeptName
		{
			get
			{
				try
				{
					return (string)base[tableDataTable1.DeptNameColumn];
				}
				catch (InvalidCastException innerException)
				{
					throw new StrongTypingException("The value for column 'DeptName' in table 'DataTable1' is DBNull.", innerException);
				}
			}
			set
			{
				base[tableDataTable1.DeptNameColumn] = value;
			}
		}
		...
		[DebuggerNonUserCode]
		public bool IsAbbrivationNull()
		{
			return IsNull(tableDataTable1.AbbrivationColumn);
		}

		[DebuggerNonUserCode]
		public void SetAbbrivationNull()
		{
			base[tableDataTable1.AbbrivationColumn] = Convert.DBNull;
		}

		[DebuggerNonUserCode]
		public bool IsDeptNameNull()
		{
			return IsNull(tableDataTable1.DeptNameColumn);
		}

		[DebuggerNonUserCode]
		public void SetDeptNameNull()
		{
			base[tableDataTable1.DeptNameColumn] = Convert.DBNull;
		}
	...
	[DebuggerNonUserCode]
	protected BudgetDept(SerializationInfo info, StreamingContext context)
	...
	{
		BudgetDept budgetDept = (BudgetDept)base.Clone();
		budgetDept.InitVars();
		budgetDept.SchemaSerializationMode = SchemaSerializationMode;
		return budgetDept;
	}
	...
	private void InitClass()
	{
		base.DataSetName = "BudgetDept";
		base.Prefix = "";
		base.Namespace = "http://tempuri.org/BudgetDept.xsd";
	...
	public static XmlSchemaComplexType GetTypedDataSetSchema(XmlSchemaSet xs)
	{
		...
		XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
		XmlSchemaAny xmlSchemaAny = new XmlSchemaAny();
		xmlSchemaAny.Namespace = budgetDept.Namespace;
		xmlSchemaSequence.Items.Add(xmlSchemaAny);
		xmlSchemaComplexType.Particle = xmlSchemaSequence;
		XmlSchema schemaSerializable = budgetDept.GetSchemaSerializable();
		if (xs.Contains(schemaSerializable.TargetNamespace))
