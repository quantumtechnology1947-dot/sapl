...
public class Module_Inventory_Transactions_MaterialRequisitionSlip_MRS_Delete : Page, IRequiresSessionState
{
	...
	protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		try
		{
			if (e.CommandName == "Sel")
			{
				...
				base.Response.Redirect("MaterialRequisitionSlip_MRS_Delete_Details.aspx?Id=" + text3 + "&MRSNo=" + text + "&FyId=" + text2 + "&ModId=9&SubModId=40");
			}
		}
		catch (Exception)
		{
