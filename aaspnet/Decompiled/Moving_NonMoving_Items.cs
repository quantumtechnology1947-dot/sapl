...
[XmlRoot("Moving_NonMoving_Items")]
[HelpKeyword("vs.data.DataSet")]
[DesignerCategory("code")]
[ToolboxItem(true)]
public class Moving_NonMoving_Items : DataSet
{
	...
	public class DataTable1DataTable : TypedTableBase<DataTable1Row>
	{
		...
		[DebuggerNonUserCode]
		public DataTable1Row AddDataTable1Row(int Id, string ItemCode, string ManfDesc, string Category, string SubCategory, string UOM, int CompId, double GQNQTY, double ISSUEQTY, double OPENINGQTY, double CLOSINGQTY, double RateReg)
		{
		...
		public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
		{
			...
			Moving_NonMoving_Items moving_NonMoving_Items = new Moving_NonMoving_Items();
			...
			xmlSchemaAttribute.FixedValue = moving_NonMoving_Items.Namespace;
			...
			XmlSchema schemaSerializable = moving_NonMoving_Items.GetSchemaSerializable();
	...
	[DebuggerNonUserCode]
	protected Moving_NonMoving_Items(SerializationInfo info, StreamingContext context)
	...
	{
		Moving_NonMoving_Items moving_NonMoving_Items = (Moving_NonMoving_Items)base.Clone();
		moving_NonMoving_Items.InitVars();
		moving_NonMoving_Items.SchemaSerializationMode = SchemaSerializationMode;
		return moving_NonMoving_Items;
	}
	...
	private void InitClass()
	{
		base.DataSetName = "Moving_NonMoving_Items";
		base.Prefix = "";
		base.Namespace = "http://tempuri.org/Moving_NonMoving_Items.xsd";
	...
	public static XmlSchemaComplexType GetTypedDataSetSchema(XmlSchemaSet xs)
	{
		...
		XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
		XmlSchemaAny xmlSchemaAny = new XmlSchemaAny();
		xmlSchemaAny.Namespace = moving_NonMoving_Items.Namespace;
		xmlSchemaSequence.Items.Add(xmlSchemaAny);
		xmlSchemaComplexType.Particle = xmlSchemaSequence;
		XmlSchema schemaSerializable = moving_NonMoving_Items.GetSchemaSerializable();
		if (xs.Contains(schemaSerializable.TargetNamespace))
