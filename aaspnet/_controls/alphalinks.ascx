<%@ control language="C#" autoeventwireup="true" inherits="_controls_alphalinks, newerp_deploy" %>
...
<script runat="server">
	...
	private void Page_Load()
	{
        ...
        {
            selectedLetter = "All";
            ViewState["selectedLetter"] = selectedLetter;
        }
        else
        {
            ViewState["selectedLetter"] = letters; 
        }
	}
	...
	private void Select(object sender, CommandEventArgs e)
	{
		...
		ViewState["selectedLetter"] = selectedLetter.ToString();
	}
