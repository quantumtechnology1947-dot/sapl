"""
Playwright test for Mr_Office Root
ASP.NET Source: Module/MROffice/Dashboard.aspx
...
class TestMrOfficeRoot:
    """Test suite for Mr_Office Root"""
    ...
    def test_create_new_record(self, authenticated_page: Page):
        ...
        authenticated_page.goto("http://localhost:8000/mr_office/mr_office_root/create/")
    ...
    def test_edit_existing_record(self, authenticated_page: Page):
        ...
        # authenticated_page.goto("http://localhost:8000/mr_office/mr_office_root/1/edit/")
