"""
# Note: This test file covers 19 .aspx files in sys_admin/Root:
# - City.aspx
# - Country.aspx
# - Dashboard.aspx
# - Dashboard.aspx
# - FinYear_New_Details.aspx
# - FinYrs_Delete.aspx
# - FinYrs_New.aspx
# - FinYrs_Update.aspx
# - State.aspx
...
Playwright test for Sys_Admin Root
ASP.NET Source: Module/SysAdmin/City.aspx
...
class TestSysAdminRoot:
    """Test suite for Sys_Admin Root"""
    ...
    def test_create_new_record(self, authenticated_page: Page):
        ...
        authenticated_page.goto("http://localhost:8000/sys_admin/sys_admin_root/create/")
    ...
    def test_edit_existing_record(self, authenticated_page: Page):
        ...
        # authenticated_page.goto("http://localhost:8000/sys_admin/sys_admin_root/1/edit/")
