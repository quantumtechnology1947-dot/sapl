"""
# Note: This test file covers 2 .aspx files in human_resource/Reports:
# - Dashboard.aspx
# - MultipleReports.aspx

Playwright test for Human_Resource Reports
ASP.NET Source: Module/HR/Reports/Dashboard.aspx
...
class TestHumanResourceReports:
    """Test suite for Human_Resource Reports"""
    ...
    def test_create_new_record(self, authenticated_page: Page):
        ...
        authenticated_page.goto("http://localhost:8000/human_resource/human_resource_reports/create/")
    ...
    def test_edit_existing_record(self, authenticated_page: Page):
        ...
        # authenticated_page.goto("http://localhost:8000/human_resource/human_resource_reports/1/edit/")
