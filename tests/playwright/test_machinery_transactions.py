"""
# Note: This test file covers 29 .aspx files in machinery/Transactions:
# - Dashboard.aspx
# - PMBM_Dashboard.aspx
# - PMBM_Delete.aspx
# - PMBM_Edit.aspx
# - PMBM_Edit_Details.aspx
# - PMBM_New.aspx
# - PMBM_New_Details.aspx
# - PMBM_Print.aspx
# - PMBM_Print_Details.aspx
# - Schedule_Dashboard.aspx
# ... and 19 more files

Playwright test for Machinery Transactions
ASP.NET Source: Module/Machinery/Transactions/Dashboard.aspx
...
class TestMachineryTransactions:
    """Test suite for Machinery Transactions"""
    ...
    def test_create_new_record(self, authenticated_page: Page):
        ...
        authenticated_page.goto("http://localhost:8000/machinery/machinery_transactions/create/")
    ...
    def test_edit_existing_record(self, authenticated_page: Page):
        ...
        # authenticated_page.goto("http://localhost:8000/machinery/machinery_transactions/1/edit/")
