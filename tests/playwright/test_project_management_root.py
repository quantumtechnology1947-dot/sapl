"""
Playwright test for Project_Management Root
ASP.NET Source: Module/ProjectManagement/Dashboard.aspx
...
class TestProjectManagementRoot:
    """Test suite for Project_Management Root"""
    ...
    def test_create_new_record(self, authenticated_page: Page):
        ...
        authenticated_page.goto("http://localhost:8000/project_management/project_management_root/create/")
    ...
    def test_edit_existing_record(self, authenticated_page: Page):
        ...
        # authenticated_page.goto("http://localhost:8000/project_management/project_management_root/1/edit/")
