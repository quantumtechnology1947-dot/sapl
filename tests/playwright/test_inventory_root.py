"""
Playwright test for Inventory Root
ASP.NET Source: Module/Inventory/Dashboard.aspx
...
class TestInventoryRoot:
    """Test suite for Inventory Root"""
    ...
    def test_create_new_record(self, authenticated_page: Page):
        ...
        authenticated_page.goto("http://localhost:8000/inventory/inventory_root/create/")
    ...
    def test_edit_existing_record(self, authenticated_page: Page):
        ...
        # authenticated_page.goto("http://localhost:8000/inventory/inventory_root/1/edit/")
