"""
# Note: This test file covers 12 .aspx files in human_resource/Masters:
# - BusinessGroup.aspx
# - CorporateMobileNo.aspx
# - Dashboard.aspx
# - Department.aspx
# - Designation.aspx
# - GatePassReason.aspx
...
Playwright test for Human_Resource Masters
ASP.NET Source: Module/HR/Masters/BusinessGroup.aspx
...
class TestHumanResourceMasters:
    """Test suite for Human_Resource Masters"""
    ...
    def test_create_new_record(self, authenticated_page: Page):
        ...
        authenticated_page.goto("http://localhost:8000/human_resource/human_resource_masters/create/")
    ...
    def test_edit_existing_record(self, authenticated_page: Page):
        ...
        # authenticated_page.goto("http://localhost:8000/human_resource/human_resource_masters/1/edit/")
