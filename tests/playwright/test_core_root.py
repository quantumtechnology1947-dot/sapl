"""
# Note: This test file covers 2 .aspx files in core/Root:
# - ChatWindow.aspx
# - Chatroom.aspx

Playwright test for Core Root
ASP.NET Source: Module/Chatting/ChatWindow.aspx
Django App: core
Category: Root
"""
import pytest
...
class TestCoreRoot:
    ...
    def test_create_new_record(self, authenticated_page: Page):
        ...
        authenticated_page.goto("http://localhost:8000/core/core_root/create/")
    ...
    def test_edit_existing_record(self, authenticated_page: Page):
        ...
        # authenticated_page.goto("http://localhost:8000/core/core_root/1/edit/")
