"""
# Note: This test file covers 2 .aspx files in sales_distribution/Root:
# - CustomerMaster_New.aspx
# - Dashboard.aspx

Playwright test for Sales_Distribution Root
ASP.NET Source: Module/SalesDistribution/CustomerMaster_New.aspx
...
class TestSalesDistributionRoot:
    """Test suite for Sales_Distribution Root"""
    ...
    def test_create_new_record(self, authenticated_page: Page):
        ...
        authenticated_page.goto("http://localhost:8000/sales_distribution/sales_distribution_root/create/")
    ...
    def test_edit_existing_record(self, authenticated_page: Page):
        ...
        # authenticated_page.goto("http://localhost:8000/sales_distribution/sales_distribution_root/1/edit/")
