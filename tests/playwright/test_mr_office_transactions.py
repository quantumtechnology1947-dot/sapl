"""
# Note: This test file covers 2 .aspx files in mr_office/Transactions:
# - Dashboard.aspx
# - MROffice.aspx

Playwright test for Mr_Office Transactions
ASP.NET Source: Module/MROffice/Transactions/Dashboard.aspx
...
class TestMrOfficeTransactions:
    """Test suite for Mr_Office Transactions"""
    ...
    def test_create_new_record(self, authenticated_page: Page):
        ...
        authenticated_page.goto("http://localhost:8000/mr_office/mr_office_transactions/create/")
    ...
    def test_edit_existing_record(self, authenticated_page: Page):
        ...
        # authenticated_page.goto("http://localhost:8000/mr_office/mr_office_transactions/1/edit/")
